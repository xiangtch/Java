...
public class Collections {
    ...
    static class SynchronizedCollection<E> implements Collection<E>, Serializable {
        ...
        // 根据集合 c 和 mutex 创建 SynchronizedCollection 对象
    ...
    // 根据 list 和 mutex 将 list 包装成线程安全的 List，不过在使用 iterator 进行迭代时，需要对返回的 list 进行同步操作
    // 即加上 synchronized 关键字
    static <T> List<T> synchronizedList(List<T> list, Object mutex) {
        // 判断 list 有没有实现 RandomAccess 接口
        return (list instanceof RandomAccess ?
    ...
    static class SynchronizedList<E>
        ...
        // 根据 list 和 mutex 创建 SynchronizedList 对象
    ...
    static class SynchronizedRandomAccessList<E>
        ...
        // 根据 list 和 mutex 创建 SynchronizedRandomAccessList 对象
