...
/*     */     
/*     */ 
/* 108 */     localInfo1 = new DataLine.Info(SourceDataLine.class, paramAudioInputStream.getFormat());
...
/*     */         try
/*     */         {
/* 200 */           AudioInputStream localAudioInputStream2 = new AudioInputStream(paramInputStream, ((AudioDataStream)paramInputStream).getAudioData().format, -1L);
/*     */           
...
/*     */         try
/*     */         {
/* 211 */           AudioInputStream localAudioInputStream3 = new AudioInputStream(paramInputStream, ((AudioDataStream)paramInputStream).getAudioData().format, ((AudioDataStream)paramInputStream).getAudioData().buffer.length);
...
/*     */         {
/*     */           try {
/* 235 */             MidiFileFormat localMidiFileFormat = MidiSystem.getMidiFileFormat(localBufferedInputStream);
...
/*     */ 
/*     */ 
/* 249 */           AudioFormat localAudioFormat = new AudioFormat(Encoding.ULAW, 8000.0F, 8, 1, 1, 8000.0F, true);
/*     */           try
/*     */           {
...
/*     */     {
/* 411 */       this.sequencer = paramSequencer;
/* 412 */       this.in = paramInputStream;
/* 413 */       this.datapusher = paramDataPusher;
/*     */     }
/*     */     
...
/* Location:              E:\java_source\rt.jar!\sun\audio\AudioDevice.class
