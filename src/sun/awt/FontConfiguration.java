...
/*      */     {
/*   87 */       FontUtilities.getLogger().info("Creating standard Font Configuration");
/*      */     }
...
/*      */     {
/*  120 */       FontUtilities.getLogger().info("Creating alternate Font Configuration");
/*      */     }
...
/*      */     String str3;
/*  436 */     if ((localHashMap.containsKey(str3 = this.initEncoding + "." + str1 + "." + str2)) || 
/*  437 */       (localHashMap.containsKey(str3 = this.initEncoding + "." + str1)) || 
/*  438 */       (localHashMap.containsKey(str3 = this.initEncoding))) {
/*  439 */       this.initELC = ((Integer)localHashMap.get(str3)).shortValue();
/*      */     } else {
/*  441 */       this.initELC = ((Integer)localHashMap.get("NULL.NULL.NULL")).shortValue();
/*      */     }
/*  443 */     int j = 0;
...
/*      */   
/*  468 */   private void initAllComponentFonts() { short[] arrayOfShort1 = getFallbackScripts();
...
/*      */           
/*  492 */           if ((this.preferLocaleFonts) && (localeMap != null) && 
/*  493 */             (this.fontManager.usingAlternateFontforJALocales())) {
...
/*      */           
/*  507 */           if ((this.preferLocaleFonts) && (localeMap != null) && 
/*  508 */             (this.fontManager.usingAlternateFontforJALocales())) {
...
/*      */       }
/*      */       
/*  901 */       CharsetEncoder localCharsetEncoder = getFontCharsetEncoder(str4.trim(), str3);
/*      */       
/*      */ 
...
/*      */         public Object run() {
/*      */           try {
/*  949 */             return Class.forName(paramString1, true, 
...
/* 1018 */       int m = 0;
/* 1019 */       int n = 0;
/* 1020 */       int i3; for (int i1 = 0; i1 < arrayOfInt.length; i1++) {
...
/* 1049 */           if ((localObject2[arrayOfString1] == null) || 
/* 1050 */             (needToSearchForFile(localObject2[arrayOfString1]))) {
/* 1051 */             localObject2[arrayOfString1] = getFileNameFromComponentFontName(getComponentFontName(s1));
/*      */           }
/* 1053 */           if ((i3 == 0) && 
/* 1054 */             (str1.equals(localObject2[arrayOfString1]))) {
/* 1055 */             i3 = 1;
/*      */           }
/*      */         }
/*      */         
...
/* 1203 */       short s1; for (j = 0; j < arrayOfShort2.length; j++) {
...
/* 1218 */           this.filenamesMap.put(this.componentFonts[j], 
...
/* 1395 */             getString(table_componentFontNameIDs[j]) + "> entry is missing!!!");
/*      */           
/* 1397 */           i++;
/*      */         }
/* 1399 */         else if ((verbose) && (!isEmpty(table_filenames))) {
/* 1400 */           System.err.println("\n Note: 'filename' entry is undefined for \"" + 
/* 1401 */             getString(table_componentFontNameIDs[j]) + "\"");
/*      */         }
/*      */       }
/*      */     }
/*      */     
...
/* 1411 */           getString(table_scriptIDs[j]) + "> entry is missing!!!");
/*      */         
/* 1413 */         i++;
/*      */       }
/* 1415 */       else if (k < 0) {
...
/* 1423 */                 getFontName(m) + "." + 
/* 1424 */                 getStyleName(n) + "." + 
/* 1425 */                 getString(table_scriptIDs[j]) + "> entry is missing!!!");
/*      */               
/* 1427 */               i++;
/*      */             }
/*      */           }
...
/* 1437 */           if ((!str2.contains("lucida")) && 
/* 1438 */             (!str2.contains("dingbats")) && 
/* 1439 */             (!str2.contains("symbol")))
/*      */           {
/*      */ 
...
/* 1475 */     int j; for (i = 0; i < table_scriptIDs.length; i++) {
/* 1476 */       j = table_scriptFonts[i];
/* 1477 */       if (j >= 0) {
/* 1478 */         System.out.println("  allfonts." + 
/* 1479 */           getString(table_scriptIDs[i]) + "=" + 
/*      */           
/* 1481 */           getString(table_componentFontNameIDs[j]));
/*      */       }
/*      */     }
...
/* 1493 */               getFontName(k) + "." + 
/* 1494 */               getStyleName(m) + "." + 
/* 1495 */               getString(table_scriptIDs[i]) + "=" + 
/*      */               
/* 1497 */               getString(table_componentFontNameIDs[i1]));
/*      */           }
/*      */         }
/*      */       }
/*      */     }
...
/* 1524 */           getString(table_fontfileNameIDs[table_filenames[i]]));
/*      */       }
/*      */     }
/* 1527 */     System.out.println("\n----awtfontpaths---------");
/* 1528 */     for (i = 0; i < table_awtfontpaths.length; i++) {
/* 1529 */       System.out.println("  " + getString(table_scriptIDs[i]) + " : " + 
/*      */       
/* 1531 */         getString(table_awtfontpaths[i]));
/*      */     }
/* 1533 */     System.out.println("\n----proportionals--------");
/* 1534 */     for (i = 0; i < table_proportionals.length; i++) {
/* 1535 */       System.out.println("  " + 
/* 1536 */         getString(table_componentFontNameIDs[table_proportionals[(i++)]]) + " -> " + 
/*      */         
/* 1538 */         getString(table_componentFontNameIDs[table_proportionals[i]]));
/*      */     }
/* 1540 */     i = 0;
...
/* 1906 */           FontConfiguration.table_scriptFontsMotif[((Short)localObject3.getKey()).intValue()] = 
/* 1907 */             ((Short)((Map.Entry)localObject3).getValue()).shortValue();
/*      */         }
...
/* 2090 */             (FontConfiguration.logger != null)) {
...
/*      */     }
/*      */     
/*      */     class FontProperties extends Properties { FontProperties() {}
/*      */       
/* 2114 */       public synchronized Object put(Object paramObject1, Object paramObject2) { PropertiesHandler.this.parseProperty((String)paramObject1, (String)paramObject2);
/* 2115 */         return null;
/*      */       }
/*      */     }
/*      */     
...
/* 2134 */         this.exclusions.put(getID(this.scriptIDs, paramString1), parseExclusions(paramString1, paramString2)); } else { int i;
/* 2135 */         int j; Object localObject; Short localShort3; if (paramString1.startsWith("sequence.")) {
...
/*      */           
/* 2224 */           this.proportionals.put(getID(this.componentFontNameIDs, paramString1), 
/* 2225 */             getID(this.componentFontNameIDs, paramString2));
/*      */         }
/*      */         else
/*      */         {
/* 2229 */           int k = 0;
...
/*      */           }
/*      */           
/* 2273 */           arrayOfShort[(localObject.intValue() * 4 + localInteger1.intValue())] = getID(this.componentFontNameIDs, paramString2);
/*      */           
/*      */ 
/*      */ 
/*      */ 
...
/* Location:              E:\java_source\rt.jar!\sun\awt\FontConfiguration.class
