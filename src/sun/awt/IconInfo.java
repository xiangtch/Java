...
/*     */   {
/*  73 */     this.intIconData = (null == paramArrayOfInt ? null : Arrays.copyOf(paramArrayOfInt, paramArrayOfInt.length));
...
/*     */   {
/*  83 */     this.longIconData = (null == paramArrayOfLong ? null : Arrays.copyOf(paramArrayOfLong, paramArrayOfLong.length));
...
/*     */   {
/* 192 */     DirectColorModel localDirectColorModel = new DirectColorModel(ColorSpace.getInstance(1000), 32, 16711680, 65280, 255, -16777216, false, 3);
/*     */     
/*     */ 
/* 195 */     DataBufferInt localDataBufferInt = new DataBufferInt(paramArrayOfInt, paramArrayOfInt.length - 2, 2);
/*     */     
/* 197 */     WritableRaster localWritableRaster = Raster.createPackedRaster(localDataBufferInt, paramArrayOfInt[0], paramArrayOfInt[1], paramArrayOfInt[0], new int[] { 16711680, 65280, 255, -16777216 }, null);
/*     */     
/*     */ 
/*     */ 
/*     */ 
...
/*     */     }
/*     */     
/* 215 */     DirectColorModel localDirectColorModel = new DirectColorModel(ColorSpace.getInstance(1000), 32, 16711680, 65280, 255, -16777216, false, 3);
/*     */     
/*     */ 
/* 218 */     DataBufferInt localDataBufferInt = new DataBufferInt(paramInt1 * paramInt2);
/*     */     
/* 220 */     WritableRaster localWritableRaster = Raster.createPackedRaster(localDataBufferInt, paramInt1, paramInt2, paramInt1, new int[] { 16711680, 65280, 255, -16777216 }, null);
/*     */     
/*     */ 
/*     */ 
/*     */ 
...
/* Location:              E:\java_source\rt.jar!\sun\awt\IconInfo.class
