...
/*     */     }
/*     */     
/* 211 */     CharsetString localCharsetString = new CharsetString(arrayOfChar, k, paramInt2 - k, (FontDescriptor)localObject);
...
/* 219 */       for (int n = 0; n < localVector.size(); n++) {
...
/*     */         {
/* 361 */           arrayOfByte = new byte[(i1 - i + 1) * (int)localPlatformFontCache.fontDescriptor.unicodeEncoder.maxBytesPerChar() + 4];
/*     */ 
/*     */         }
/*     */         else
/*     */         {
/* 366 */           arrayOfByte = new byte[(i1 - i + 1) * (int)localPlatformFontCache.fontDescriptor.encoder.maxBytesPerChar() + 4];
/*     */         }
/*     */         
/*     */ 
/* 370 */         j = 4;
...
/*     */     }
/* 407 */     return (Object[])localObject1;
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/* Location:              E:\java_source\rt.jar!\sun\awt\PlatformFont.class
