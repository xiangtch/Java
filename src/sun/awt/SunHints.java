...
/*     */     String description;
/*     */     
/*  58 */     public Key(int paramInt, String paramString) { super();
/*  59 */       this.description = paramString;
/*     */     }
/*     */     
/*     */ 
/*     */ 
...
/*     */     {
/*  83 */       if ((paramObject instanceof Value)) {
/*  84 */         return ((Value)paramObject).isCompatibleKey(this);
/*     */       }
/*  86 */       return false;
/*     */     }
/*     */   }
...
/*     */     
/*     */ 
/*     */     private static synchronized void register(Key paramKey, Value paramValue)
/*     */     {
/* 107 */       int i = paramKey.getIndex();
/* 108 */       int j = paramValue.getIndex();
/* 109 */       if (ValueObjects[i][j] != null) {
/* 110 */         throw new InternalError("duplicate index: " + j);
/*     */       }
/* 112 */       ValueObjects[i][j] = paramValue;
/*     */     }
/*     */     
/*     */     public static Value get(int paramInt1, int paramInt2) {
/* 116 */       return ValueObjects[paramInt1][paramInt2];
/*     */     }
/*     */     
/*     */ 
/*     */ 
...
/*     */ 
/*     */ 
/*     */     public Value(Key paramKey, int paramInt, String paramString)
/*     */     {
/* 126 */       this.myKey = paramKey;
/* 127 */       this.index = paramInt;
/* 128 */       this.description = paramString;
/*     */       
/* 130 */       register(paramKey, this);
/*     */     }
/*     */     
/*     */ 
/*     */ 
...
/*     */ 
/*     */ 
/*     */     public final boolean isCompatibleKey(Key paramKey)
/*     */     {
/* 154 */       return this.myKey == paramKey;
/*     */     }
/*     */     
/*     */ 
/*     */ 
...
/*     */     {
/* 490 */       if ((paramObject instanceof Integer)) {
/* 491 */         int i = ((Integer)paramObject).intValue();
...
/* Location:              E:\java_source\rt.jar!\sun\awt\SunHints.class
