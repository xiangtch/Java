...
/* 338 */       super.setFullScreenWindow(paramWindow); return;
/*     */     }
/*     */     
...
/* 421 */       configDisplayMode(this.screen, localWWindowPeer, paramDisplayMode.getWidth(), paramDisplayMode.getHeight(), paramDisplayMode
/* 422 */         .getBitDepth(), paramDisplayMode.getRefreshRate());
/*     */       
/*     */ 
/* 425 */       Rectangle localRectangle = getDefaultConfiguration().getBounds();
/* 426 */       localWindow.setBounds(localRectangle.x, localRectangle.y, paramDisplayMode
...
/* 466 */       if ((paramDisplayMode.equals(localDisplayMode)) || (
/* 467 */         (paramDisplayMode.getRefreshRate() == 0) && 
/* 468 */         (paramDisplayMode.getWidth() == localDisplayMode.getWidth()) && 
/* 469 */         (paramDisplayMode.getHeight() == localDisplayMode.getHeight()) && 
/* 470 */         (paramDisplayMode.getBitDepth() == localDisplayMode.getBitDepth())))
/*     */       {
...
/*     */     {
/* 559 */       GraphicsDevice[] arrayOfGraphicsDevice1 = GraphicsEnvironment.getLocalGraphicsEnvironment().getScreenDevices();
/*     */       
...
/* Location:              E:\java_source\rt.jar!\sun\awt\Win32GraphicsDevice.class
