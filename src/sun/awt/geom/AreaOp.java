...
/*     */     extends CAGOp {
/*  87 */     public boolean newClassification(boolean paramBoolean1, boolean paramBoolean2) { return paramBoolean1 != paramBoolean2; } }
/*     */   
/*     */   public static class NZWindOp extends AreaOp { private int count;
/*     */     
/*  91 */     public NZWindOp() { super(); }
/*     */     
/*     */     public void newRow()
/*     */     {
/*  95 */       this.count = 0;
...
/*     */     
/*     */ 
/* 109 */     public int getState() { return this.count == 0 ? -1 : 1; } }
/*     */   
/*     */   public static class EOWindOp extends AreaOp { private boolean inside;
/*     */     
/* 113 */     public EOWindOp() { super(); }
/*     */     
/*     */     public void newRow()
/*     */     {
...
/*     */       double d1;
/* 186 */       double d2; if (((d1 = localCurve1.getYTop()) == (d2 = localCurve2.getYTop())) && 
...
/* 338 */             if ((localObject4 == null) && 
/* 339 */               (((Edge)localObject1).isActiveFor(d2, i4)))
/*     */             {
...
/*     */             }
/* 348 */             m++; } while ((m < k) && 
/* 349 */             ((localObject1 = arrayOfEdge[m]).getEquivalence() == i5));
/* 350 */           m--;
/* 351 */           if (getState() == i6) {
/* 352 */             i4 = 0;
/*     */           } else {
...
/* 370 */         if (k < i) {
/* 371 */           System.out.println("y top of next curve = " + arrayOfEdge[k]
...
/*     */ 
/*     */ 
/* 488 */         n = ((k & 0x1) == 0) && (((ChainEnd)localObject1).getX() == localChainEnd1.getX()) ? 1 : 0;
/*     */         
/* 490 */         i1 = ((m & 0x1) == 0) && (((CurveLink)localObject2).getX() == localCurveLink.getX()) ? 1 : 0;
/*     */         
/* 492 */         if ((n == 0) && (i1 == 0))
/*     */         {
/*     */ 
...
/* 500 */           if ((localChainEnd1 != null) && (d1 < d2)) {}
/*     */           
/* 502 */           n = obstructs(localChainEnd1.getX(), d2, k) ? 1 : 0;
/* 503 */           if ((localCurveLink != null) && (d2 < d1)) {}
/*     */           
/* 505 */           i1 = obstructs(localCurveLink.getX(), d1, m) ? 1 : 0;
/*     */         } }
/*     */       Object localObject3;
/* 508 */       if (n != 0) {
...
/* Location:              E:\java_source\rt.jar!\sun\awt\geom\AreaOp.class
