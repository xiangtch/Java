...
/* 130 */       double d5; double d6; switch (i) {
/*     */       case 0: 
/* 132 */         if ((d2 != d4) && 
/* 133 */           (((Crossings)localObject).accumulateLine(d3, d4, d1, d2)))
/*     */         {
/* 135 */           return null;
/*     */         }
...
/*     */       case 4: 
/* 168 */         if ((d2 != d4) && 
/* 169 */           (((Crossings)localObject).accumulateLine(d3, d4, d1, d2)))
/*     */         {
/* 171 */           return null;
/*     */         }
/* 173 */         d3 = d1;
...
/*     */ 
/*     */ 
/* 187 */     return (Crossings)localObject;
/*     */   }
/*     */   
/*     */ 
...
/* 216 */     double d1; double d2; if (paramDouble2 < this.ylo) {
...
/* 221 */       d2 = paramDouble2; }
/*     */     double d3;
/* 223 */     double d4; if (this.yhi < paramDouble4) {
...
/* 347 */             d4 = paramDouble1; }
/*     */           double d5;
/* 349 */           double d6; if (paramDouble2 < d2) {
/* 350 */             d5 = paramDouble2;
/* 351 */             d6 = d2;
/*     */           } else {
/* 353 */             d5 = d2;
...
/* Location:              E:\java_source\rt.jar!\sun\awt\geom\Crossings.class
