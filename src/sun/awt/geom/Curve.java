...
/*      */     
/*  141 */     int i = 0;
/*  142 */     while (!paramPathIterator.isDone()) { double d5;
/*  143 */       double d6; switch (paramPathIterator.currentSegment(arrayOfDouble)) {
/*      */       case 0: 
/*  145 */         if (d4 != d2) {
...
/*      */     
/*      */ 
/*  270 */       pointCrossingsForQuad(paramDouble1, paramDouble2, paramDouble3, paramDouble4, d1, d2, paramDouble5, paramDouble6, paramInt + 1) + pointCrossingsForQuad(paramDouble1, paramDouble2, paramDouble5, paramDouble6, d3, d4, paramDouble7, paramDouble8, paramInt + 1);
/*      */   }
/*      */   
/*      */ 
/*      */ 
...
/*      */     
/*      */ 
/*  328 */       pointCrossingsForCubic(paramDouble1, paramDouble2, paramDouble3, paramDouble4, paramDouble5, paramDouble6, d3, d4, d1, d2, paramInt + 1) + pointCrossingsForCubic(paramDouble1, paramDouble2, d1, d2, d5, d6, paramDouble7, paramDouble8, paramDouble9, paramDouble10, paramInt + 1);
/*      */   }
/*      */   
/*      */ 
/*      */ 
...
/*  395 */     double d4; double d2 = d4 = arrayOfDouble[1];
/*  396 */     int i = 0;
/*  397 */     while ((i != Integer.MIN_VALUE) && (!paramPathIterator.isDone())) { double d5;
/*  398 */       double d6; switch (paramPathIterator.currentSegment(arrayOfDouble)) {
/*      */       case 0: 
/*  400 */         if ((d1 != d3) || (d2 != d4)) {
...
/*      */   
/*      */ 
/*  743 */   public static long signeddiffbits(double paramDouble1, double paramDouble2) { return Double.doubleToLongBits(paramDouble1) - Double.doubleToLongBits(paramDouble2); }
/*      */   
...
/*      */   }
/*      */   
/*  750 */   public static double prev(double paramDouble) { return Double.longBitsToDouble(Double.doubleToLongBits(paramDouble) - 1L); }
/*      */   
...
/*      */ 
/*      */ 
/*  761 */       "Curve[" + getOrder() + ", " + "(" + round(getX0()) + ", " + round(getY0()) + "), " + controlPointString() + "(" + round(getX1()) + ", " + round(getY1()) + "), " + (this.direction == 1 ? "D" : "U") + "]";
/*      */   }
/*      */   
/*      */ 
/*      */ 
/*      */ 
/*  767 */   public String controlPointString() { return ""; }
/*      */   
...
/*  925 */     double d14; double d15; double d16; if (fairlyClose(d9, d10)) {
/*  926 */       d13 = d12;
/*  927 */       d14 = Math.min(d12 * 1.0E13D, (d2 - d1) * 0.1D);
/*  928 */       d15 = d1 + d13;
/*  929 */       while (d15 <= d2) {
...
/*      */     double d4;
/*      */     double d5;
/* 1065 */     double d6; if (paramDouble5 - paramDouble2 > 0.001D) {
...
/* Location:              E:\java_source\rt.jar!\sun\awt\geom\Curve.class
