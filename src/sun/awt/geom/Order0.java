...
/* 119 */     return (this.x > paramCrossings.getXLo()) && 
/* 120 */       (this.x < paramCrossings.getXHi()) && 
/* 121 */       (this.y > paramCrossings.getYLo()) && 
/* 122 */       (this.y < paramCrossings.getYHi());
/*     */   }
/*     */   
...
/* Location:              E:\java_source\rt.jar!\sun\awt\geom\Order0.class
