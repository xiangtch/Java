...
/*     */   {
/* 140 */     paramArrayOfDouble[(paramInt + 8)] = (d5 = paramArrayOfDouble[(paramInt + 4)]);
/* 141 */     paramArrayOfDouble[(paramInt + 9)] = (d6 = paramArrayOfDouble[(paramInt + 5)]);
/* 142 */     double d3 = paramArrayOfDouble[(paramInt + 2)];
/* 143 */     double d4 = paramArrayOfDouble[(paramInt + 3)];
/* 144 */     double d5 = d3 + (d5 - d3) * paramDouble;
/* 145 */     double d6 = d4 + (d6 - d4) * paramDouble;
...
/* Location:              E:\java_source\rt.jar!\sun\awt\geom\Order2.class
