...
/*     */   {
/* 196 */     paramArrayOfDouble[(paramInt + 12)] = (d7 = paramArrayOfDouble[(paramInt + 6)]);
/* 197 */     paramArrayOfDouble[(paramInt + 13)] = (d8 = paramArrayOfDouble[(paramInt + 7)]);
/* 198 */     double d5 = paramArrayOfDouble[(paramInt + 4)];
/* 199 */     double d6 = paramArrayOfDouble[(paramInt + 5)];
/* 200 */     double d7 = d5 + (d7 - d5) * paramDouble;
/* 201 */     double d8 = d6 + (d8 - d6) * paramDouble;
...
/* 360 */           Math.cos((d10 + 6.283185307179586D) / 3.0D) - d8);
/*     */       }
/* 362 */       if (d9 < 0.0D) {
/* 363 */         d9 = refine(d1, d2, d3, paramDouble, d4 * 
/* 364 */           Math.cos((d10 - 6.283185307179586D) / 3.0D) - d8);
/*     */       }
/*     */     } else {
...
/* 390 */           d11 = d9;
/* 391 */         } else { if (d15 <= paramDouble) break;
/* 392 */           d13 = d9;
/*     */         }
/*     */       }
/*     */     }
...
/*     */     double d2;
/* 417 */     double d3; if (d1 < paramDouble4) {
/* 418 */       d2 = paramDouble5;
/* 419 */       d3 = 1.0D;
/*     */     } else {
/* 421 */       d2 = 0.0D;
...
/* 425 */     double d5 = d1;
/* 426 */     int i = 1;
/* 427 */     while (d1 != paramDouble4) { double d6;
/* 428 */       if (i == 0) {
/* 429 */         d6 = (d2 + d3) / 2.0D;
/* 430 */         if ((d6 == d2) || (d6 == d3)) {
/*     */           break;
...
/* 449 */         d2 = paramDouble5;
/* 450 */       } else { if (d1 <= paramDouble4) break;
/* 451 */         d3 = paramDouble5;
/*     */       }
/*     */     }
/*     */     
...
/* 631 */     return 
/* 632 */       "(" + round(getCX0()) + ", " + round(getCY0()) + "), " + "(" + round(getCX1()) + ", " + round(getCY1()) + "), ";
/*     */   }
/*     */ }


/* Location:              E:\java_source\rt.jar!\sun\awt\geom\Order3.class
