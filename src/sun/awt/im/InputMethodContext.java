...
/*     */   static
/*     */   {
/*  76 */     String str = (String)AccessController.doPrivileged(new GetPropertyAction("java.awt.im.style", null));
/*     */     
/*  78 */     if (str == null) {
...
/* 100 */     Component localComponent = getClientComponent();
/* 101 */     return (localComponent != null) && 
/* 102 */       (localComponent.getInputMethodRequests() != null);
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */   {
/* 114 */     Component localComponent = getClientComponent();
/* 115 */     if (localComponent != null) {
/* 116 */       InputMethodEvent localInputMethodEvent = new InputMethodEvent(localComponent, paramInt1, paramAttributedCharacterIterator, paramInt2, paramTextHitInfo1, paramTextHitInfo2);
/*     */       
/*     */ 
/* 119 */       if ((haveActiveClient()) && (!useBelowTheSpotInput())) {
/* 120 */         localComponent.dispatchEvent(localInputMethodEvent);
/*     */       } else {
/* 122 */         getCompositionAreaHandler(true).processInputMethodEvent(localInputMethodEvent);
/*     */       }
/*     */     }
/*     */   }
/*     */   
...
/*     */   {
/* 143 */     if ((paramInt == 0) || 
/* 144 */       (paramAttributedCharacterIterator.getEndIndex() <= paramAttributedCharacterIterator.getBeginIndex())) {
/* 145 */       return;
/*     */     }
/* 147 */     long l = System.currentTimeMillis();
/* 148 */     this.dispatchingCommittedText = true;
/*     */     try {
/* 150 */       InputMethodRequests localInputMethodRequests = paramComponent.getInputMethodRequests();
/* 151 */       int i; Object localObject1; if (localInputMethodRequests != null)
/*     */       {
/* 153 */         i = paramAttributedCharacterIterator.getBeginIndex();
/*     */         
/* 155 */         localObject1 = new AttributedString(paramAttributedCharacterIterator, i, i + paramInt).getIterator();
/*     */         
/* 157 */         InputMethodEvent localInputMethodEvent = new InputMethodEvent(paramComponent, 1100, (AttributedCharacterIterator)localObject1, paramInt, null, null);
/*     */         
/*     */ 
/*     */ 
/*     */ 
/*     */ 
/*     */ 
/* 164 */         paramComponent.dispatchEvent(localInputMethodEvent);
/*     */       }
/*     */       else {
/* 167 */         i = paramAttributedCharacterIterator.first();
/* 168 */         while ((paramInt-- > 0) && (i != 65535)) {
/* 169 */           localObject1 = new KeyEvent(paramComponent, 400, l, 0, 0, i);
/*     */           
/* 171 */           paramComponent.dispatchEvent((AWTEvent)localObject1);
/* 172 */           i = paramAttributedCharacterIterator.next();
/*     */         }
/*     */       }
/*     */     } finally {
...
/*     */   {
/* 336 */     InputContext localInputContext = paramBoolean ? this : null;
/* 337 */     return createInputMethodWindow(paramString, localInputContext, false);
/*     */   }
/*     */   
/*     */   public JFrame createInputMethodJFrame(String paramString, boolean paramBoolean)
/*     */   {
/* 342 */     InputContext localInputContext = paramBoolean ? this : null;
/* 343 */     return (JFrame)createInputMethodWindow(paramString, localInputContext, true);
/*     */   }
/*     */   
...
/*     */     }
/* 353 */     Toolkit localToolkit = Toolkit.getDefaultToolkit();
/* 354 */     if ((localToolkit instanceof InputMethodSupport)) {
/* 355 */       return ((InputMethodSupport)localToolkit).createInputMethodWindow(paramString, paramInputContext);
/*     */     }
/*     */     
/*     */ 
...
/* Location:              E:\java_source\rt.jar!\sun\awt\im\InputMethodContext.class
