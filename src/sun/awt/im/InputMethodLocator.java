...
/*  67 */       return false;
/*     */     }
/*  69 */     if (((this.loader == null) && (localInputMethodLocator.loader != null)) || ((this.loader != null) && 
/*  70 */       (!this.loader.equals(localInputMethodLocator.loader)))) {
/*  71 */       return false;
/*     */     }
/*  73 */     if (((this.locale == null) && (localInputMethodLocator.locale != null)) || ((this.locale != null) && 
/*  74 */       (!this.locale.equals(localInputMethodLocator.locale)))) {
/*  75 */       return false;
/*     */     }
/*  77 */     return true;
/*     */   }
...
/* Location:              E:\java_source\rt.jar!\sun\awt\im\InputMethodLocator.class
