...
/*     */     Object localObject;
/* 172 */     int j; int k; if ((paramSampleModel instanceof ComponentSampleModel)) {
...
/* 395 */           paramArrayOfByte[(k++)] = this.data[j];m++;
/*     */         }
/* 392 */         n++;
/*     */       }
/*     */     }
...
/* 674 */           this.data[j] = paramArrayOfByte[(k++)];m++;
/*     */         }
/* 671 */         n++;
/*     */       }
/*     */     }
...
/* 731 */             this.data[j] = paramArrayOfByte[(k++)];m++;
/*     */           }
/* 728 */           n++;
/*     */         }
/*     */         
...
/* 934 */       if (this.dataOffsets[n] > Integer.MAX_VALUE - j) {
...
/* Location:              E:\java_source\rt.jar!\sun\awt\image\ByteComponentRaster.class
