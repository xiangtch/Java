...
/*  205 */     Object localObject; if (!(paramSampleModel instanceof PixelInterleavedSampleModel)) { if ((paramSampleModel instanceof ComponentSampleModel))
/*      */       {
/*  207 */         if (!isInterleaved((ComponentSampleModel)paramSampleModel)) {} }
/*  208 */     } else { localObject = (ComponentSampleModel)paramSampleModel;
...
/*      */       break label325; }
/*  215 */     if ((paramSampleModel instanceof SinglePixelPackedSampleModel)) {
...
/*  417 */           paramArrayOfByte[(k++)] = this.data[j];m++;
/*      */         }
/*  414 */         n++;
/*      */       }
/*      */     }
...
/*  478 */             paramArrayOfByte[(k++)] = this.data[j];m++;
/*      */           }
/*  475 */           n++;
/*      */         }
/*      */       }
...
/*  488 */             paramArrayOfByte[(k++)] = this.data[(j + i1)];m++;
/*      */           }
/*  484 */           n++;
/*      */         }
/*      */       }
...
/*  500 */               paramArrayOfByte[(k++)] = this.data[(j + i2)];m++;
/*      */             }
/*  495 */             n++;
/*      */ 
/*      */ 
...
/*  514 */               paramArrayOfByte[(k++)] = this.data[(j + i3)];m++;
/*      */             }
/*  508 */             n++;
/*      */ 
/*      */           }
...
/*  726 */           this.data[j] = paramArrayOfByte[(k++)];m++;
/*      */         }
/*  723 */         n++;
/*      */       }
/*      */     }
...
/*  781 */             this.data[j] = paramArrayOfByte[(k++)];m++;
/*      */           }
/*  778 */           n++;
/*      */         }
/*      */       }
...
/*  791 */             this.data[(j + i1)] = paramArrayOfByte[(k++)];m++;
/*      */           }
/*  787 */           n++;
/*      */         }
/*      */       }
...
/*  803 */               this.data[(j + i2)] = paramArrayOfByte[(k++)];m++;
/*      */             }
/*  798 */             n++;
/*      */ 
/*      */ 
...
/*  817 */               this.data[(j + i3)] = paramArrayOfByte[(k++)];m++;
/*      */             }
/*  811 */             n++;
/*      */ 
/*      */           }
...
/*  887 */     int j = 0;
/*      */     int k;
/*  889 */     int m; int n; if (this.packed) {
...
/*  924 */     int j = 0;
/*      */     int k;
/*  926 */     int m; int n; if (this.packed) {
...
/*  970 */     int j = 0;
/*      */     int k;
/*  972 */     int m; int n; int i1; if (this.packed) {
...
/* 1061 */     int j = 0;
/*      */     int k;
/* 1063 */     int m; int n; int i1; int i2; if (this.packed) {
...
/* Location:              E:\java_source\rt.jar!\sun\awt\image\ByteInterleavedRaster.class
