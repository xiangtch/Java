...
/* 306 */       this.global_colormap[0] = (this.global_colormap[1] = this.global_colormap[2] = 0);
/* 307 */       this.global_colormap[3] = (this.global_colormap[4] = this.global_colormap[5] = -1);
/*     */     }
/*     */     else
/*     */     {
...
/*     */       }
/*     */     }
/* 325 */     this.input.mark(Integer.MAX_VALUE);
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */ 
/*     */ 
/* 342 */   private short[] prefix = new short['က'];
/* 343 */   private byte[] suffix = new byte['က'];
/* 344 */   private byte[] outCode = new byte['ခ'];
/*     */   
/*     */ 
/*     */ 
/*     */   static
...
/* 397 */     if ((this.trans_pixel >= 0) && (!this.curframe.initialframe)) { int i2;
...
/*     */ 
/*     */ 
/* 470 */     byte[] arrayOfByte1 = new byte['ă'];
/*     */     
/*     */ 
...
/*     */     }
/* 528 */     else if ((localIndexColorModel == null) || 
/* 529 */       (this.trans_pixel != localIndexColorModel.getTransparentPixel())) {
...
/* Location:              E:\java_source\rt.jar!\sun\awt\image\GifImageDecoder.class
