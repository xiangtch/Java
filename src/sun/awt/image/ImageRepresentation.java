...
/* 235 */       if ((((DirectColorModel)localObject).getRedMask() == 16711680) && 
/* 236 */         (((DirectColorModel)localObject).getGreenMask() == 65280) && 
/* 237 */         (((DirectColorModel)localObject).getBlueMask() == 255)) {
...
/* 271 */       if ((localDirectColorModel.getRedMask() == 16711680) && 
/* 272 */         (localDirectColorModel.getGreenMask() == 65280) && 
/* 273 */         (localDirectColorModel.getBlueMask() == 255)) {
...
/* 288 */     int i1; if (((this.cmodel instanceof IndexColorModel)) && ((this.biRaster instanceof ByteComponentRaster)))
/*     */     {
/* 290 */       if (this.biRaster.getNumDataElements() == 1)
/*     */       {
...
/*     */     
/* 315 */     localObject = new int[] { 16711680, 65280, 255, -16777216 };
/*     */     
/*     */ 
/*     */ 
/*     */ 
...
/*     */       Object localObject2;
/*     */       Object localObject3;
/* 422 */       boolean bool; int i9; if ((this.isSameCM) && (this.cmodel != paramColorModel) && (this.srcLUT != null) && ((paramColorModel instanceof IndexColorModel)) && ((this.biRaster instanceof ByteComponentRaster)))
/*     */       {
/*     */ 
/*     */ 
...
/* 429 */         if (!setDiffICM(paramInt1, paramInt2, paramInt3, paramInt4, this.srcLUT, this.srcLUTtransIndex, this.numSrcLUT, (IndexColorModel)localObject2, paramArrayOfByte, paramInt5, paramInt6, (ByteComponentRaster)localObject3, ((ByteComponentRaster)localObject3)
/*     */         
/*     */ 
/* 432 */           .getDataOffset(0))) {
/* 433 */           convertToRGB();
...
/*     */             }
/* 503 */             ((IntegerComponentRaster)localObject3).setDataElements(paramInt1, i8, paramInt3, 1, arrayOfInt);i8++;
/*     */           }
/* 505 */           this.availinfo |= 0x8;
/*     */         }
/*     */       } else {
/* 508 */         if ((this.cmodel == paramColorModel) && ((this.biRaster instanceof ByteComponentRaster)))
/*     */         {
/* 510 */           if (this.biRaster.getNumDataElements() == 1) {
...
/* 529 */             this.bimage.setRGB(i5, i4, paramColorModel
/* 530 */               .getRGB(paramArrayOfByte[(j++)] & 0xFF));
/*     */           }
/* 526 */           i4++;
/*     */         }
/*     */         
...
/* 584 */             ((IntegerComponentRaster)localObject1).setDataElements(paramInt1, k, paramInt3, 1, arrayOfInt1);k++;
/*     */           }
/*     */         }
/*     */       }
/*     */       else
/*     */       {
/* 589 */         if ((paramColorModel.getTransparency() != 1) && 
/* 590 */           (this.cmodel.getTransparency() == 1)) {
/* 591 */           convertToRGB();
/*     */         }
/*     */         int j;
...
/* 598 */           int i1; if (this.cmodel.equals(paramColorModel)) {
...
/*     */               }
/* 615 */               ((IntegerComponentRaster)localObject1).setDataElements(paramInt1, k, paramInt3, 1, arrayOfInt1);k++;
/*     */             }
/*     */           }
/*     */           
...
/*     */   
/* 684 */   public void imageComplete(int paramInt) { if (this.src != null) {
...
/* Location:              E:\java_source\rt.jar!\sun\awt\image\ImageRepresentation.class
