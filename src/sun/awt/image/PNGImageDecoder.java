...
/*     */   }
/*     */   
/*  90 */   private void property(String paramString, float paramFloat) { property(paramString, new Float(paramFloat)); }
/*     */   
...
/*     */     } }
/*     */   
/*     */   protected boolean handleChunk(int paramInt1, byte[] paramArrayOfByte, int paramInt2, int paramInt3) throws IOException { int i;
/*     */     int j;
...
/*     */       }
/*     */       
/* 124 */       if (localColor != null) property("background", localColor);
/*     */       break;
/*     */     case 1665684045: 
...
/*     */       break;
/*     */     case 1749635924: 
/*     */       break; case 1229209940:  return false;
/*     */     case 1229278788: 
/*     */       break;
/* 147 */     case 1229472850:  if ((paramInt3 != 13) || 
/* 148 */         ((this.width = getInt(paramInt2)) == 0) || 
/* 149 */         ((this.height = getInt(paramInt2 + 4)) == 0))
...
/* 168 */         this.blue_map[j] = paramArrayOfByte[(m + 2)];j++;
/*     */       }
/*     */       
/*     */ 
/*     */ 
...
/* 200 */         for (;;) { k--; if (k < paramInt3) break; this.alpha_map[k] = -1;
/*     */         }
/*     */       case 2: 
/*     */       case 6: 
...
/*     */         else
/*     */         {
/* 214 */           this.transparentPixel = ((getShort(paramInt2 + 0) & 0xFF) << 16 | (getShort(paramInt2 + 2) & 0xFF) << 8 | getShort(paramInt2 + 4) & 0xFF);
/*     */         }
/* 216 */         break;
/*     */       case 0: 
/*     */       case 4: 
...
/*     */   }
/*     */   
/* 235 */   public class PNGException extends IOException { PNGException(String paramString) { super(); }
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */       
/* 258 */       int m = 0;
/* 259 */       switch (this.bitDepth) {
/* 260 */       case 1:  m = 0; break;
/* 261 */       case 2:  m = 1; break;
/* 262 */       case 4:  m = 2; break;
/* 263 */       case 8:  m = 3; break;
/* 264 */       case 16:  m = 4; break;
/* 265 */       default:  throw new PNGException("invalid depth"); }
/*     */       int k;
/* 267 */       if (this.interlaceMethod != 0) { j *= this.height;k = this.width;
/* 268 */       } else { k = 0; }
...
/* 333 */       int i5 = i4 + 7 >> 3;
/*     */       int i6;
/* 335 */       int i7; if (this.interlaceMethod == 0) { i6 = -1;i7 = 0;
/* 336 */       } else { i6 = 0;i7 = 7;
/*     */       }
/*     */       
/*     */ 
...
/* 375 */               if (arrayOfInt != null) { int i24;
/* 376 */                 switch (n) {
/*     */                 case 70: 
...
/* 451 */                   i21++;
/* 452 */                   break;
/* 453 */                 case 8:  arrayOfByte1[(i20 + i17)] = localObject1[(i21++)];
/* 454 */                   break;
/* 455 */                 case 16:  arrayOfByte1[(i20 + i17)] = localObject1[i21];i21 += 2;
/* 456 */                   break;
...
/*     */ 
/*     */ 
/* 519 */       imageComplete(3, true); return;
/*     */ 
/*     */     }
...
/* 575 */         int tmp57_55 = i; byte[] tmp57_54 = paramArrayOfByte1;tmp57_54[tmp57_55] = ((byte)(tmp57_54[tmp57_55] + paramArrayOfByte1[(i - paramInt3)]));i++; continue;
/*     */         
/*     */ 
/* 578 */         if (paramArrayOfByte2 != null)
/* 579 */           while (i < paramInt2) {
/* 580 */             int tmp89_87 = i; byte[] tmp89_86 = paramArrayOfByte1;tmp89_86[tmp89_87] = ((byte)(tmp89_86[tmp89_87] + paramArrayOfByte2[i]));i++; continue;
/*     */             
/*     */ 
/* 583 */             if (paramArrayOfByte2 != null) {
/* 584 */               for (; i < paramInt3; i++) {
/* 585 */                 int tmp118_116 = i; byte[] tmp118_115 = paramArrayOfByte1;tmp118_115[tmp118_116] = ((byte)(tmp118_115[tmp118_116] + ((0xFF & paramArrayOfByte2[i]) >> 1))); }
/* 586 */               for (; i < paramInt2; i++) {
/* 587 */                 int tmp149_147 = i; byte[] tmp149_146 = paramArrayOfByte1;tmp149_146[tmp149_147] = ((byte)(tmp149_146[tmp149_147] + ((paramArrayOfByte2[i] & 0xFF) + (paramArrayOfByte1[(i - paramInt3)] & 0xFF) >> 1)));
/*     */               } }
/* 589 */             for (i = paramInt3; i < paramInt2;) {
/* 590 */               int tmp196_194 = i; byte[] tmp196_193 = paramArrayOfByte1;tmp196_193[tmp196_194] = ((byte)(tmp196_193[tmp196_194] + ((paramArrayOfByte1[(i - paramInt3)] & 0xFF) >> 1)));i++; continue;
/*     */               
/*     */ 
/* 593 */               if (paramArrayOfByte2 != null) {
/* 594 */                 for (; i < paramInt3; i++) {
/* 595 */                   int tmp234_232 = i; byte[] tmp234_231 = paramArrayOfByte1;tmp234_231[tmp234_232] = ((byte)(tmp234_231[tmp234_232] + paramArrayOfByte2[i])); }
...
/* 604 */                   int i3 = n > m ? n - m : m - n; int 
/* 605 */                     tmp371_369 = i; byte[] tmp371_368 = paramArrayOfByte1;tmp371_368[tmp371_369] = ((byte)(tmp371_368[tmp371_369] + (i2 <= i3 ? k : (i1 <= i2) && (i1 <= i3) ? j : m)));
/*     */                 }
/*     */               }
/* 608 */               for (i = paramInt3; i < paramInt2;) {
/* 609 */                 int tmp429_427 = i; byte[] tmp429_426 = paramArrayOfByte1;tmp429_426[tmp429_427] = ((byte)(tmp429_426[tmp429_427] + paramArrayOfByte1[(i - paramInt3)]));i++; continue;
/*     */                 
/*     */ 
...
/*     */ 
/*     */ 
/* 663 */   byte[] inbuf = new byte['က'];
/*     */   
/* 665 */   private void fill() throws IOException { if (!this.seenEOF) {
...
/*     */   }
/*     */   
/* 695 */   private final int getInt(int paramInt) { return (this.inbuf[paramInt] & 0xFF) << 24 | (this.inbuf[(paramInt + 1)] & 0xFF) << 16 | (this.inbuf[(paramInt + 2)] & 0xFF) << 8 | this.inbuf[(paramInt + 3)] & 0xFF; }
/*     */   
/*     */ 
/*     */ 
...
/*     */   
/*     */ 
/* 705 */   private final int getByte(int paramInt) { return this.inbuf[paramInt] & 0xFF; }
/*     */   
...
/*     */   }
/*     */   
/* 722 */   private void readAll() throws IOException { while (getChunk()) handleChunk(this.chunkKey, this.inbuf, this.chunkStart, this.chunkLength);
/*     */   }
/*     */   
...
/*     */   }
/*     */   
/* 742 */   protected void wrk(int paramInt) { wrc(paramInt >> 24);
/* 743 */     wrc(paramInt >> 16);
/* 744 */     wrc(paramInt >> 8);
/* 745 */     wrc(paramInt);
/*     */   }
/*     */   
/* 748 */   public void print() { wrk(this.chunkKey);
/* 749 */     System.out.print(" " + this.chunkLength + "\n");
/*     */   }
/*     */   
/*     */ 
/* 753 */   private static final int[] crc_table = new int['Ā'];
/*     */   
/*     */   static
/*     */   {
...
/*     */   {
/* 774 */     int i = paramInt1;
/* 775 */     for (;;) { paramInt3--; if (paramInt3 < 0) break;
...
/*     */ 
/*     */ 
/* 782 */   private static int crc(byte[] paramArrayOfByte, int paramInt1, int paramInt2) { return update_crc(-1, paramArrayOfByte, paramInt1, paramInt2) ^ 0xFFFFFFFF; }
/*     */   
/*     */   public static class Chromaticities { public float whiteX;
/*     */     public float whiteY;
/*     */     
/* 787 */     Chromaticities(int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5, int paramInt6, int paramInt7, int paramInt8) { this.whiteX = (paramInt1 / 100000.0F);
...
/*     */     }
/*     */     
/* 797 */     public String toString() { return "Chromaticities(white=" + this.whiteX + "," + this.whiteY + ";red=" + this.redX + "," + this.redY + ";green=" + this.greenX + "," + this.greenY + ";blue=" + this.blueX + "," + this.blueY + ")"; }
/*     */     
/*     */     public float redX;
/*     */     public float redY;
/*     */     public float greenX;
...
/* Location:              E:\java_source\rt.jar!\sun\awt\image\PNGImageDecoder.class
