...
/* 394 */           paramArrayOfShort[(k++)] = this.data[j];m++;
/*     */         }
/* 391 */         n++;
/*     */       }
/*     */     }
...
/* 635 */           this.data[j] = paramArrayOfShort[(k++)];m++;
/*     */         }
/* 632 */         n++;
/*     */       }
/*     */     }
...
/* 868 */       if (this.dataOffsets[n] > Integer.MAX_VALUE - j) {
...
/* Location:              E:\java_source\rt.jar!\sun\awt\image\ShortComponentRaster.class
