...
/*     */     Object localObject;
/*     */     int i;
/* 144 */     int j; if (!(paramSampleModel instanceof PixelInterleavedSampleModel)) { if ((paramSampleModel instanceof ComponentSampleModel))
/*     */       {
/* 146 */         if (paramSampleModel.getNumBands() != 1) {} }
/* 147 */     } else { localObject = (ComponentSampleModel)paramSampleModel;
/*     */       
...
/*     */       break label313; }
/* 157 */     if ((paramSampleModel instanceof SinglePixelPackedSampleModel)) {
...
/* 367 */           paramArrayOfShort[(k++)] = this.data[j];m++;
/*     */         }
/* 364 */         n++;
/*     */       }
/*     */     }
...
/* 607 */           this.data[j] = paramArrayOfShort[(k++)];m++;
/*     */         }
/* 604 */         n++;
/*     */       }
/*     */     }
...
/* Location:              E:\java_source\rt.jar!\sun\awt\image\ShortInterleavedRaster.class
