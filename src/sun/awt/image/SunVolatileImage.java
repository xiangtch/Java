...
/*     */   {
/* 107 */     this(paramComponent, paramInt1, paramInt2, null);
/*     */   }
/*     */   
/*     */ 
/*     */   public SunVolatileImage(Component paramComponent, int paramInt1, int paramInt2, Object paramObject)
/*     */   {
/* 113 */     this(paramComponent, paramComponent.getGraphicsConfiguration(), paramInt1, paramInt2, paramObject, null);
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */   {
/* 121 */     this(null, paramGraphicsConfiguration, paramInt1, paramInt2, null, paramInt3, paramImageCapabilities, 0);
/*     */   }
/*     */   
/*     */   public int getWidth()
/*     */   {
...
/* 142 */       GraphicsConfiguration localGraphicsConfiguration = this.comp.getGraphicsConfiguration();
/* 143 */       if (localGraphicsConfiguration != null)
/*     */       {
/*     */ 
/*     */ 
/* 147 */         this.graphicsConfig = localGraphicsConfiguration;
/*     */       }
/*     */     }
/*     */   }
/*     */   
...
/*     */   {
/* 175 */     if ((!(this.graphicsConfig instanceof BufferedImageGraphicsConfig)) && (!(this.graphicsConfig instanceof PrinterGraphicsConfig))) { if (paramImageCapabilities != null)
/*     */       {
/* 177 */         if (paramImageCapabilities.isAccelerated()) {} }
/*     */     } else {
/* 179 */       return new BufImgVolatileSurfaceManager(this, paramObject);
/*     */     }
/* 181 */     SurfaceManagerFactory localSurfaceManagerFactory = SurfaceManagerFactory.getInstance();
/* 182 */     return localSurfaceManagerFactory.createVolatileManager(this, paramObject);
/*     */   }
/*     */   
...
/* 245 */     BufferedImage localBufferedImage = getBackupImage();
/* 246 */     Graphics2D localGraphics2D = localBufferedImage.createGraphics();
/* 247 */     localGraphics2D.setComposite(AlphaComposite.Src);
/* 248 */     localGraphics2D.drawImage(this, 0, 0, null);
/* 249 */     localGraphics2D.dispose();
/* 250 */     return localBufferedImage;
/*     */   }
/*     */   
...
/* Location:              E:\java_source\rt.jar!\sun\awt\image\SunVolatileImage.class
