...
/*     */     
/*     */ 
/* 100 */     GraphicsEnvironment localGraphicsEnvironment = GraphicsEnvironment.getLocalGraphicsEnvironment();
/*     */     
/*     */ 
...
/*     */     
/*     */ 
/* 123 */     if ((this.sdCurrent == null) && 
/* 124 */       (this.vImg.getForcedAccelSurfaceType() == 0))
/*     */     {
...
/*     */       
/* 265 */       SunWritableRaster.stealTrackable(localBufferedImage
/* 266 */         .getRaster()
...
/*     */   {
/* 366 */     return (paramGraphicsConfiguration == null) || 
/* 367 */       (paramGraphicsConfiguration.getDevice() == this.vImg.getGraphicsConfig().getDevice());
/*     */   }
/*     */   
...
/* Location:              E:\java_source\rt.jar!\sun\awt\image\VolatileSurfaceManager.class
