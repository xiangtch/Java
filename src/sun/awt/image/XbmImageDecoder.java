...
/*  86 */     int i; while ((!this.aborted) && ((i = this.input.read()) != -1))
...
/* 112 */           k = 2; } else { int i5;
/* 113 */           int i6; if ((i4 > 2) && (k < 0) && (arrayOfChar[0] == '0') && (arrayOfChar[1] == 'x')) {
/* 114 */             i5 = 0;
...
/* Location:              E:\java_source\rt.jar!\sun\awt\image\XbmImageDecoder.class
