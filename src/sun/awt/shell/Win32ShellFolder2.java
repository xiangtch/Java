...
/*      */         public Void call() {
/*  184 */           if (FolderDisposer.this.relativePIDL != 0L) {
/*  185 */             Win32ShellFolder2.releasePIDL(FolderDisposer.this.relativePIDL);
/*      */           }
/*  187 */           if (FolderDisposer.this.absolutePIDL != 0L) {
/*  188 */             Win32ShellFolder2.releasePIDL(FolderDisposer.this.absolutePIDL);
/*      */           }
/*  190 */           if (FolderDisposer.this.pIShellFolder != 0L) {
/*  191 */             Win32ShellFolder2.releaseIShellFolder(FolderDisposer.this.pIShellFolder);
/*      */           }
/*  193 */           return null;
/*      */         }
/*  195 */       });
...
/*      */   
/*  201 */   private void setIShellFolder(long paramLong) { this.disposer.pIShellFolder = paramLong; }
/*      */   
...
/*      */ 
/*      */ 
/*  272 */         return null; } }, InterruptedException.class);
/*      */     
/*      */ 
/*      */ 
...
/*  296 */       (String)invoke(new Callable()
/*      */       {
/*      */ 
/*  298 */         public String call() { return Win32ShellFolder2.getFileSystemPath(Win32ShellFolder2.access$200(Win32ShellFolder2.this), paramLong); } }, RuntimeException.class));
/*      */     
/*      */ 
/*      */ 
...
/*  403 */             if (l1 == 0L)
/*      */             {
/*  405 */               throw new InternalError("Parent IShellFolder was null for " + Win32ShellFolder2.this.getAbsolutePath());
/*      */             }
/*      */             
/*      */ 
/*      */ 
...
/*  412 */             if (l2 == 0L)
/*      */             {
/*  414 */               throw new InternalError("Unable to bind " + Win32ShellFolder2.this.getAbsolutePath() + " to parent");
/*      */             }
/*  416 */             return Long.valueOf(l2); } }, RuntimeException.class)).longValue();
/*      */       }
...
/*      */     {
/*  500 */       return (pathsEqual(getPath(), localWin32ShellFolder2.getPath())) && ((this.parent == localWin32ShellFolder2.parent) || 
/*  501 */         (this.parent.equals(localWin32ShellFolder2.parent)));
/*      */     }
/*      */     
...
/*      */   {
/*  517 */     ((Boolean)invoke(new Callable()
/*      */     {
/*  519 */       public Boolean call() { return Boolean.valueOf(Win32ShellFolder2.compareIDs(this.val$pIShellFolder, paramLong3, this.val$pidl2) == 0); } }, RuntimeException.class)).booleanValue();
/*      */   }
/*      */   
/*      */ 
/*      */ 
...
/*  548 */           .getRelativePIDL(), paramInt) & paramInt) != 0);
/*      */ 
/*      */       }
/*      */       
/*      */ 
...
/*      */     {
/*  588 */       public String call() throws IOException { return Win32ShellFolder2.getFileSystemPath0(this.val$csidl); } }, IOException.class);
/*      */     
/*      */ 
/*  591 */     if (str != null) {
...
/*      */     throws InterruptedException
/*      */   {
/*  639 */     ((Long)invoke(new Callable() {
/*      */       public Long call() {
/*  641 */         boolean bool = Win32ShellFolder2.this.disposer.pIShellFolder == Win32ShellFolder2.this.getDesktopIShellFolder();
/*      */         
/*  643 */         return Long.valueOf(Win32ShellFolder2.this.getEnumObjects(Win32ShellFolder2.this.disposer.pIShellFolder, bool, paramBoolean)); } }, RuntimeException.class)).longValue();
/*      */   }
/*      */   
/*      */ 
/*      */ 
...
/*      */               label178:
/*  707 */               do { long l3 = Win32ShellFolder2.this.getNextChild(l2);
/*  708 */                 int j = 1;
/*  709 */                 if ((l3 != 0L) && 
/*  710 */                   ((Win32ShellFolder2.getAttributes0(l1, l3, i) & i) != 0))
/*      */                 {
/*  712 */                   if ((Win32ShellFolder2.this.equals(localWin32ShellFolder21)) && (localWin32ShellFolder22 != null))
/*      */                   {
/*  714 */                     if (Win32ShellFolder2.pidlsEqual(l1, l3, localWin32ShellFolder22.disposer.relativePIDL)) {
/*  715 */                       localWin32ShellFolder23 = localWin32ShellFolder22;
/*      */                       break label178; } }
/*  717 */                   Win32ShellFolder2 localWin32ShellFolder23 = new Win32ShellFolder2(Win32ShellFolder2.this, l3);
/*  718 */                   j = 0;
/*      */                   
...
/*      */             }
/*      */           }
/*  730 */           return Thread.currentThread().isInterrupted() ? new File[0] : 
/*      */           
/*  732 */             (File[])localArrayList.toArray(new ShellFolder[localArrayList.size()]); } }, InterruptedException.class);
/*      */     }
/*      */     catch (InterruptedException localInterruptedException) {}
/*      */     
...
/*      */     throws InterruptedException
/*      */   {
/*  747 */     (Win32ShellFolder2)invoke(new Callable() {
...
/*  767 */         return localWin32ShellFolder2; } }, InterruptedException.class);
/*      */   }
/*      */   
/*      */ 
/*      */ 
...
/*  807 */     (ShellFolder)invoke(new Callable() {
...
/*  814 */         long l = Win32ShellFolder2.getLinkLocation(Win32ShellFolder2.this.getParentIShellFolder(), Win32ShellFolder2.this
/*  815 */           .getRelativePIDL(), paramBoolean);
/*  816 */         if (l != 0L) {
/*      */           try
/*      */           {
/*  819 */             localWin32ShellFolder2 = Win32ShellFolderManager2.createShellFolderFromRelativePIDL(Win32ShellFolder2.this.getDesktop(), l);
/*      */           }
...
/*      */   {
/*  835 */     ((Long)invoke(new Callable()
/*      */     {
/*  837 */       public Long call() throws IOException { return Long.valueOf(Win32ShellFolder2.parseDisplayName0(Win32ShellFolder2.access$200(Win32ShellFolder2.this), paramString)); } }, IOException.class)).longValue();
/*      */   }
/*      */   
/*      */ 
/*      */ 
...
/*      */     {
/*  857 */       this.displayName = ((String)invoke(new Callable() {
/*      */         public String call() {
/*  859 */           return Win32ShellFolder2.getDisplayNameOf(Win32ShellFolder2.this.getParentIShellFolder(), Win32ShellFolder2.this
/*  860 */             .getRelativePIDL(), 0);
/*      */         }
/*      */       }));
/*      */     }
...
/*      */       
/*  878 */       this.folderType = ((String)invoke(new Callable()
/*      */       {
/*      */         public String call() {
...
/*      */     {
/*  968 */       localImage = (Image)invoke(new Callable() {
/*      */         public Image call() {
/*  970 */           Image localImage = null;
/*  971 */           long l1; if (Win32ShellFolder2.this.isFileSystem())
/*      */           {
/*  973 */             l1 = Win32ShellFolder2.this.parent != null ? ((Win32ShellFolder2)Win32ShellFolder2.this.parent).getIShellIcon() : 0L;
/*      */             
...
/*      */           {
/* 1000 */             l1 = Win32ShellFolder2.extractIcon(Win32ShellFolder2.this.getParentIShellFolder(), Win32ShellFolder2.this
/* 1001 */               .getRelativePIDL(), paramBoolean);
...
/*      */   {
/* 1093 */     (ShellFolderColumnInfo[])invoke(new Callable() {
...
/* 1103 */               localShellFolderColumnInfo.setAlignment(Integer.valueOf(localShellFolderColumnInfo
/*      */               
/* 1105 */                 .getAlignment().intValue() == 2 ? 0 : localShellFolderColumnInfo.getAlignment().intValue() == 1 ? 4 : 10));
/*      */               
/*      */ 
/*      */ 
/* 1109 */               localShellFolderColumnInfo.setComparator(new ColumnComparator(Win32ShellFolder2.this, i));
/*      */               
...
/*      */   
/*      */ 
/* 1143 */   public void sortChildren(final List<? extends File> paramList) { invoke(new Callable() {
/*      */       public Void call() {
/* 1145 */         Collections.sort(paramList, new ColumnComparator(Win32ShellFolder2.this, 0));
/*      */         
/* 1147 */         return null;
/*      */       }
/*      */     }); }
...
/*      */           {
/*      */ 
/* 1169 */             return Integer.valueOf(Win32ShellFolder2.compareIDsByColumn(Win32ShellFolder2.access$200(Win32ShellFolder2.this), ((Win32ShellFolder2)paramFile1)
/* 1170 */               .getRelativePIDL(), ((Win32ShellFolder2)paramFile2)
/* 1171 */               .getRelativePIDL(), 
/* 1172 */               ColumnComparator.this.columnIdx));
/*      */           }
...
/* Location:              E:\java_source\rt.jar!\sun\awt\shell\Win32ShellFolder2.class
