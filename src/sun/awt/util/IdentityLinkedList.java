...
/*     */     }
/* 126 */     return (E)this.header.next.element;
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */     }
/* 139 */     return (E)this.header.previous.element;
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */   {
/* 149 */     return (E)remove(this.header.next);
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */   public E removeLast()
/*     */   {
/* 159 */     return (E)remove(this.header.previous);
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */   {
/* 320 */     return (E)entry(paramInt).element;
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */   {
/* 362 */     return (E)remove(entry(paramInt));
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/* 373 */     int i; if (paramInt < this.size >> 1) {
...
/* 653 */     private Entry<E> lastReturned = IdentityLinkedList.this.header;
/*     */     private Entry<E> next;
/*     */     private int nextIndex;
/* 656 */     private int expectedModCount = IdentityLinkedList.this.modCount;
/*     */     
/*     */     ListItr(int paramInt) {
/* 659 */       if ((paramInt < 0) || (paramInt > IdentityLinkedList.this.size))
/*     */       {
/* 661 */         throw new IndexOutOfBoundsException("Index: " + paramInt + ", Size: " + IdentityLinkedList.this.size); }
/* 662 */       if (paramInt < IdentityLinkedList.this.size >> 1) {
/* 663 */         this.next = IdentityLinkedList.this.header.next;
/* 664 */         for (this.nextIndex = 0; this.nextIndex < paramInt; this.nextIndex += 1)
/* 665 */           this.next = this.next.next;
/*     */       }
/* 667 */       this.next = IdentityLinkedList.this.header;
/* 668 */       for (this.nextIndex = IdentityLinkedList.this.size; this.nextIndex > paramInt; this.nextIndex -= 1) {
...
/* 685 */       return (E)this.lastReturned.element;
/*     */     }
/*     */     
...
/* 699 */       return (E)this.lastReturned.element;
/*     */     }
/*     */     
...
/* 712 */       Entry localEntry = this.lastReturned.next;
/*     */       try {
...
/*     */ 
/*     */ 
/* 786 */   public Iterator<E> descendingIterator() { return new DescendingIterator(null); }
/*     */   
/*     */   private class DescendingIterator implements Iterator {
/*     */     private DescendingIterator() {}
/*     */     
/* 791 */     final ListItr itr = new ListItr(IdentityLinkedList.this, IdentityLinkedList.this.size());
/*     */     
/* 793 */     public boolean hasNext() { return this.itr.hasPrevious(); }
/*     */     
/*     */     public E next() {
/* 796 */       return (E)this.itr.previous();
/*     */     }
/*     */     
/* 799 */     public void remove() { this.itr.remove(); }
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/* 865 */       paramArrayOfT = (Object[])Array.newInstance(paramArrayOfT
...
/* Location:              E:\java_source\rt.jar!\sun\awt\util\IdentityLinkedList.class
