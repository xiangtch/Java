...
/*     */   {
/*  89 */     (Method)AccessController.doPrivileged(new PrivilegedAction()
/*     */     {
/*     */ 
/*     */       public Object run()
/*     */       {
...
/*     */         try
/*     */         {
/*  97 */           Class localClass = ObjectInputStream.class;
/*  98 */           localMethod = localClass.getDeclaredMethod("latestUserDefinedLoader", 
/*  99 */             Bridge.NO_ARGS);
...
/*     */         try
/*     */         {
/* 123 */           Class localClass = Unsafe.class;
/* 124 */           localField = localClass.getDeclaredField("theUnsafe");
...
/* 197 */       Error localError = new Error("sun.corba.Bridge.latestUserDefinedLoader: " + localIllegalAccessException);
/*     */       
...
/* Location:              E:\java_source\rt.jar!\sun\corba\Bridge.class
