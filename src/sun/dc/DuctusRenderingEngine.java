...
/*  97 */       Object localObject1; if (paramArrayOfFloat != null) {
...
/* 142 */     localPathStroker.setCorners(RasterizerCorners[paramBasicStroke.getLineJoin()], paramBasicStroke
/* 143 */       .getMiterLimit());
/* 144 */     float[] arrayOfFloat2 = paramBasicStroke.getDashArray();
/* 145 */     Object localObject2; if (arrayOfFloat2 != null) {
...
/*     */       return;
/* 161 */     } catch (PathException localPathException) { throw new InternalError("Unable to Stroke shape (" + localPathException.getMessage() + ")", localPathException);
/*     */     } finally {
/* 163 */       while ((localObject1 != null) && (localObject1 != paramPathConsumer2D)) {
/* 164 */         localPathConsumer = ((PathConsumer)localObject1).getConsumer();
...
/* 301 */             j = 0;
/*     */           }
/* 303 */           else if ((arrayOfFloat[0] < 1.7014117E38F) && (arrayOfFloat[0] > -1.7014117E38F) && (arrayOfFloat[1] < 1.7014117E38F) && (arrayOfFloat[1] > -1.7014117E38F))
/*     */           {
/*     */ 
...
/* 330 */             j = 0;
/*     */           }
/* 332 */           else if ((arrayOfFloat[0] < 1.7014117E38F) && (arrayOfFloat[0] > -1.7014117E38F) && (arrayOfFloat[1] < 1.7014117E38F) && (arrayOfFloat[1] > -1.7014117E38F) && (arrayOfFloat[2] < 1.7014117E38F) && (arrayOfFloat[2] > -1.7014117E38F) && (arrayOfFloat[3] < 1.7014117E38F) && (arrayOfFloat[3] > -1.7014117E38F))
/*     */           {
/*     */ 
/*     */ 
/*     */ 
...
/* 404 */         localRasterizer.setPenDiameter(0.19999999F);
/*     */       } else {
...
/* 414 */       localRasterizer.setCorners(RasterizerCorners[paramBasicStroke.getLineJoin()], paramBasicStroke
/* 415 */         .getMiterLimit());
...
/*     */ 
/*     */       case 0: 
/* 507 */         if ((arrayOfFloat3[0] < 1.7014117E38F) && (arrayOfFloat3[0] > -1.7014117E38F) && (arrayOfFloat3[1] < 1.7014117E38F) && (arrayOfFloat3[1] > -1.7014117E38F))
/*     */         {
/*     */ 
...
/*     */ 
/*     */       case 1: 
/* 527 */         if ((arrayOfFloat3[0] < 1.7014117E38F) && (arrayOfFloat3[0] > -1.7014117E38F) && (arrayOfFloat3[1] < 1.7014117E38F) && (arrayOfFloat3[1] > -1.7014117E38F))
/*     */         {
/*     */ 
/* 530 */           if (j != 0) {
...
/* 533 */             j = 0;
/*     */           } else {
/* 535 */             localRasterizer.appendLine(arrayOfFloat3[0], arrayOfFloat3[1]);
/*     */           }
/*     */         }
/*     */         
/*     */ 
...
/*     */         break;
/*     */       case 2: 
/* 550 */         if ((arrayOfFloat3[2] < 1.7014117E38F) && (arrayOfFloat3[2] > -1.7014117E38F) && (arrayOfFloat3[3] < 1.7014117E38F) && (arrayOfFloat3[3] > -1.7014117E38F))
/*     */         {
/*     */ 
/* 553 */           if (j != 0) {
...
/* 556 */             j = 0;
/*     */           }
/* 558 */           else if ((arrayOfFloat3[0] < 1.7014117E38F) && (arrayOfFloat3[0] > -1.7014117E38F) && (arrayOfFloat3[1] < 1.7014117E38F) && (arrayOfFloat3[1] > -1.7014117E38F))
/*     */           {
/*     */ 
/* 561 */             localRasterizer.appendQuadratic(arrayOfFloat3[0], arrayOfFloat3[1], arrayOfFloat3[2], arrayOfFloat3[3]);
/*     */           }
/*     */           else {
/* 564 */             localRasterizer.appendLine(arrayOfFloat3[2], arrayOfFloat3[3]);
/*     */           }
/*     */         }
/*     */         
/*     */ 
...
/*     */         break;
/*     */       case 3: 
/* 580 */         if ((arrayOfFloat3[4] < 1.7014117E38F) && (arrayOfFloat3[4] > -1.7014117E38F) && (arrayOfFloat3[5] < 1.7014117E38F) && (arrayOfFloat3[5] > -1.7014117E38F))
/*     */         {
/*     */ 
/* 583 */           if (j != 0) {
...
/* 586 */             j = 0;
/*     */           }
/* 588 */           else if ((arrayOfFloat3[0] < 1.7014117E38F) && (arrayOfFloat3[0] > -1.7014117E38F) && (arrayOfFloat3[1] < 1.7014117E38F) && (arrayOfFloat3[1] > -1.7014117E38F) && (arrayOfFloat3[2] < 1.7014117E38F) && (arrayOfFloat3[2] > -1.7014117E38F) && (arrayOfFloat3[3] < 1.7014117E38F) && (arrayOfFloat3[3] > -1.7014117E38F))
/*     */           {
/*     */ 
/*     */ 
/*     */ 
...
/*     */           else
/*     */           {
/* 597 */             localRasterizer.appendLine(arrayOfFloat3[4], arrayOfFloat3[5]);
/*     */           }
/*     */         }
/*     */         
/*     */         break;
...
/*     */     double d1;
/* 653 */     double d2; double d3; double d4; if (i != 0) {
...
/* 766 */       throw new InternalError("Unable to Stroke shape (" + localPathException.getMessage() + ")", localPathException);
/*     */     }
/*     */   }
/*     */   
...
/* Location:              E:\java_source\rt.jar!\sun\dc\DuctusRenderingEngine.class
