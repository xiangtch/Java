...
/*  166 */         switch (k) {
/*  167 */         case 0:  m = i; break;
/*  168 */         case 1:  n = i; break;
/*  169 */         case 2:  i1 = i; break;
/*  170 */         case 3:  i2 = i; break;
/*  171 */         case 4:  i3 = i; break;
/*  172 */         case 5:  i4 = i; break;
/*  173 */         case 6:  i5 = i; break;
/*  174 */         case 10:  i6 = i;
/*      */         }
/*      */         
/*      */       }
...
/*      */       }
/*  220 */       else if (i1 != 0) {
/*  221 */         localCMap = createCMap(localByteBuffer, i1, 
/*  222 */           getConverterMap((short)2));
/*      */       }
/*  224 */       else if (i2 != 0) {
/*  225 */         localCMap = createCMap(localByteBuffer, i2, 
...
/*      */ 
/*      */ 
/*  235 */         if ((FontUtilities.isSolaris) && (paramTrueTypeFont.platName != null) && (
/*  236 */           (paramTrueTypeFont.platName.startsWith("/usr/openwin/lib/locale/zh_CN.EUC/X11/fonts/TrueType")) || 
/*      */           
/*  238 */           (paramTrueTypeFont.platName.startsWith("/usr/openwin/lib/locale/zh_CN/X11/fonts/TrueType")) || 
/*      */           
/*  240 */           (paramTrueTypeFont.platName.startsWith("/usr/openwin/lib/locale/zh/X11/fonts/TrueType"))))
/*      */         {
/*  242 */           localCMap = createCMap(localByteBuffer, i3, 
/*  243 */             getConverterMap((short)3));
/*      */         }
/*      */         else {
/*  246 */           localCMap = createCMap(localByteBuffer, i3, 
/*  247 */             getConverterMap((short)4));
/*      */         }
/*      */       }
/*  250 */       else if (i4 != 0) {
/*  251 */         localCMap = createCMap(localByteBuffer, i4, 
/*  252 */           getConverterMap((short)5));
/*      */       }
/*  254 */       else if (i5 != 0) {
/*  255 */         localCMap = createCMap(localByteBuffer, i5, 
...
/*      */ 
/*      */ 
/*  340 */       Charset.forName(str).newDecoder().onMalformedInput(CodingErrorAction.REPLACE).onUnmappableCharacter(CodingErrorAction.REPLACE).replaceWith("\000").decode(ByteBuffer.wrap(arrayOfByte, 0, arrayOfByte.length), 
...
/*      */     
/*  414 */     switch (i) {
/*  415 */     case 0:  return new CMapFormat0(paramByteBuffer, paramInt);
/*  416 */     case 2:  return new CMapFormat2(paramByteBuffer, paramInt, paramArrayOfChar);
/*  417 */     case 4:  return new CMapFormat4(paramByteBuffer, paramInt, paramArrayOfChar);
/*  418 */     case 6:  return new CMapFormat6(paramByteBuffer, paramInt, paramArrayOfChar);
/*  419 */     case 8:  return new CMapFormat8(paramByteBuffer, paramInt, paramArrayOfChar);
/*  420 */     case 10:  return new CMapFormat10(paramByteBuffer, paramInt, paramArrayOfChar);
/*  421 */     case 12:  return new CMapFormat12(paramByteBuffer, paramInt, paramArrayOfChar);
/*      */     }
/*  423 */     throw new RuntimeException("Cmap format unimplemented: " + paramByteBuffer.getChar(paramInt));
/*      */   }
/*      */   
/*      */ 
/*      */ 
...
/*      */     extends CMap
/*      */   {
/*  718 */     char[] subHeaderKey = new char['Ā'];
/*      */     
/*      */ 
/*      */     char[] firstCodeArray;
/*      */     
...
/* Location:              E:\java_source\rt.jar!\sun\font\CMap.class
