...
/*     */     {
/* 235 */       float f1 = 0.0F;
/* 236 */       float f2; if (this.stdUnderline != null)
/*     */       {
...
/*     */ 
/*     */ 
/*     */     private void drawTextAndEmbellishments(Label paramLabel, Graphics2D paramGraphics2D, float paramFloat1, float paramFloat2)
/*     */     {
...
/*     */         Paint localPaint2;
/*     */         Object localObject2;
/* 302 */         Object localObject1; if (this.swapColors) {
...
/*     */ 
/*     */ 
/* 310 */               int i = 33 * ((Color)localObject2).getRed() + 53 * ((Color)localObject2).getGreen() + 14 * ((Color)localObject2).getBlue();
/* 311 */               localObject1 = i > 18500 ? Color.BLACK : Color.WHITE;
/*     */             } else {
/* 313 */               localObject1 = Color.WHITE;
/*     */             }
/*     */           } else {
/* 316 */             localObject1 = this.bgPaint;
/*     */           }
/*     */         }
/*     */         else {
...
/*     */ 
/*     */ 
/* 330 */           localObject2 = new Rectangle2D.Float(paramFloat1 + (float)((Rectangle2D)localObject2).getX(), paramFloat2 + (float)((Rectangle2D)localObject2).getY(), (float)((Rectangle2D)localObject2).getWidth(), (float)((Rectangle2D)localObject2).getHeight());
/*     */           
...
/* Location:              E:\java_source\rt.jar!\sun\font\Decoration.class
