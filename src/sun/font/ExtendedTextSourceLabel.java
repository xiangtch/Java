...
/*      */       
/*  109 */       LineMetrics localLineMetrics = this.font.getLineMetrics(this.source.getChars(), this.source.getStart(), this.source
...
/*      */     }
/*  126 */     return new Float((float)(this.lb.getX() + paramFloat1),
...
/*      */     }
/*  143 */     return new Float((float)(this.vb.getX() + paramFloat1),
...
/*      */     }
/*  153 */     return new Float((float)(this.ab.getX() + paramFloat1),
...
/*      */     }
/*  164 */     return new Float((float)(this.ib.getX() + paramFloat1),
...
/*  251 */       return new Float(f1, f2, f3, f4);
/*      */     }
/*      */     
...
/*      */ 
/*      */ 
/*  290 */     return new Float(f1, f2, f3, f4);
/*      */   }
/*      */   
...
/*      */       }
/*      */     }
/*  310 */     return new Float(f2, f3, f4 - f2, f5 - f3);
/*      */   }
/*      */   
...
/*  393 */       return new Float();
/*      */     }
/*  395 */     return new Float(arrayOfFloat[(paramInt + 4)], arrayOfFloat[(paramInt + 5)], arrayOfFloat[(paramInt + 6)], arrayOfFloat[(paramInt + 7)]);
/*      */   }
/*      */   
/*      */ 
/*      */ 
...
/*  406 */       localRectangle2D.setRect(localRectangle2D.getX() + paramFloat1, localRectangle2D
/*  407 */         .getY() + paramFloat2, localRectangle2D
/*  408 */         .getWidth(), localRectangle2D
/*  409 */         .getHeight());
/*      */     }
...
/*  499 */     paramInt1--;
/*  500 */     for (;;) { paramInt1++; if (paramInt1 >= paramInt2) break;
...
/*  697 */     int i8 = 0;
/*      */     int i10;
/*  699 */     int i13; int i12; while (i3 != i4)
/*      */     {
/*  701 */       int i9 = 0;
/*  702 */       i10 = 0;
/*      */       
...
/*      */           } else {
/*  998 */             localGlyphJustificationInfo4 = localGlyphJustificationInfo1;
/*      */           }
/*      */         }
/*      */       }
...
/* Location:              E:\java_source\rt.jar!\sun\font\ExtendedTextSourceLabel.class
