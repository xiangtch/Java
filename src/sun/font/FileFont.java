...
/*     */       {
/*     */         public Object run() {
/* 266 */           if (CreatedFontFileDisposerRecord.this.fontFile != null) {
/*     */             try {
/* 268 */               if (CreatedFontFileDisposerRecord.this.tracker != null) {
/* 269 */                 CreatedFontFileDisposerRecord.this.tracker.subBytes((int)CreatedFontFileDisposerRecord.this.fontFile.length());
/*     */               }
/*     */               
/*     */ 
/*     */ 
...
/*     */ 
/*     */ 
/* 277 */               CreatedFontFileDisposerRecord.this.fontFile.delete();
/*     */               
/*     */ 
/* 280 */               SunFontManager.getInstance().tmpFontFiles.remove(CreatedFontFileDisposerRecord.this.fontFile);
/*     */             }
...
/* Location:              E:\java_source\rt.jar!\sun\font\FileFont.class
