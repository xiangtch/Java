...
/*     */       {
/*     */ 
/* 157 */         localAffineTransform = GraphicsEnvironment.getLocalGraphicsEnvironment().getDefaultScreenDevice().getDefaultConfiguration().getDefaultTransform();
/*     */       }
...
/*     */   {
/* 176 */     static ReferenceQueue queue = ;
/*     */     Object key;
/*     */     
...
/*     */       }
/* 224 */       return 
/* 225 */         (this.font.equals(((MetricsKey)paramObject).font)) && 
/* 226 */         (this.frc.equals(((MetricsKey)paramObject).frc));
/*     */     }
/*     */     
/*     */     public int hashCode() {
...
/* 265 */     if ((localSunFontManager.maybeUsingAlternateCompositeFonts()) && 
...
/* 474 */         char c = paramString.charAt(j);
/* 475 */         if (c < 'Ā') {
...
/* Location:              E:\java_source\rt.jar!\sun\font\FontDesignMetrics.class
