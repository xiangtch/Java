...
/*  90 */       return (localFontStrikeDesc.valuemask == this.valuemask) && 
/*  91 */         (localFontStrikeDesc.glyphTx.equals(this.glyphTx)) && 
/*  92 */         (localFontStrikeDesc.devTx.equals(this.devTx));
/*     */     }
...
/* 154 */       int i; if ((localAffineTransform.isIdentity()) && (!paramFont.isTransformed())) {
...
/* Location:              E:\java_source\rt.jar!\sun\font\FontStrikeDesc.class
