...
/*     */ 
/*  93 */     return 
/*  94 */       FontScaler.getNullScaler().getGlyphAdvance(0L, paramInt);
/*     */   }
/*     */   
...
/*     */     }
/*     */     
/* 109 */     FontScaler.getNullScaler().getGlyphMetrics(0L, paramInt, paramFloat);
/*     */   }
/*     */   
...
/*     */ 
/* 120 */     return 
/* 121 */       FontScaler.getNullScaler().getGlyphImage(0L, paramInt);
/*     */   }
/*     */   
...
/*     */ 
/* 133 */     return 
/* 134 */       FontScaler.getNullScaler().getGlyphOutlineBounds(0L, paramInt);
/*     */   }
/*     */   
...
/*     */ 
/* 147 */     return 
/* 148 */       FontScaler.getNullScaler().getGlyphOutline(0L, paramInt, paramFloat1, paramFloat2);
/*     */   }
/*     */   
...
/* 172 */       disposeNativeScaler((Font2D)this.font.get(), this.nativeScaler);
...
/* 193 */       return getGlyphCodeNative((Font2D)this.font.get(), this.nativeScaler, paramChar);
/*     */     }
...
/* Location:              E:\java_source\rt.jar!\sun\font\FreetypeFontScaler.class
