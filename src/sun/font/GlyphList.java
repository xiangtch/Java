...
/*     */       
/*     */ 
/* 339 */       this.gposx = (this.gposx + StrikeCache.unsafe.getFloat(this.images[paramInt] + StrikeCache.xAdvanceOffset));
/*     */       
/* 341 */       this.gposy = (this.gposy + StrikeCache.unsafe.getFloat(this.images[paramInt] + StrikeCache.yAdvanceOffset));
/*     */     }
/*     */     
/* 344 */     this.metrics[2] = StrikeCache.unsafe.getChar(this.images[paramInt] + StrikeCache.widthOffset);
...
/*     */     
/* 457 */     if (this.len == 0) {
/* 458 */       paramArrayOfInt[0] = (paramArrayOfInt[1] = paramArrayOfInt[2] = paramArrayOfInt[3] = 0); return;
/*     */     }
/*     */     
/*     */     float f2;
/* 462 */     float f1 = f2 = Float.POSITIVE_INFINITY;
/* 463 */     float f4; float f3 = f4 = Float.NEGATIVE_INFINITY;
/*     */     
/* 465 */     int i2 = 0;
...
/*     */       float f9;
/* 476 */       float f10; if (this.usePositions) {
...
/* Location:              E:\java_source\rt.jar!\sun\font\GlyphList.class
