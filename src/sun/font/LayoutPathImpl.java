...
/*     */   {
/*  57 */     Double localDouble = new Double(paramDouble1, paramDouble2);
...
/*  63 */     Double localDouble = new Double(paramDouble1, paramDouble2);
...
/* 104 */     private EndType() {} public boolean isPinned() { return this == PINNED; }
...
/*     */ 
/*     */ 
/*     */     public SegmentPath build(EndType paramEndType, double... paramVarArgs)
/*     */     {
/* 166 */       assert (paramVarArgs.length % 2 == 0);
/*     */       
/* 168 */       reset(paramVarArgs.length / 2 * 3);
/*     */       
/* 170 */       for (int i = 0; i < paramVarArgs.length; i += 2) {
/* 171 */         nextPoint(paramVarArgs[i], paramVarArgs[(i + 1)], i != 0);
/*     */       }
/*     */       
...
/* 226 */         this.data[(this.w - 3)] = (this.px = paramDouble1);
/* 227 */         this.data[(this.w - 2)] = (this.py = paramDouble2);
/* 228 */         return;
/*     */       }
/*     */       
/*     */ 
...
/*     */ 
/*     */ 
/*     */     public SegmentPath complete(EndType paramEndType)
/*     */     {
/* 267 */       if ((this.data == null) || (this.w < 6)) {
/* 268 */         return null;
/*     */       }
/*     */       SegmentPath localSegmentPath;
/* 271 */       if (this.w == this.data.length) {
/* 272 */         localSegmentPath = new SegmentPath(this.data, paramEndType);
/* 273 */         reset(0);
/*     */       } else {
/* 275 */         double[] arrayOfDouble = new double[this.w];
/* 276 */         System.arraycopy(this.data, 0, arrayOfDouble, 0, this.w);
/* 277 */         localSegmentPath = new SegmentPath(arrayOfDouble, paramEndType);
/* 278 */         reset(2);
/*     */       }
/*     */       
...
/*     */ 
/*     */ 
/*     */     public static SegmentPath get(EndType paramEndType, double... paramVarArgs)
/*     */     {
/* 317 */       return new SegmentPathBuilder().build(paramEndType, paramVarArgs);
/*     */     }
/*     */     
/*     */ 
/*     */ 
/*     */ 
/*     */     SegmentPath(double[] paramArrayOfDouble, EndType paramEndType)
/*     */     {
...
/*     */       
/*     */ 
/* 405 */       double d6 = Double.MAX_VALUE;
/* 406 */       double d7 = 0.0D;
/* 407 */       double d8 = 0.0D;
/* 408 */       double d9 = 0.0D;
/* 409 */       int i = 0;
...
/*     */         double d23;
/*     */         double d24;
/* 430 */         int n; if (d18 != 0.0D) { if (d21 < 0.0D)
/*     */           {
/* 432 */             if ((this.etype.isExtended()) && (j == 3)) {} }
/*     */         } else {
/* 434 */           d22 = d3;
/* 435 */           d23 = d4;
/* 436 */           d24 = d5;
/* 437 */           n = j;
/*     */           break label304; }
/* 439 */         double d25 = d18 * d18;
/* 440 */         if ((d21 <= d25) || (
/* 441 */           (this.etype.isExtended()) && (j == this.data.length - 3)))
/*     */         {
/* 443 */           d26 = d21 / d25;
/* 444 */           d22 = d3 + d26 * d16;
/* 445 */           d23 = d4 + d26 * d17;
...
/* 493 */       if ((k != 0) && (m != 0)) {
/* 494 */         Double localDouble1 = new Double(d1, d2);
/* 495 */         calcoffset(i - 3, bool, localDouble1);
/* 496 */         Double localDouble2 = new Double(d1, d2);
...
/*     */       {
/* 733 */         double d1 = SegmentPath.this.data[(paramInt - 1)];
/* 734 */         double d2 = SegmentPath.this.data[(paramInt + 2)];
/* 735 */         switch (LayoutPathImpl.1.$SwitchMap$sun$font$LayoutPathImpl$EndType[SegmentPath.this.etype.ordinal()]) {
/*     */         case 1: 
/*     */           break;
/*     */         case 2: 
/* 739 */           if (paramInt == 3) d1 = Double.NEGATIVE_INFINITY;
/* 740 */           if (paramInt == SegmentPath.this.data.length - 3) { d2 = Double.POSITIVE_INFINITY;
/*     */           }
/*     */           
/*     */           break;
/*     */         }
...
/*     */       {
/* 766 */         this.ix = paramInt;
/* 767 */         double d = SegmentPath.this.data[(paramInt + 2)] - SegmentPath.this.data[(paramInt - 1)];
/* 768 */         this.ux = ((SegmentPath.this.data[paramInt] - SegmentPath.this.data[(paramInt - 3)]) / d);
/* 769 */         this.uy = ((SegmentPath.this.data[(paramInt + 1)] - SegmentPath.this.data[(paramInt - 2)]) / d);
/* 770 */         this.temp = new LineInfo(SegmentPath.this);
/*     */       }
/*     */       
/*     */       void init()
/*     */       {
...
/*     */       
/*     */ 
/*     */       void line(LineInfo paramLineInfo)
/*     */       {
/* 795 */         if (paramLineInfo.pin(this.ix, this.temp))
/*     */         {
/*     */ 
/* 798 */           this.temp.sx -= SegmentPath.this.data[(this.ix - 1)];
/* 799 */           double d1 = SegmentPath.this.data[(this.ix - 3)] + this.temp.sx * this.ux - this.temp.sy * this.uy;
/* 800 */           double d2 = SegmentPath.this.data[(this.ix - 2)] + this.temp.sx * this.uy + this.temp.sy * this.ux;
/* 801 */           this.temp.lx -= SegmentPath.this.data[(this.ix - 1)];
/* 802 */           double d3 = SegmentPath.this.data[(this.ix - 3)] + this.temp.lx * this.ux - this.temp.ly * this.uy;
/* 803 */           double d4 = SegmentPath.this.data[(this.ix - 2)] + this.temp.lx * this.uy + this.temp.ly * this.ux;
/*     */           
/*     */ 
/*     */ 
...
/*     */       
/*     */       Mapper() {
/* 834 */         this.li = new LineInfo(SegmentPath.this);
/* 835 */         this.segments = new ArrayList();
/* 836 */         for (int i = 3; i < SegmentPath.this.data.length; i += 3) {
/* 837 */           if (SegmentPath.this.data[(i + 2)] != SegmentPath.this.data[(i - 1)]) {
/* 838 */             this.segments.add(new Segment(SegmentPath.this, i));
/*     */           }
/*     */         }
/*     */         
/* 842 */         this.mpt = new Double();
/* 843 */         this.cpt = new Double();
/*     */       }
/*     */       
/*     */       void init()
/*     */       {
/* 848 */         this.haveMT = false;
/* 849 */         for (Segment localSegment : this.segments) {
...
/* 878 */           for (localIterator = this.segments.iterator(); localIterator.hasNext();) { localSegment = (Segment)localIterator.next();
/* 879 */             localSegment.move();
/*     */           }
/*     */         }
/*     */         Segment localSegment;
/* 883 */         this.li.set(this.cpt.x, this.cpt.y, paramDouble1, paramDouble2);
/* 884 */         for (Iterator localIterator = this.segments.iterator(); localIterator.hasNext();) { localSegment = (Segment)localIterator.next();
...
/* 895 */         for (Segment localSegment : this.segments) {
...
/* 909 */           switch (localPathIterator.currentSegment(arrayOfDouble)) {
/* 910 */           case 4:  close(); break;
/* 911 */           case 0:  moveTo(arrayOfDouble[0], arrayOfDouble[1]); break;
/* 912 */           case 1:  lineTo(arrayOfDouble[0], arrayOfDouble[1]); break;
/*     */           }
/*     */           
/*     */           
...
/* 921 */         for (Segment localSegment : this.segments) {
...
/*     */     }
/*     */     
/* 985 */     public double start() { return 0.0D; }
/*     */     
/* 987 */     public double end() { return 0.0D; }
/*     */     
/* 989 */     public double length() { return 0.0D; }
/*     */     
/*     */     public Shape mapShape(Shape paramShape) {
/* 992 */       if (this.tx != null) {
...
/* Location:              E:\java_source\rt.jar!\sun\font\LayoutPathImpl.class
