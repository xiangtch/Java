...
/*     */     
/* 282 */     GraphicsEnvironment localGraphicsEnvironment = GraphicsEnvironment.getLocalGraphicsEnvironment();
/* 283 */     if (!GraphicsEnvironment.isHeadless())
/*     */     {
/* 285 */       GraphicsConfiguration localGraphicsConfiguration = localGraphicsEnvironment.getDefaultScreenDevice().getDefaultConfiguration();
...
/* 348 */           if ((paramArrayOfLong[i] != 0L) && 
/* 349 */             (unsafe.getByte(paramArrayOfLong[i] + managedOffset) == 0))
/*     */           {
...
/*     */   
/*     */   static abstract interface DisposableStrike { public abstract FontStrikeDisposer getDisposer(); }
/*     */   
/* 418 */   static class SoftDisposerRef extends SoftReference implements DisposableStrike { public FontStrikeDisposer getDisposer() { return this.disposer; }
/*     */     
...
/* Location:              E:\java_source\rt.jar!\sun\font\StrikeCache.class
