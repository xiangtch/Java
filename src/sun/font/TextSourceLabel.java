...
/*     */     }
/*  75 */     return new Float((float)(this.lb.getX() + paramFloat1),
...
/*     */     }
/*     */     
/*  86 */     return new Float((float)(this.vb.getX() + paramFloat1),
...
/*     */     }
/*  96 */     return new Float((float)(this.ab.getX() + paramFloat1),
...
/*     */     }
/* 106 */     return new Float((float)(this.ib.getX() + paramFloat1),
...
/* Location:              E:\java_source\rt.jar!\sun\font\TextSourceLabel.class
