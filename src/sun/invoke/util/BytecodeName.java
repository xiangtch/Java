...
/* 311 */         int i1 = -1;
/* 312 */         if (n < i) {
/* 313 */           i1 = "\\/.;:$[]<>".indexOf(paramString.charAt(n));
/* 314 */           if (i1 < 1) {}
/*     */         }
/*     */         else {
/* 317 */           if (m < n)
...
/* 364 */           paramArrayOfObject[i] = (localObject = str);
/*     */         }
/*     */       }
/*     */     }
...
/*     */   }
/*     */   
/* 371 */   private static String appendAll(Object[] paramArrayOfObject) { if (paramArrayOfObject.length <= 1) {
...
/*     */   }
/*     */   
/* 423 */   private static boolean isJavaIdent(String paramString) { int i = paramString.length();
...
/* 492 */           if (((i == 0) && (c2 == NULL_ESCAPE_C)) || 
/* 493 */             (c2 != originalOfReplacement(c2)))
/*     */           {
/* 495 */             bool = true;
/*     */           }
/*     */         }
/*     */       } else {
/* 499 */         bool = isDangerous(c1);
/*     */       }
/*     */       
/* 502 */       if (!bool) {
...
/*     */   }
/*     */   
/* 596 */   static char replacementOf(char paramChar) { if (!isSpecial(paramChar)) return paramChar;
/* 597 */     int i = "\\/.;:$[]<>".indexOf(paramChar);
/* 598 */     if (i < 0) return paramChar;
/* 599 */     return "-|,?!%{}^_".charAt(i);
/*     */   }
/*     */   
/* 602 */   static char originalOfReplacement(char paramChar) { if (!isSpecial(paramChar)) return paramChar;
/* 603 */     int i = "-|,?!%{}^_".indexOf(paramChar);
/* 604 */     if (i < 0) return paramChar;
/* 605 */     return "\\/.;:$[]<>".charAt(i);
/*     */   }
/*     */   
/* 608 */   static boolean isDangerous(char paramChar) { if (!isSpecial(paramChar)) return false;
/* 609 */     return "\\/.;:$[]<>".indexOf(paramChar) >= 1;
/*     */   }
/*     */   
/* 612 */   static int indexOfDangerousChar(String paramString, int paramInt) { int i = paramInt; for (int j = paramString.length(); i < j; i++) {
...
/*     */   }
/*     */   
/* 619 */   static int lastIndexOfDangerousChar(String paramString, int paramInt) { for (int i = Math.min(paramInt, paramString.length() - 1); i >= 0; i--) {
...
/* Location:              E:\java_source\rt.jar!\sun\invoke\util\BytecodeName.class
