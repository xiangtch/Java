...
/*     */     
/*     */ 
/* 116 */     BufferedImage localBufferedImage1 = new BufferedImage(this.srcCM, localWritableRaster, this.srcCM.isAlphaPremultiplied(), null);
/*     */     
/*     */ 
/* 119 */     BufferedImage localBufferedImage2 = new BufferedImage(this.dstCM, paramWritableRaster, this.dstCM.isAlphaPremultiplied(), null);
/*     */     
/*     */ 
...
/* 124 */     Blit localBlit = Blit.getFromCache(localSurfaceData1.getSurfaceType(), this.comptype, localSurfaceData2
/*     */     
/* 126 */       .getSurfaceType());
...
/* Location:              E:\java_source\rt.jar!\sun\java2d\SunCompositeContext.class
