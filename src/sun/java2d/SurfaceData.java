...
/*      */ 
/*      */ 
/*  224 */       SurfaceDataProxy localSurfaceDataProxy = (SurfaceDataProxy)localSurfaceManager.getCacheData(this.blitProxyKey);
...
/*  471 */   protected static final SpanShapeRenderer paintShape = new Composite(paintPipe);
...
/*  482 */   protected static final SpanShapeRenderer compShape = new Composite(compPipe);
...
/*      */   {
/*  505 */     if ((paramSunGraphics2D.compositeState <= 0) && (paramSunGraphics2D.paintState <= 1) && (paramSunGraphics2D.clipState <= 1))
/*      */     {
/*      */ 
/*  508 */       if (paramSunGraphics2D.surfaceData.getTransparency() == 1)
/*      */       {
/*  510 */         if (this.haveLCDLoop == 0)
/*      */         {
/*  512 */           DrawGlyphListLCD localDrawGlyphListLCD = DrawGlyphListLCD.locate(SurfaceType.AnyColor, CompositeType.SrcNoEa, 
/*      */           
/*  514 */             getSurfaceType());
...
/*  523 */     if (paramSunGraphics2D.paintState <= 1) { FillParallelogram localFillParallelogram;
/*  524 */       if (paramSunGraphics2D.compositeState == 2) {
/*  525 */         if (this.havePgramXORLoop == 0)
/*      */         {
/*  527 */           localFillParallelogram = FillParallelogram.locate(SurfaceType.AnyColor, CompositeType.Xor, 
/*      */           
/*  529 */             getSurfaceType());
...
/*      */         {
/*  540 */           localFillParallelogram = FillParallelogram.locate(SurfaceType.AnyColor, CompositeType.SrcNoEa, 
/*      */           
/*  542 */             getSurfaceType());
...
/*  554 */     Object localObject; if (paramSunGraphics2D.compositeState == 2) {
...
/*      */         }
/*      */         else {
/*  641 */           localObject = paramSunGraphics2D.alphafill.canDoParallelograms() ? AAColorViaPgram : AAColorViaShape;
/*      */           
/*      */ 
...
/* Location:              E:\java_source\rt.jar!\sun\java2d\SurfaceData.class
