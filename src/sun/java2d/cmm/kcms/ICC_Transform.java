...
/* 122 */     CMMImageLayout localCMMImageLayout2; if (localCMMImageLayout1 != null) {
...
/*     */     Object localObject9;
/* 177 */     Object localObject10; float[] arrayOfFloat5; pelArrayInfo localpelArrayInfo; Object localObject11; float[] arrayOfFloat4; int m; if (j == 8) {
...
/*     */       case 5: 
/*     */       case 6: 
/* 317 */         localObject = (ComponentColorModel)paramBufferedImage.getColorModel();
/* 318 */         if ((localObject.getClass() == ComponentColorModel.class) || 
/* 319 */           (checkMinMaxScaling((ComponentColorModel)localObject))) {
...
/*     */ 
/*     */       case 10: 
/* 326 */         localObject = (ComponentColorModel)paramBufferedImage.getColorModel();
/* 327 */         if (((ComponentColorModel)localObject).getComponentSize(0) != 8) {
/* 328 */           return null;
/*     */         }
/* 330 */         if ((localObject.getClass() == ComponentColorModel.class) || 
/* 331 */           (checkMinMaxScaling((ComponentColorModel)localObject))) {
...
/*     */ 
/*     */       case 11: 
/* 338 */         localObject = (ComponentColorModel)paramBufferedImage.getColorModel();
/* 339 */         if (((ComponentColorModel)localObject).getComponentSize(0) != 16) {
/* 340 */           return null;
/*     */         }
/* 342 */         if ((localObject.getClass() == ComponentColorModel.class) || 
/* 343 */           (checkMinMaxScaling((ComponentColorModel)localObject))) {
/* 344 */           return new CMMImageLayout(paramBufferedImage);
/*     */         }
/* 346 */         return null;
/*     */       }
/*     */       
/* 349 */       Object localObject = paramBufferedImage.getColorModel();
/* 350 */       SampleModel localSampleModel; int j; int k; if ((localObject instanceof DirectColorModel))
/*     */       {
/*     */ 
...
/*     */         int i4;
/* 370 */         int i3; int i2; int i1 = i2 = i3 = i4 = -1;
/* 371 */         int i5 = 0;
/* 372 */         int i6 = 3;
/* 373 */         if (n != 0) {
/* 374 */           i6 = 4;
...
/* 425 */         if ((localComponentColorModel.getClass() == ComponentColorModel.class) || 
/* 426 */           (checkMinMaxScaling(localComponentColorModel))) {
...
/*     */     float[] arrayOfFloat1;
/* 462 */     float[] arrayOfFloat2; float f1; switch (paramComponentColorModel.getTransferType())
/*     */     {
/*     */     case 0: 
...
/*     */       } else {
/* 561 */         if (i == 2) {
/* 562 */           arrayOfFloat1[localObject4] = 2.0000305F;
/*     */         }
/*     */         else {
/* 565 */           arrayOfFloat1[localObject4] = (65535.0F / ((1 << localSampleModel1.getSampleSize(localObject4)) - 1));
/*     */         }
...
/*     */       } else {
/* 575 */         if (j == 2) {
/* 576 */           arrayOfFloat2[localObject5] = 0.49999237F;
/*     */         }
/*     */         else {
/* 579 */           arrayOfFloat2[localObject5] = (((1 << localSampleModel2.getSampleSize(localObject5)) - 1) / 65535.0F);
/*     */         }
/*     */         
/* 582 */         arrayOfFloat4[localObject5] = 0.0F;
/*     */       }
/*     */     }
/* 585 */     int i1 = paramRaster.getMinY();
...
/* 595 */     try { localCMMImageLayout1 = new CMMImageLayout(arrayOfShort1, localpelArrayInfo.nPels, localpelArrayInfo.nSrc);
/*     */       
...
/* 606 */       int i5 = 0;
/* 607 */       float f; for (Object localObject6 = 0; localObject6 < localObject1; i3++) {
...
/* 640 */     CMMImageLayout localCMMImageLayout2; if (localCMMImageLayout1 != null) {
...
/*     */       }
/*     */       else {
/* 680 */         localObject6[localObject7] = (f / ((1 << ((SampleModel)???).getSampleSize(localObject7)) - 1));
/*     */       }
/*     */     }
...
/*     */       }
/*     */       else {
/* 688 */         arrayOfFloat[localObject8] = (((1 << localSampleModel.getSampleSize(localObject8)) - 1) / f);
/*     */       }
/*     */     }
...
/* 695 */     pelArrayInfo localpelArrayInfo; int i2; int i5; int i4; int i3; if (m == 8) {
...
/* Location:              E:\java_source\rt.jar!\sun\java2d\cmm\kcms\ICC_Transform.class
