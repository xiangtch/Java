...
/*     */   {
/* 107 */     D3DContext.D3DContextCaps localD3DContextCaps = null;
...
/*     */     try
/*     */     {
/* 115 */       Object local1Result = new Object() { int caps; String id; };
...
/*     */   {
/* 251 */     if ((!(paramWindow instanceof Frame)) && (!(paramWindow instanceof Dialog)) && 
/* 252 */       ((this.realFSWindow = getToplevelOwner(paramWindow)) != null))
/*     */     {
...
/*     */       {
/* 323 */         public void run() { local2Result.dm = D3DGraphicsDevice.getCurrentDisplayModeNative(paramInt); }
/*     */       });
...
/* Location:              E:\java_source\rt.jar!\sun\java2d\d3d\D3DGraphicsDevice.class
