...
/*     */   {
/*  49 */     int i = paramSunGraphics2D.paint.getTransparency() == 1 ? 1 : 0;
...
/*     */     }
/*  57 */     D3DContext.validateContext(localD3DSurfaceData, localD3DSurfaceData, paramSunGraphics2D
/*  58 */       .getCompClip(), paramSunGraphics2D.composite, null, paramSunGraphics2D.paint, paramSunGraphics2D, i);
/*     */   }
/*     */   
/*     */ 
...
/*     */     }
/*  71 */     D3DContext.validateContext(localD3DSurfaceData, localD3DSurfaceData, paramSunGraphics2D
/*  72 */       .getCompClip(), paramSunGraphics2D.composite, null, paramSunGraphics2D.paint, paramSunGraphics2D, i);
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */     try
/*     */     {
/*  82 */       int i = paramSunGraphics2D.surfaceData.getTransparency() == 1 ? 1 : 0;
/*     */       D3DSurfaceData localD3DSurfaceData;
/*     */       try
/*     */       {
...
/*     */       }
/*  90 */       D3DContext.validateContext(localD3DSurfaceData, localD3DSurfaceData, paramSunGraphics2D
/*  91 */         .getCompClip(), paramSunGraphics2D.composite, null, null, null, i);
/*     */       
/*     */ 
...
/*     */   
/*     */ 
/* 108 */   D3DRenderer traceWrap() { return new Tracer(this); }
/*     */   
...
/* 114 */       super();
/* 115 */       this.d3dr = paramD3DRenderer;
/*     */     }
/*     */     
/* 118 */     public ParallelogramPipe getAAParallelogramPipe() { final ParallelogramPipe localParallelogramPipe = this.d3dr.getAAParallelogramPipe();
/* 119 */       new ParallelogramPipe()
/*     */       {
/*     */ 
/*     */ 
...
/*     */     }
/*     */     
/* 159 */     public void drawRect(SunGraphics2D paramSunGraphics2D, int paramInt1, int paramInt2, int paramInt3, int paramInt4) { GraphicsPrimitive.tracePrimitive("D3DDrawRect");
...
/*     */     }
/*     */     
/* 170 */     public void fillRect(SunGraphics2D paramSunGraphics2D, int paramInt1, int paramInt2, int paramInt3, int paramInt4) { GraphicsPrimitive.tracePrimitive("D3DFillRect");
...
/* Location:              E:\java_source\rt.jar!\sun\java2d\d3d\D3DRenderer.class
