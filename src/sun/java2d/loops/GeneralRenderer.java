...
/* 167 */     int m; int j = m = paramArrayOfInt2[paramInt1] + paramInt4;
/* 168 */     for (;;) { paramInt2--; if (paramInt2 <= 0) break;
/* 169 */       paramInt1++;
...
/*     */   {
/* 186 */     WritableRaster localWritableRaster = (WritableRaster)paramSurfaceData.getRaster(paramInt1, paramInt2, paramInt3 - paramInt1, paramInt4 - paramInt2);
...
/*     */     
/*     */ 
/* 220 */     WritableRaster localWritableRaster = (WritableRaster)paramSurfaceData.getRaster(Math.min(i, k), Math.min(j, m), 
...
/*     */     
/*     */ 
/* 380 */     WritableRaster localWritableRaster = (WritableRaster)paramSurfaceData.getRaster(i, j, k - i, m - j);
...
/* Location:              E:\java_source\rt.jar!\sun\java2d\loops\GeneralRenderer.class
