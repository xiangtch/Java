...
/*     */     
/*     */ 
/* 134 */       paramInt << 24 | paramSurfaceType2.getUniqueID() << 16 | paramCompositeType.getUniqueID() << 8 | paramSurfaceType1.getUniqueID();
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */   {
/* 307 */     return (this.methodSignature == paramGraphicsPrimitive.methodSignature) && 
/* 308 */       (this.sourceType.equals(paramGraphicsPrimitive.sourceType)) && 
/* 309 */       (this.compositeType.equals(paramGraphicsPrimitive.compositeType)) && 
/* 310 */       (this.destType.equals(paramGraphicsPrimitive.destType));
/*     */   }
/*     */   
/*     */ 
...
/* 394 */         FileOutputStream localFileOutputStream = (FileOutputStream)AccessController.doPrivileged(new PrivilegedAction()
/*     */         {
...
/*     */         });
/*     */         
/* 404 */         if (localFileOutputStream != null) {
/* 405 */           traceout = new PrintStream(localFileOutputStream);
/*     */         } else {
...
/*     */         public Void run() {
/* 420 */           TraceReporter localTraceReporter = new TraceReporter();
...
/*     */ 
/*     */ 
/* 619 */       this.cachedname = (getClass().getName() + "::" + str + "(" + simplename(this.sourceType) + ", " + simplename(this.compositeType) + ", " + simplename(this.destType) + ")");
/*     */     }
...
/* Location:              E:\java_source\rt.jar!\sun\java2d\loops\GraphicsPrimitive.class
