...
/*     */   static
/*     */   {
/*  56 */     initIDs(GraphicsPrimitive.class, SurfaceType.class, CompositeType.class, SunGraphics2D.class, Color.class, AffineTransform.class, XORComposite.class, AlphaComposite.class, Path2D.class, Float.class, SunHints.class);
/*     */     
/*     */ 
/*     */ 
/*     */ 
...
/*  88 */       int j = ((PrimitiveSpec)paramAnonymousObject2).uniqueID;
/*     */       
...
/*     */ 
/*     */ 
/* 202 */           localPrimitiveSpec.uniqueID = GraphicsPrimitive.makeUniqueID(paramInt, localSurfaceType1, localCompositeType, localSurfaceType2);
...
/* 291 */         if ((!localGraphicsPrimitive.getSignature().equals(((GraphicsPrimitive)localObject).getSignature())) || 
/* 292 */           (localGraphicsPrimitive.getUniqueID() != ((GraphicsPrimitive)localObject).getUniqueID())) {
...
/*     */           
/*     */ 
/* 299 */           throw new RuntimeException("Primitive " + localObject + " returns wrong signature for " + localGraphicsPrimitive.getClass());
/*     */         }
/*     */         
/* 302 */         j++;
...
/* Location:              E:\java_source\rt.jar!\sun\java2d\loops\GraphicsPrimitiveMgr.class
