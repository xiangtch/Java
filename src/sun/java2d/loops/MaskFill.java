...
/*     */   {
/* 156 */     if ((SurfaceType.OpaqueColor.equals(paramSurfaceType1)) || 
/* 157 */       (SurfaceType.AnyColor.equals(paramSurfaceType1)))
/*     */     {
...
/*     */ 
/*     */ 
/* 213 */   public GraphicsPrimitive traceWrap() { return new TraceMaskFill(this); }
/*     */   
...
/* 222 */     public TraceMaskFill(MaskFill paramMaskFill) { super(paramMaskFill
/* 223 */         .getCompositeType(), paramMaskFill
/* 224 */         .getDestType());
/* 225 */       this.target = paramMaskFill;
/*     */       
/*     */ 
/*     */ 
/* 229 */       this.fillPgramTarget = new MaskFill(fillPgramSignature, paramMaskFill.getSourceType(), paramMaskFill.getCompositeType(), paramMaskFill.getDestType());
/*     */       
/*     */ 
/*     */ 
/* 233 */       this.drawPgramTarget = new MaskFill(drawPgramSignature, paramMaskFill.getSourceType(), paramMaskFill.getCompositeType(), paramMaskFill.getDestType());
/*     */     }
/*     */     
...
/* Location:              E:\java_source\rt.jar!\sun\java2d\loops\MaskFill.class
