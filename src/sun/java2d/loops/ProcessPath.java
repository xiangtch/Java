...
/*   86 */       this.xMaxf = (paramInt3 - 0.5F - 9.765625E-4F);
/*   87 */       this.yMaxf = (paramInt4 - 0.5F - 9.765625E-4F);
/*      */     }
/*      */     
/*      */ 
...
/*      */     int clipMode;
/*      */     
/*      */     public ProcessHandler(DrawHandler paramDrawHandler, int paramInt)
/*      */     {
...
/*      */   {
/*  307 */     int i = 3;
/*  308 */     if ((paramArrayOfFloat[paramInt1] < paramFloat1) || (paramArrayOfFloat[paramInt1] > paramFloat2)) { double d;
...
/*      */   {
/*  332 */     int i = 3;
/*  333 */     if ((paramArrayOfInt[paramInt3] < paramInt1) || (paramArrayOfInt[paramInt3] > paramInt2)) { double d;
...
/*      */     
/*      */     public DrawProcessHandler(DrawHandler paramDrawHandler, EndSubPathHandler paramEndSubPathHandler)
/*      */     {
/*  433 */       super(0);
...
/*      */         
/*      */ 
/*  604 */         int i3 = paramInt1 & 0xFC00;
/*  605 */         int i4 = paramInt2 & 0xFC00;
/*  606 */         int i5 = paramInt3 & 0xFC00;
/*  607 */         int i6 = paramInt4 & 0xFC00;
/*      */         int i7;
/*      */         int i8;
/*  610 */         int i9; if ((i3 == paramInt1) || (i4 == paramInt2))
/*      */         {
/*      */ 
/*      */ 
/*  614 */           j = paramInt1 + 512;
...
/*  711 */     int i18 = m - j;
/*      */     
/*  713 */     int i19 = i & 0xFC00;
/*  714 */     int i20 = j & 0xFC00;
/*      */     
/*      */ 
/*      */ 
/*      */ 
...
/*  787 */     float f4; float f2 = f4 = paramArrayOfFloat[1];
...
/*  821 */         paramArrayOfFloat[0] = (paramArrayOfFloat[2] = paramArrayOfFloat[4] = paramProcessHandler.dhnd.xMinf);
/*      */       }
/*      */     }
/*      */     
...
/*  832 */       paramArrayOfFloat[4] = (arrayOfFloat[0] = (paramArrayOfFloat[2] + arrayOfFloat[2]) / 2.0F);
/*  833 */       paramArrayOfFloat[5] = (arrayOfFloat[1] = (paramArrayOfFloat[3] + arrayOfFloat[3]) / 2.0F);
/*      */       
...
/*  977 */     paramArrayOfFloat[0] = (arrayOfFloat[4] = arrayOfFloat[2] + paramFloat * (paramArrayOfFloat[2] - arrayOfFloat[2]));
/*  978 */     paramArrayOfFloat[1] = (arrayOfFloat[5] = arrayOfFloat[3] + paramFloat * (paramArrayOfFloat[3] - arrayOfFloat[3]));
/*      */     
...
/*      */     
/*      */ 
/* 1043 */     int i22 = i & 0xFC00;
/* 1044 */     int i23 = j & 0xFC00;
/*      */     
/* 1046 */     int i24 = k - i;
/* 1047 */     int i25 = m - j;
/*      */     
/* 1049 */     while (i4 > 0)
/*      */     {
/* 1051 */       while ((Math.abs(i14) > i3) || 
/* 1052 */         (Math.abs(i15) > i3)) {
/* 1053 */         i14 = (i14 << 1) - i12;
/* 1054 */         i15 = (i15 << 1) - i13;
...
/*      */ 
/*      */ 
/* 1069 */       while (((i4 & 0x1) == 0) && (i5 > 6) && 
/* 1070 */         (Math.abs(i16) <= i2) && 
/* 1071 */         (Math.abs(i17) <= i2)) {
...
/* 1146 */     float f6; float f5 = f6 = paramArrayOfFloat[1];
/*      */     
...
/* 1180 */         paramArrayOfFloat[0] = (paramArrayOfFloat[2] = paramArrayOfFloat[4] = paramArrayOfFloat[6] = paramProcessHandler.dhnd.xMinf);
/*      */       }
/*      */     }
/*      */     
/*      */ 
...
/* 1198 */       paramArrayOfFloat[6] = (arrayOfFloat[0] = (paramArrayOfFloat[4] + arrayOfFloat[2]) / 2.0F);
/* 1199 */       paramArrayOfFloat[7] = (arrayOfFloat[1] = (paramArrayOfFloat[5] + arrayOfFloat[3]) / 2.0F);
/*      */       
...
/* 1348 */     paramArrayOfFloat[0] = (arrayOfFloat[6] = arrayOfFloat[4] + paramFloat * (paramArrayOfFloat[2] - arrayOfFloat[4]));
/* 1349 */     paramArrayOfFloat[1] = (arrayOfFloat[7] = arrayOfFloat[5] + paramFloat * (paramArrayOfFloat[3] - arrayOfFloat[5]));
/*      */     
...
/*      */     int i;
/* 1388 */     int j; int k; int m; if (paramProcessHandler.clipMode == 0)
/*      */     {
/*      */ 
/*      */ 
...
/*      */     
/* 1504 */     while (!localPathIterator.isDone()) { float f1;
/* 1505 */       float f2; switch (localPathIterator.currentSegment(arrayOfFloat1))
/*      */       {
/*      */       case 0: 
/* 1508 */         if ((i != 0) && (j == 0)) {
...
/*      */ 
/* 1560 */           if (j != 0) {
/* 1561 */             arrayOfFloat2[0] = (arrayOfFloat3[0] = f1);
/* 1562 */             arrayOfFloat2[1] = (arrayOfFloat3[1] = f2);
/* 1563 */             i = 1;
/* 1564 */             j = 0;
/*      */           } else {
...
/*      */ 
/* 1592 */           if (j != 0) {
/* 1593 */             arrayOfFloat2[0] = (arrayOfFloat3[0] = f1);
/* 1594 */             arrayOfFloat2[1] = (arrayOfFloat3[1] = f2);
/* 1595 */             i = 1;
/* 1596 */             j = 0;
/*      */           } else {
...
/*      */ 
/* 1635 */           if (j != 0) {
/* 1636 */             arrayOfFloat2[0] = (arrayOfFloat3[0] = arrayOfFloat2[6]);
/* 1637 */             arrayOfFloat2[1] = (arrayOfFloat3[1] = arrayOfFloat2[7]);
/* 1638 */             i = 1;
/* 1639 */             j = 0;
/*      */           } else {
...
/*      */     public Edge edge;
/*      */     
/* 1709 */     public Point(int paramInt1, int paramInt2, boolean paramBoolean) { this.x = paramInt1;
...
/*      */     Edge next;
/*      */     
/*      */     public Edge(Point paramPoint, int paramInt1, int paramInt2, int paramInt3) {
...
/*      */       }
/*      */       
/* 1758 */       this.plgPnts.add(new Point(paramInt1, paramInt2, paramBoolean));
/*      */     }
/*      */     
...
/* 1766 */       return ((Point)this.plgPnts.get(this.plgPnts.size() - 1)).lastPoint;
/*      */     }
/*      */     
/*      */     public boolean setEnded() {
/* 1770 */       return ((Point)this.plgPnts.get(this.plgPnts.size() - 1)).lastPoint = 1;
/*      */     }
/*      */   }
/*      */   
...
/*      */     }
/*      */     
/*      */     public void insert(Point paramPoint, int paramInt) {
/* 1782 */       Point localPoint = paramPoint.next;
...
/*      */       }
/*      */       
/* 1817 */       Edge localEdge = new Edge(paramPoint, i3, i2, i5);
/*      */       
/*      */ 
...
/*      */     }
/*      */     
/*      */     public void delete(Edge paramEdge) {
/* 1829 */       Edge localEdge1 = paramEdge.prev;
/* 1830 */       Edge localEdge2 = paramEdge.next;
...
/*      */     }
/*      */     
/*      */     FillProcessHandler(DrawHandler paramDrawHandler) {
/* 2118 */       super(1);
...
/* Location:              E:\java_source\rt.jar!\sun\java2d\loops\ProcessPath.class
