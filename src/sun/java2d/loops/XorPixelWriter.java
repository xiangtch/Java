...
/* 1043 */         int tmp18_17 = i; byte[] tmp18_16 = arrayOfByte;tmp18_16[tmp18_17] = ((byte)(tmp18_16[tmp18_17] ^ this.xorData[i]));
/*      */       }
/*      */     }
/*      */   }
/*      */   
...
/* 1060 */         int tmp18_17 = i; short[] tmp18_16 = arrayOfShort;tmp18_16[tmp18_17] = ((short)(tmp18_16[tmp18_17] ^ this.xorData[i]));
/*      */       }
/*      */     }
/*      */   }
/*      */   
...
/*      */       {
/* 1091 */         this.xorData[i] = (Float.floatToIntBits(arrayOfFloat1[i]) ^ Float.floatToIntBits(arrayOfFloat2[i]));
/*      */       }
/*      */     }
/*      */     
/*      */     protected void xorPixel(Object paramObject) {
...
/*      */       {
/* 1113 */         this.xorData[i] = (Double.doubleToLongBits(arrayOfDouble1[i]) ^ Double.doubleToLongBits(arrayOfDouble2[i]));
/*      */       }
/*      */     }
/*      */     
/*      */     protected void xorPixel(Object paramObject) {
...
/* Location:              E:\java_source\rt.jar!\sun\java2d\loops\XorPixelWriter.class
