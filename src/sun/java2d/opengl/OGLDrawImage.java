...
/*     */       
/*  62 */       SurfaceData localSurfaceData2 = localSurfaceData1.getSourceSurfaceData(paramImage, 4, paramSunGraphics2D.imageComp, paramColor);
/*     */       
/*     */ 
/*     */ 
/*     */ 
/*  67 */       if ((localSurfaceData2 != null) && 
/*  68 */         (!isBgOperation(localSurfaceData2, paramColor)) && (
/*  69 */         (localSurfaceData2.getSurfaceType() == OGLSurfaceData.OpenGLTexture) || 
/*  70 */         (localSurfaceData2.getSurfaceType() == OGLSurfaceData.OpenGLSurfaceRTT) || (paramInt1 == 1)))
/*     */       {
/*     */ 
...
/*  80 */           localTransformBlit.Transform(localSurfaceData2, localSurfaceData1, paramSunGraphics2D.composite, paramSunGraphics2D
...
/* 100 */         transformImage(paramSunGraphics2D, paramBufferedImage, paramInt1, paramInt2, localAffineTransformOp
/* 101 */           .getTransform(), localAffineTransformOp
...
/* Location:              E:\java_source\rt.jar!\sun\java2d\opengl\OGLDrawImage.class
