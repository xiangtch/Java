...
/*     */ {
/*  46 */   static RenderingEngine renderengine = ;
...
/*     */     }
/*  82 */     return new Double(paramDouble1, paramDouble2, paramDouble3, paramDouble4);
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */     
/*  95 */     AATileGenerator localAATileGenerator = renderengine.getAATileGenerator(paramDouble5, paramDouble6, paramDouble7, paramDouble8, paramDouble9, paramDouble10, 0.0D, 0.0D, localRegion, arrayOfInt);
/*     */     
...
/*     */     
/* 116 */     AATileGenerator localAATileGenerator = renderengine.getAATileGenerator(paramDouble5, paramDouble6, paramDouble7, paramDouble8, paramDouble9, paramDouble10, paramDouble11, paramDouble12, localRegion, arrayOfInt);
/*     */     
...
/*     */     
/* 152 */     AATileGenerator localAATileGenerator = renderengine.getAATileGenerator(paramShape, paramSunGraphics2D.transform, localRegion, paramBasicStroke, bool2, bool1, arrayOfInt);
/*     */     
...
/* 186 */           if ((i2 == 0) || 
/* 187 */             (!this.outpipe.needTile(localObject1, m, k, n, i1)))
/*     */           {
...
/* Location:              E:\java_source\rt.jar!\sun\java2d\pipe\AAShapePipe.class
