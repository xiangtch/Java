...
/*  71 */         if ((AlphaPaintPipe.cachedLastColorModel != null) && 
/*  72 */           (AlphaPaintPipe.cachedLastColorModel.get() == this.paintModel))
/*     */         {
...
/*     */   {
/*  84 */     PaintContext localPaintContext = paramSunGraphics2D.paint.createContext(paramSunGraphics2D.getDeviceColorModel(), paramRectangle, paramShape
/*     */     
...
/*     */ 
/*     */ 
/* 135 */           localObject2 = new BufferedImage(localColorModel, (WritableRaster)localRaster, localColorModel.isAlphaPremultiplied(), null);
/*     */           
...
/* 146 */             if ((CompositeType.SrcOverNoEa.equals(localObject2)) && 
/* 147 */               (localColorModel.getTransparency() == 1))
/*     */             {
/* 149 */               localObject2 = CompositeType.SrcNoEa;
/*     */             }
/*     */             
/* 152 */             localTileContext.lastBlit = Blit.getFromCache(localSurfaceData2.getSurfaceType(), (CompositeType)localObject2, localSurfaceData1
/*     */             
/* 154 */               .getSurfaceType());
/*     */           }
...
/* 162 */             if ((CompositeType.SrcOverNoEa.equals(localObject2)) && 
/* 163 */               (localColorModel.getTransparency() == 1))
/*     */             {
/* 165 */               localObject2 = CompositeType.SrcNoEa;
/*     */             }
/*     */             
/* 168 */             localTileContext.lastMask = MaskBlit.getFromCache(localSurfaceData2.getSurfaceType(), (CompositeType)localObject2, localSurfaceData1
/*     */             
/* 170 */               .getSurfaceType());
/*     */           }
/*     */           
...
/* 196 */           (cachedLastColorModel.get() != localTileContext.paintModel))
/*     */         {
/*     */ 
...
/* Location:              E:\java_source\rt.jar!\sun\java2d\pipe\AlphaPaintPipe.class
