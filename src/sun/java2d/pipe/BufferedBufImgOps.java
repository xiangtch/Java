...
/*     */   {
/*  96 */     int i = paramConvolveOp.getEdgeCondition() == 0 ? 1 : 0;
...
/*     */ 
/* 134 */     if ((i != 1) && 
/* 135 */       (i != localColorModel.getNumColorComponents()) && 
/* 136 */       (i != localColorModel.getNumComponents()))
/*     */     {
...
/*     */     
/*     */ 
/* 169 */     int i = (localColorModel.hasAlpha()) && (localColorModel.isAlphaPremultiplied()) ? 1 : 0;
/*     */     
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/* 273 */     if ((i != 1) && 
/* 274 */       (i != localColorModel.getNumComponents()) && 
/* 275 */       (i != localColorModel.getNumColorComponents()))
/*     */     {
...
/*     */   {
/* 335 */     int i = (paramBufferedImage.getColorModel().hasAlpha()) && (paramBufferedImage.isAlphaPremultiplied()) ? 1 : 0;
/*     */     
...
/* 371 */     Object localObject2; int i6; if (i1 != 0) {
...
/* Location:              E:\java_source\rt.jar!\sun\java2d\pipe\BufferedBufImgOps.class
