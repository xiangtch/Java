...
/* 282 */       setBounds(localRegion.getLoX(), localRegion.getLoY(), localRegion
/* 283 */         .getHiX(), localRegion.getHiY(), paramSunGraphics2D.strokeHint);
/*     */     }
/*     */     
/*     */ 
/*     */ 
...
/*     */   }
/*     */   
/*     */   public void draw(SunGraphics2D paramSunGraphics2D, Shape paramShape) { Object localObject1;
...
/* 515 */         drawPolygon(paramSunGraphics2D, ((Polygon)localObject1).xpoints, ((Polygon)localObject1).ypoints, ((Polygon)localObject1).npoints); return;
/*     */       }
/*     */       
/*     */       int i;
/*     */       
...
/*     */   }
/*     */   
/*     */   public void fill(SunGraphics2D paramSunGraphics2D, Shape paramShape) { Object localObject1;
/*     */     int i;
/*     */     int j;
...
/* 591 */       localShapeSpanIterator.setOutputAreaXYXY(localRegion.getLoX() - i, localRegion
/* 592 */         .getLoY() - j, localRegion
/* 593 */         .getHiX() - i, localRegion
/* 594 */         .getHiY() - j);
...
/* Location:              E:\java_source\rt.jar!\sun\java2d\pipe\BufferedRenderPipe.class
