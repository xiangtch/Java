...
/*     */     {
/*  55 */       this.sunG2D = paramSunGraphics2D;
/*  56 */       this.paintCtxt = paramPaintContext;
/*  57 */       this.compCtxt = paramCompositeContext;
/*  58 */       this.compModel = paramColorModel;
/*     */     }
/*     */   }
/*     */   
...
/*     */     
/*  67 */     PaintContext localPaintContext = paramSunGraphics2D.paint.createContext(localColorModel, paramRectangle, paramShape.getBounds2D(), paramSunGraphics2D
/*  68 */       .cloneTransform(), localRenderingHints);
/*     */     
/*     */ 
/*  71 */     CompositeContext localCompositeContext = paramSunGraphics2D.composite.createContext(localPaintContext.getColorModel(), localColorModel, localRenderingHints);
/*     */     
...
/* 101 */     WritableRaster localWritableRaster; Object localObject1; if (((localRaster2 instanceof WritableRaster)) && (paramArrayOfByte == null)) {
...
/*     */         
/*     */ 
/* 119 */         BufferedImage localBufferedImage = new BufferedImage(localColorModel2, localWritableRaster, localColorModel2.isAlphaPremultiplied(), null);
/*     */         
/* 121 */         SurfaceData localSurfaceData2 = BufImgSurfaceData.createData(localBufferedImage);
/* 122 */         Object localObject2; if (paramArrayOfByte == null) {
/* 123 */           localObject2 = Blit.getFromCache(localSurfaceData2.getSurfaceType(), CompositeType.SrcNoEa, localSurfaceData1
/*     */           
/* 125 */             .getSurfaceType());
...
/*     */         }
/*     */         else {
/* 129 */           localObject2 = MaskBlit.getFromCache(localSurfaceData2.getSurfaceType(), CompositeType.SrcNoEa, localSurfaceData1
/*     */           
/* 131 */             .getSurfaceType());
...
/* Location:              E:\java_source\rt.jar!\sun\java2d\pipe\GeneralCompositePipe.class
