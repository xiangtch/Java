...
/*  52 */       SurfaceData.outlineTextRenderer.drawString(paramSunGraphics2D, paramString, paramDouble1, paramDouble2); return;
/*     */     }
/*     */     
/*     */     float f1;
/*     */     float f2;
...
/*     */       
/*  77 */       TextLayout localTextLayout = new TextLayout(paramString, paramSunGraphics2D.getFont(), paramSunGraphics2D.getFontRenderContext());
...
/*  89 */       SurfaceData.outlineTextRenderer.drawChars(paramSunGraphics2D, paramArrayOfChar, paramInt1, paramInt2, paramInt3, paramInt4); return;
/*     */     }
/*     */     float f1;
/*     */     float f2;
...
/*     */       
/*     */ 
/* 110 */       TextLayout localTextLayout = new TextLayout(new String(paramArrayOfChar, paramInt1, paramInt2), paramSunGraphics2D.getFont(), paramSunGraphics2D.getFontRenderContext());
...
/* Location:              E:\java_source\rt.jar!\sun\java2d\pipe\GlyphListPipe.class
