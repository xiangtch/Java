...
/*  92 */           if ((localBasicStroke.getLineJoin() == 0) && 
/*  93 */             (localBasicStroke.getDashArray() == null))
/*     */           {
...
/* 122 */       Object localObject; if ((paramShape instanceof Rectangle2D)) {
/* 123 */         if ((localBasicStroke.getLineJoin() == 0) && 
/* 124 */           (localBasicStroke.getDashArray() == null))
/*     */         {
...
/* 139 */         if (drawGeneralLine(paramSunGraphics2D, ((Line2D)localObject)
/* 140 */           .getX1(), ((Line2D)localObject).getY1(), ((Line2D)localObject)
/* 141 */           .getX2(), ((Line2D)localObject).getY2()))
/*     */         {
/* 143 */           return;
/*     */         }
/*     */       }
...
/* 168 */     return paramDouble2 == 0.0D ? 
/* 169 */       Math.abs(paramDouble1) : paramDouble1 == 0.0D ? Math.abs(paramDouble2) : 
...
/*     */     double d4;
/* 200 */     double d5; double d6; double d7; switch (paramSunGraphics2D.transformState)
/*     */     {
/*     */     case 3: 
/*     */     case 4: 
...
/* Location:              E:\java_source\rt.jar!\sun\java2d\pipe\PixelToParallelogramConverter.class
