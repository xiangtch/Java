...
/*     */ {
/*  45 */   static final RenderingEngine RenderEngine = ;
...
/*     */     
/*  51 */     public Composite(CompositePipe paramCompositePipe) { this.comppipe = paramCompositePipe; }
/*     */     
/*     */ 
...
/*     */     extends SpanShapeRenderer implements LoopBasedPipe
/*     */   {
/*     */     public Object startSequence(SunGraphics2D paramSunGraphics2D, Shape paramShape, Rectangle paramRectangle, int[] paramArrayOfInt)
/*     */     {
...
/*     */   {
/* 104 */     if (((paramShape instanceof Rectangle2D)) && 
/* 105 */       ((paramSunGraphics2D.transform.getType() & 0x30) == 0))
/*     */     {
...
/* 139 */     double d; if (arrayOfDouble[2] < arrayOfDouble[0]) {
...
/* Location:              E:\java_source\rt.jar!\sun\java2d\pipe\SpanShapeRenderer.class
