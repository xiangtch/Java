...
/*     */   {
/*  96 */     StringBuffer localStringBuffer = new StringBuffer("ContextCapabilities: adapter=" + this.adapterId + ", caps=");
/*     */     
/*     */ 
/*  99 */     if (this.caps == 0) {
/* 100 */       localStringBuffer.append("CAPS_EMPTY");
/*     */     } else {
/* 102 */       if ((this.caps & 0x2) != 0) {
/* 103 */         localStringBuffer.append("CAPS_RT_PLAIN_ALPHA|");
/*     */       }
/* 105 */       if ((this.caps & 0x4) != 0) {
/* 106 */         localStringBuffer.append("CAPS_RT_TEXTURE_ALPHA|");
/*     */       }
/* 108 */       if ((this.caps & 0x8) != 0) {
/* 109 */         localStringBuffer.append("CAPS_RT_TEXTURE_OPAQUE|");
/*     */       }
/* 111 */       if ((this.caps & 0x10) != 0) {
/* 112 */         localStringBuffer.append("CAPS_MULTITEXTURE|");
/*     */       }
/* 114 */       if ((this.caps & 0x20) != 0) {
/* 115 */         localStringBuffer.append("CAPS_TEXNONPOW2|");
/*     */       }
/* 117 */       if ((this.caps & 0x40) != 0) {
/* 118 */         localStringBuffer.append("CAPS_TEXNONSQUARE|");
/*     */       }
/* 120 */       if ((this.caps & 0x80) != 0) {
/* 121 */         localStringBuffer.append("CAPS_PS20|");
/*     */       }
/* 123 */       if ((this.caps & 0x100) != 0) {
/* 124 */         localStringBuffer.append("CAPS_PS30|");
/*     */       }
/*     */     }
...
/* Location:              E:\java_source\rt.jar!\sun\java2d\pipe\hw\ContextCapabilities.class
