...
/*     */     case 16: 
/* 104 */       if (((paramColorModel instanceof DirectColorModel)) && 
/* 105 */         (((DirectColorModel)paramColorModel).getBlueMask() == 62))
/*     */       {
...
/*     */     
/*     */ 
/* 124 */     throw new InvalidPipeException("Unsupported bit depth: " + paramColorModel.getPixelSize());
/*     */   }
/*     */   
...
/*     */     }
/*     */     
/* 266 */     this.graphicsConfig = ((Win32GraphicsConfig)paramWComponentPeer.getGraphicsConfiguration());
/* 267 */     this.solidloops = this.graphicsConfig.getSolidLoops(paramSurfaceType);
/*     */     
/*     */ 
/* 270 */     Object localObject = (Win32GraphicsDevice)this.graphicsConfig.getDevice();
...
/* 298 */     if ((paramSunGraphics2D.transformState < 3) && (paramSunGraphics2D.clipState != 2))
/*     */     {
/* 300 */       if ((CompositeType.SrcOverNoEa.equals(localCompositeType)) || 
/* 301 */         (CompositeType.SrcNoEa.equals(localCompositeType)))
/*     */       {
...
/* Location:              E:\java_source\rt.jar!\sun\java2d\windows\GDIWindowSurfaceData.class
