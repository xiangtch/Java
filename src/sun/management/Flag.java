...
/*     */     
/*  75 */     List localList = getFlags(arrayOfString, 1);
/*  76 */     if (localList.isEmpty()) {
/*  77 */       return null;
/*     */     }
/*     */     
/*  80 */     return (Flag)localList.get(0);
/*     */   }
/*     */   
...
/*  92 */     Flag[] arrayOfFlag1 = new Flag[paramInt];
/*  93 */     int i = getFlags(paramArrayOfString, arrayOfFlag1, paramInt);
/*     */     
/*  95 */     ArrayList localArrayList = new ArrayList();
/*  96 */     for (Flag localFlag : arrayOfFlag1) {
/*  97 */       if (localFlag != null) {
/*  98 */         localArrayList.add(localFlag);
/*     */       }
/*     */     }
/* 101 */     return localArrayList;
/*     */   }
/*     */   
...
/*     */   
/* 118 */   static { AccessController.doPrivileged(new PrivilegedAction()
/*     */     {
/*     */       public Void run() {
...
/* Location:              E:\java_source\rt.jar!\sun\management\Flag.class
