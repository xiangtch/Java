...
/*  75 */     Object localObject2; if ((paramType instanceof Class)) {
...
/* 105 */     return (MappedMXBeanType)localObject1;
/*     */   }
/*     */   
...
/* 281 */       Object localObject = paramClass;
/*     */       
/* 283 */       for (int i = 0; ((Class)localObject).isArray(); i++) {
/* 284 */         localStringBuilder.append('[');
/* 285 */         localObject = ((Class)localObject).getComponentType();
/*     */       }
/* 287 */       this.baseElementType = getMappedType((Type)localObject);
/* 288 */       if (((Class)localObject).isPrimitive()) {
...
/*     */     
/*     */     GenericArrayMXBeanType(GenericArrayType paramGenericArrayType) throws OpenDataException {
...
/*     */       
/*     */ 
/* 463 */       Object[] arrayOfObject = (Object[])Array.newInstance(this.paramType.getMappedTypeClass(), localList
/* 464 */         .size());
/* 465 */       int i = 0;
/* 466 */       for (Object localObject : localList) {
...
/*     */ 
/*     */ 
/* 516 */       this.typeName = ("Map<" + this.keyType.getName() + "," + this.valueType.getName() + ">");
/*     */       
/*     */ 
...
/*     */ 
/*     */ 
/* 525 */       CompositeType localCompositeType = new CompositeType(this.typeName, this.typeName, MappedMXBeanType.mapItemNames, MappedMXBeanType.mapItemNames, arrayOfOpenType);
/*     */       
/*     */ 
...
/*     */       
/* 546 */       for (Entry localEntry : localMap.entrySet()) {
...
/*     */         
/*     */ 
/* 551 */         CompositeDataSupport localCompositeDataSupport = new CompositeDataSupport(localCompositeType, MappedMXBeanType.mapItemNames, new Object[] { localObject1, localObject2 });
/*     */         
...
/* 618 */             return CompositeDataMXBeanType.this.javaClass.getMethod("from", new Class[] { MappedMXBeanType.COMPOSITE_DATA_CLASS });
/*     */           }
/*     */         }));
/*     */       }
...
/*     */ 
/*     */ 
/* 637 */         Method[] arrayOfMethod = (Method[])AccessController.doPrivileged(new PrivilegedAction()
/*     */         {
/*     */           public Method[] run() {
/* 639 */             return CompositeDataMXBeanType.this.javaClass.getMethods();
/*     */           }
/* 641 */         });
...
/* 655 */           } else { if ((!str1.startsWith("is")) || (!(localType instanceof Class)) || ((Class)localType != Boolean.TYPE)) {
/*     */               continue;
/*     */             }
...
/*     */ 
/* 664 */           if ((!str2.equals("")) && 
/* 665 */             (localMethod.getParameterTypes().length <= 0) && (localType != Void.TYPE))
/*     */           {
/* 667 */             if (!str2.equals("Class"))
/*     */             {
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */ 
/* 681 */         this.openType = new CompositeType(paramClass.getName(), paramClass.getName(), arrayOfString, arrayOfString, (OpenType[])localArrayList2.toArray(new OpenType[0]));
/*     */       }
/*     */     }
/*     */     
/*     */     Type getJavaType() {
...
/*     */         }
/* 706 */         return LockInfoCompositeData.toCompositeData((LockInfo)paramObject);
/*     */       }
/*     */       
/* 709 */       if ((paramObject instanceof MemoryNotificationInfo)) {
/* 710 */         return 
/* 711 */           MemoryNotifInfoCompositeData.toCompositeData((MemoryNotificationInfo)paramObject);
/*     */       }
/*     */       
...
/*     */       {
/* 750 */         OpenDataException localOpenDataException = new OpenDataException("Failed to invoke " + this.fromMethod.getName() + " to convert CompositeData  to " + this.javaClass.getName());
...
/* 802 */         OpenType localOpenType = simpleTypes[i];
/*     */         Class localClass1;
/*     */         try {
/* 805 */           localClass1 = Class.forName(localOpenType.getClassName(), false, MappedMXBeanType.class
/* 806 */             .getClassLoader());
...
/* Location:              E:\java_source\rt.jar!\sun\management\MappedMXBeanType.class
