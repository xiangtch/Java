...
/*     */ 
/*     */ 
/* 131 */       throw new IllegalArgumentException("Invalid threshold: " + paramLong + " must be <= maxSize. Committed = " + localMemoryUsage.getCommitted() + " Max = " + localMemoryUsage.getMax());
/*     */     }
/*     */     
...
/* 183 */     return (localMemoryUsage.getUsed() >= this.usageThreshold) || 
/* 184 */       (this.usageSensor.isOn());
/*     */   }
/*     */   
...
/*     */     {
/*     */ 
/* 226 */       throw new IllegalArgumentException("Invalid threshold: " + paramLong + " > max (" + localMemoryUsage.getMax() + ").");
/*     */     }
/*     */     
...
/* 252 */     return (this.gcSensor.isOn()) || ((localMemoryUsage != null) && 
/* 253 */       (localMemoryUsage.getUsed() >= this.collectionThreshold));
/*     */   }
/*     */   
...
/* 296 */       super();
/* 297 */       this.pool = paramMemoryPoolImpl;
/*     */     }
/*     */     
...
/*     */     {
/* 324 */       super();
/* 325 */       this.pool = paramMemoryPoolImpl;
/*     */     }
/*     */     
/* 328 */     void triggerAction(MemoryUsage paramMemoryUsage) { MemoryImpl.createNotification("java.management.memory.collection.threshold.exceeded", this.pool
/* 329 */         .getName(), paramMemoryUsage, 
/*     */         
/* 331 */         MemoryPoolImpl.this.gcSensor.getCount());
/*     */     }
/*     */     
/*     */ 
/*     */     void triggerAction() {}
...
/* Location:              E:\java_source\rt.jar!\sun\management\MemoryPoolImpl.class
