...
/*     */     {
/* 242 */       for (int i = 0; i < paramArrayOfLong.length; i++) {
/* 243 */         if (paramArrayOfLong[i] != Thread.currentThread().getId()) {
...
/* 383 */     for (int i = 0; i < arrayOfThread.length; i++) {
/* 384 */       Thread localThread = arrayOfThread[i];
/* 385 */       arrayOfLong[i] = localThread.getId();
/*     */     }
...
/* 404 */     for (int i = 0; i < arrayOfThread.length; i++) {
/* 405 */       Thread localThread = arrayOfThread[i];
/* 406 */       arrayOfLong[i] = localThread.getId();
/*     */     }
...
/* 481 */   public ObjectName getObjectName() { return Util.newObjectName("java.lang:type=Threading"); }
/*     */ }


/* Location:              E:\java_source\rt.jar!\sun\management\ThreadImpl.class
