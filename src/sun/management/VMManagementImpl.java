...
/*     */ {
/*  64 */   private static String version = ;
/*  65 */   static { if (version == null) {
...
/*     */   }
/*     */   
/* 157 */   public String getVmVersion() { return System.getProperty("java.vm.version"); }
/*     */   
/*     */   public String getVmSpecName() {
/* 160 */     return System.getProperty("java.vm.specification.name");
/*     */   }
/*     */   
/* 163 */   public String getVmSpecVendor() { return System.getProperty("java.vm.specification.vendor"); }
/*     */   
/*     */   public String getVmSpecVersion() {
/* 166 */     return System.getProperty("java.vm.specification.version");
/*     */   }
/*     */   
/* 169 */   public String getClassPath() { return System.getProperty("java.class.path"); }
/*     */   
...
/* 176 */     GetPropertyAction localGetPropertyAction = new GetPropertyAction("sun.boot.class.path");
/*     */     
/* 178 */     String str = (String)AccessController.doPrivileged(localGetPropertyAction);
/* 179 */     return str;
/*     */   }
/*     */   
...
/*     */   
/* 188 */   public synchronized List<String> getVmArguments() { if (this.vmArgs == null) {
/* 189 */       String[] arrayOfString = getVmArguments0();
/*     */       
/* 191 */       List localList = (arrayOfString != null) && (arrayOfString.length != 0) ? Arrays.asList(arrayOfString) : Collections.emptyList();
/* 192 */       this.vmArgs = Collections.unmodifiableList(localList);
/*     */     }
...
/*     */   {
/* 204 */     String str = (String)AccessController.doPrivileged(new PrivilegedAction()
/*     */     {
/*     */       public String run() {
...
/*     */   }
/*     */   
/* 225 */   public String getOsArch() { return System.getProperty("os.arch"); }
/*     */   
...
/*     */     
/*     */ 
/* 255 */     Perf localPerf = (Perf)AccessController.doPrivileged(new GetPerfAction());
/*     */     try {
/* 257 */       ByteBuffer localByteBuffer = localPerf.attach(0, "r");
/* 258 */       if (localByteBuffer.capacity() == 0) {
/* 259 */         this.noPerfData = true;
/* 260 */         return null;
/*     */       }
/* 262 */       this.perfInstr = new PerfInstrumentation(localByteBuffer);
/*     */     }
/*     */     catch (IllegalArgumentException localIllegalArgumentException)
/*     */     {
/* 266 */       this.noPerfData = true;
/*     */     } catch (IOException localIOException) {
/* 268 */       throw new AssertionError(localIOException);
/*     */     }
/* 270 */     return this.perfInstr;
/*     */   }
/*     */   
/*     */   public List<Counter> getInternalCounters(String paramString) {
/* 274 */     PerfInstrumentation localPerfInstrumentation = getPerfInstrumentation();
/* 275 */     if (localPerfInstrumentation != null) {
/* 276 */       return localPerfInstrumentation.findByPattern(paramString);
/*     */     }
...
/* Location:              E:\java_source\rt.jar!\sun\management\VMManagementImpl.class
