...
/*     */ 
/*     */ 
/*  83 */       throw new InstrumentationException("Entry extends beyond end of buffer:  entryStart = " + this.entryStart + " entryLength = " + this.entryLength + " buffer limit = " + paramByteBuffer.limit());
/*     */     }
/*     */     
...
/*     */ 
/*     */ 
/*  93 */       throw new InstrumentationException("Invalid name offset:  entryStart = " + this.entryStart + " nameOffset = " + i + " buffer limit = " + paramByteBuffer.limit());
/*     */     }
/*     */     
/*     */ 
...
/*     */     {
/* 136 */       throw new InternalError(localUnsupportedEncodingException.getMessage(), localUnsupportedEncodingException);
/*     */     }
/*     */     
...
/*     */ 
/*     */ 
/* 160 */       throw new InstrumentationException("Data extends beyond end of buffer:  entryStart = " + this.entryStart + " dataOffset = " + this.dataOffset + " dataSize = " + this.dataSize + " buffer limit = " + paramByteBuffer.limit());
/*     */     }
/*     */     
...
/* Location:              E:\java_source\rt.jar!\sun\management\counter\perf\PerfDataEntry.class
