...
/*     */     throws JdpException
/*     */   {
/* 110 */     JdpPacketReader localJdpPacketReader = new JdpPacketReader(paramArrayOfByte);
/* 111 */     Map localMap = localJdpPacketReader.getDiscoveryDataAsMap();
/*     */     
/* 113 */     String str = (String)localMap.get("DISCOVERABLE_SESSION_UUID");
/* 114 */     this.id = (str == null ? null : UUID.fromString(str));
/* 115 */     this.jmxServiceUrl = ((String)localMap.get("JMX_SERVICE_URL"));
/* 116 */     this.mainClass = ((String)localMap.get("MAIN_CLASS"));
/* 117 */     this.instanceName = ((String)localMap.get("INSTANCE_NAME"));
/* 118 */     this.processId = ((String)localMap.get("PROCESS_ID"));
/* 119 */     this.rmiHostname = ((String)localMap.get("RMI_HOSTNAME"));
/* 120 */     this.broadcastInterval = ((String)localMap.get("BROADCAST_INTERVAL"));
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */     throws IOException
/*     */   {
/* 205 */     JdpPacketWriter localJdpPacketWriter = new JdpPacketWriter();
/* 206 */     localJdpPacketWriter.addEntry("DISCOVERABLE_SESSION_UUID", this.id == null ? null : this.id.toString());
/* 207 */     localJdpPacketWriter.addEntry("MAIN_CLASS", this.mainClass);
/* 208 */     localJdpPacketWriter.addEntry("JMX_SERVICE_URL", this.jmxServiceUrl);
/* 209 */     localJdpPacketWriter.addEntry("INSTANCE_NAME", this.instanceName);
/* 210 */     localJdpPacketWriter.addEntry("PROCESS_ID", this.processId);
/* 211 */     localJdpPacketWriter.addEntry("RMI_HOSTNAME", this.rmiHostname);
/* 212 */     localJdpPacketWriter.addEntry("BROADCAST_INTERVAL", this.broadcastInterval);
/*     */     
/* 214 */     return localJdpPacketWriter.getPacketBytes();
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */     }
/*     */     
/* 242 */     JdpJmxPacket localJdpJmxPacket = (JdpJmxPacket)paramObject;
/* 243 */     return (Objects.equals(this.id, localJdpJmxPacket.getId())) && (Objects.equals(this.jmxServiceUrl, localJdpJmxPacket.getJmxServiceUrl()));
/*     */   }
/*     */ }


/* Location:              E:\java_source\rt.jar!\sun\management\jdp\JdpJmxPacket.class
