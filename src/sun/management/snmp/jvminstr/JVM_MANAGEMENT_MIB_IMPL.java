...
/*  94 */       return (SnmpOidTable)localObject;
/*     */     }
/*     */     
...
/*     */     }
/*     */     
/* 103 */     return (SnmpOidTable)localObject;
/*     */   }
/*     */   
...
/*     */     {
/* 113 */       JVM_MANAGEMENT_MIB_IMPL.log.debug("handleNotification", "Received notification [ " + paramNotification
/* 114 */         .getType() + "]");
/*     */       
/* 116 */       String str = paramNotification.getType();
/* 117 */       if ((str.equals("java.management.memory.threshold.exceeded")) || 
/* 118 */         (str.equals("java.management.memory.collection.threshold.exceeded")))
/*     */       {
/*     */ 
/* 121 */         MemoryNotificationInfo localMemoryNotificationInfo = MemoryNotificationInfo.from((CompositeData)paramNotification.getUserData());
/* 122 */         SnmpCounter64 localSnmpCounter641 = new SnmpCounter64(localMemoryNotificationInfo.getCount());
/*     */         
/* 124 */         SnmpCounter64 localSnmpCounter642 = new SnmpCounter64(localMemoryNotificationInfo.getUsage().getUsed());
/* 125 */         SnmpString localSnmpString = new SnmpString(localMemoryNotificationInfo.getPoolName());
/*     */         
/* 127 */         SnmpOid localSnmpOid1 = JVM_MANAGEMENT_MIB_IMPL.this.getJvmMemPoolEntryIndex(localMemoryNotificationInfo.getPoolName());
/*     */         
/* 129 */         if (localSnmpOid1 == null) {
/* 130 */           JVM_MANAGEMENT_MIB_IMPL.log.error("handleNotification", "Error: Can't find entry index for Memory Pool: " + localMemoryNotificationInfo
/*     */           
...
/*     */           {
/*     */ 
/* 147 */             localSnmpOid2 = new SnmpOid(localSnmpOidTable.resolveVarName("jvmLowMemoryPoolUsageNotif").getOid());
/*     */             
/*     */ 
/* 150 */             localSnmpOid3 = new SnmpOid(localSnmpOidTable.resolveVarName("jvmMemPoolUsed").getOid() + "." + localSnmpOid1);
/*     */             
/*     */ 
/*     */ 
/* 154 */             localSnmpOid4 = new SnmpOid(localSnmpOidTable.resolveVarName("jvmMemPoolThreshdCount").getOid() + "." + localSnmpOid1);
/*     */           }
/* 156 */           else if (str.equals("java.management.memory.collection.threshold.exceeded"))
/*     */           {
/*     */ 
/*     */ 
/* 160 */             localSnmpOid2 = new SnmpOid(localSnmpOidTable.resolveVarName("jvmLowMemoryPoolCollectNotif").getOid());
/*     */             
/*     */ 
/* 163 */             localSnmpOid3 = new SnmpOid(localSnmpOidTable.resolveVarName("jvmMemPoolCollectUsed").getOid() + "." + localSnmpOid1);
/*     */             
/*     */ 
/*     */ 
/*     */ 
/* 168 */             localSnmpOid4 = new SnmpOid(localSnmpOidTable.resolveVarName("jvmMemPoolCollectThreshdCount").getOid() + "." + localSnmpOid1);
/*     */           }
/*     */           
/*     */ 
/*     */ 
...
/*     */           
/*     */ 
/* 176 */           SnmpOid localSnmpOid5 = new SnmpOid(localSnmpOidTable.resolveVarName("jvmMemPoolName").getOid() + "." + localSnmpOid1);
/*     */           
/*     */ 
...
/* 190 */           JVM_MANAGEMENT_MIB_IMPL.log.error("handleNotification", "Exception occurred : " + localException);
/*     */         }
/*     */       }
/*     */     }
/*     */   }
...
/*     */     
/* 220 */     SnmpAdaptorServer localSnmpAdaptorServer = (SnmpAdaptorServer)getSnmpAdaptor();
/*     */     
...
/*     */         
/* 237 */         SnmpPeer localSnmpPeer = new SnmpPeer(localNotificationTarget.getAddress(), localNotificationTarget.getPort());
...
/* 241 */         log.debug("handleNotification", "Sending trap to " + localNotificationTarget
/* 242 */           .getAddress() + ":" + localNotificationTarget.getPort());
/* 243 */         localSnmpAdaptorServer.snmpV2Trap(localSnmpPeer, paramSnmpOid, paramSnmpVarBindList, null);
/*     */       } catch (Exception localException) {
/* 245 */         log.error("sendTrap", "Exception occurred while sending trap to [" + localNotificationTarget + "]. Exception : " + localException);
/*     */         
/*     */ 
...
/*     */   {
/* 627 */     SnmpMibTable localSnmpMibTable = getRegisteredTableMeta("JvmMemPoolTable");
/* 628 */     if (!(localSnmpMibTable instanceof JvmMemPoolTableMetaImpl))
/*     */     {
/*     */ 
/* 631 */       localObject = "Bad metadata class for JvmMemPoolTable: " + localSnmpMibTable.getClass().getName();
...
/*     */       {
/* 649 */         localObject = "Bad class for JvmMemPoolTable datas: " + paramSnmpTableHandler.getClass().getName();
...
/* Location:              E:\java_source\rt.jar!\sun\management\snmp\jvminstr\JVM_MANAGEMENT_MIB_IMPL.class
