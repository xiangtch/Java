...
/*     */   {
/*  98 */     return new JvmMemMgrPoolRelEntryMeta(paramSnmpMib, this.objectserver);
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */   {
/* 134 */     this.node = createJvmMemMgrPoolRelEntryMetaNode("JvmMemMgrPoolRelEntry", "JvmMemMgrPoolRelTable", paramSnmpMib, paramMBeanServer);
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */     throws SnmpStatusException
/*     */   {
/* 148 */     if (!(paramObject instanceof JvmMemMgrPoolRelEntryMBean)) {
/* 149 */       throw new ClassCastException("Entries for Table \"JvmMemMgrPoolRelTable\" must implement the \"JvmMemMgrPoolRelEntryMBean\" interface.");
/*     */     }
/*     */     
...
/*     */     throws SnmpStatusException
/*     */   {
/* 165 */     JvmMemMgrPoolRelEntryMBean localJvmMemMgrPoolRelEntryMBean = (JvmMemMgrPoolRelEntryMBean)getEntry(paramSnmpOid);
/* 166 */     synchronized (this) {
/* 167 */       this.node.setInstance(localJvmMemMgrPoolRelEntryMBean);
...
/*     */     }
/* 183 */     JvmMemMgrPoolRelEntryMBean localJvmMemMgrPoolRelEntryMBean = (JvmMemMgrPoolRelEntryMBean)getEntry(paramSnmpOid);
/* 184 */     synchronized (this) {
/* 185 */       this.node.setInstance(localJvmMemMgrPoolRelEntryMBean);
...
/*     */     }
/* 201 */     JvmMemMgrPoolRelEntryMBean localJvmMemMgrPoolRelEntryMBean = (JvmMemMgrPoolRelEntryMBean)getEntry(paramSnmpOid);
/* 202 */     synchronized (this) {
/* 203 */       this.node.setInstance(localJvmMemMgrPoolRelEntryMBean);
...
/*     */     try
/*     */     {
/* 244 */       JvmMemMgrPoolRelEntryMBean localJvmMemMgrPoolRelEntryMBean = (JvmMemMgrPoolRelEntryMBean)getEntry(paramSnmpOid);
/* 245 */       synchronized (this) {
/* 246 */         this.node.setInstance(localJvmMemMgrPoolRelEntryMBean);
...
/* Location:              E:\java_source\rt.jar!\sun\management\snmp\jvmmib\JvmMemMgrPoolRelTableMeta.class
