...
/* 223 */       if ((arrayOfByte.length == paramByteBuffer.capacity()) && 
/* 224 */         (arrayOfByte.length == paramByteBuffer.remaining())) {
...
/* Location:              E:\java_source\rt.jar!\sun\misc\CharacterEncoder.class
