...
/*     */   static
/*     */   {
/*  88 */     String str1 = (String)AccessController.doPrivileged(new GetPropertyAction("sun.perflog"));
/*     */     
/*  90 */     if (str1 != null) {
...
/*     */ 
/*     */ 
/*  95 */       String str2 = (String)AccessController.doPrivileged(new GetPropertyAction("sun.perflog.nano"));
/*     */       
/*  97 */       if (str2 != null) {
/*  98 */         useNanoTime = true;
/*     */       }
...
/* 115 */               System.out.println(localException + ": Creating logfile " + 
/* 116 */                 PerformanceLogger.logFileName + ".  Log to console");
/*     */             }
/*     */             
/* 119 */             return null;
/*     */           }
...
/* 294 */               paramWriter.write(i + " " + localTimeData.getMessage() + ": " + (localTimeData
...
/* Location:              E:\java_source\rt.jar!\sun\misc\PerformanceLogger.class
