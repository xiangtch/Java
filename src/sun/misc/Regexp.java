...
/*     */   {
/* 108 */     if (this.exact)
/* 109 */       return (paramInt2 == this.totalLen) && 
/* 110 */         (this.exp.regionMatches(this.ignoreCase, 0, paramString, paramInt1, paramInt2));
/* 111 */     if (paramInt2 < this.totalLen)
/* 112 */       return false;
/* 113 */     if ((this.prefixLen <= 0) || 
/* 114 */       (this.prefix.regionMatches(this.ignoreCase, 0, paramString, paramInt1, this.prefixLen))) { if (this.suffixLen > 0)
/*     */       {
/*     */ 
/*     */ 
/* 118 */         if (this.suffix.regionMatches(this.ignoreCase, 0, paramString, paramInt1 + paramInt2 - this.suffixLen, this.suffixLen)) {}
/*     */       }
/*     */     } else
/* 121 */       return false;
...
/* 130 */       while ((j + n <= k) && 
/* 131 */         (!str.regionMatches(this.ignoreCase, 0, paramString, j, n)))
/*     */       {
/* 133 */         j++; }
/* 134 */       if (j + n > k)
/* 135 */         return false;
...
/* Location:              E:\java_source\rt.jar!\sun\misc\Regexp.class
