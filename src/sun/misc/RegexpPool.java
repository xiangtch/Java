...
/* 105 */       if ((localRegexpNode1.result != null) && (localRegexpNode1.depth < Integer.MAX_VALUE) && ((!localRegexpNode1.exact) || (j == i)))
/*     */       {
...
/* 116 */     j = i; for (;;) { j--; if ((j < 0) || (localRegexpNode1 == null)) break;
/* 117 */       if ((localRegexpNode1.result != null) && (localRegexpNode1.depth < Integer.MAX_VALUE)) {
/* 118 */         k = 0;
...
/*     */   {
/* 154 */     return matchAfter(paramString, Integer.MAX_VALUE);
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/* 215 */     m = k; for (;;) { m--; if ((m < 0) || (localRegexpNode1 == null)) break;
...
/* Location:              E:\java_source\rt.jar!\sun\misc\RegexpPool.class
