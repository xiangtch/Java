...
/*   89 */     if (!VM.isSystemDomainLoader(localClass.getClassLoader()))
...
/*      */     do
/*      */     {
/* 1034 */       i = getIntVolatile(paramObject, paramLong);
/* 1035 */     } while (!compareAndSwapInt(paramObject, paramLong, i, i + paramInt));
/* 1036 */     return i;
/*      */   }
/*      */   
/*      */ 
...
/*      */     do
/*      */     {
/* 1053 */       l = getLongVolatile(paramObject, paramLong1);
/* 1054 */     } while (!compareAndSwapLong(paramObject, paramLong1, l, l + paramLong2));
/* 1055 */     return l;
/*      */   }
/*      */   
/*      */ 
...
/*      */     do
/*      */     {
/* 1072 */       i = getIntVolatile(paramObject, paramLong);
/* 1073 */     } while (!compareAndSwapInt(paramObject, paramLong, i, paramInt));
/* 1074 */     return i;
/*      */   }
/*      */   
/*      */ 
...
/*      */     do
/*      */     {
/* 1091 */       l = getLongVolatile(paramObject, paramLong1);
/* 1092 */     } while (!compareAndSwapLong(paramObject, paramLong1, l, paramLong2));
/* 1093 */     return l;
/*      */   }
/*      */   
/*      */ 
...
/*      */     do
/*      */     {
/* 1110 */       localObject = getObjectVolatile(paramObject1, paramLong);
/* 1111 */     } while (!compareAndSwapObject(paramObject1, paramLong, localObject, paramObject2));
/* 1112 */     return localObject;
/*      */   }
/*      */   
/*      */ 
/*      */ 
...
/* Location:              E:\java_source\rt.jar!\sun\misc\Unsafe.class
