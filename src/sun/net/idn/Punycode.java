...
/* 192 */         if (i1 < i11) {
/* 193 */           arrayOfInt[(i8++)] = 0;
/* 194 */           arrayOfChar[i1] = (paramArrayOfBoolean != null ? 
/*     */           
/* 196 */             asciiCaseMap(i9, paramArrayOfBoolean[i3]) : i9);
/*     */         }
/*     */         
/* 199 */         i1++;
/*     */       } else {
...
/*     */ 
/*     */ 
/* 242 */       int i4 = Integer.MAX_VALUE; int i5; for (i3 = 0; i3 < i8; i3++) {
...
/* 320 */     return (paramInt & 0xF800) == 55296;
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */         }
/* 401 */         if (i7 > (Integer.MAX_VALUE - m) / i5)
/*     */         {
...
/*     */         }
/*     */         
/* 417 */         if (i5 > Integer.MAX_VALUE / (36 - i8))
/*     */         {
...
/*     */ 
/*     */ 
/* 436 */       if (m / i9 > Integer.MAX_VALUE - j)
/*     */       {
