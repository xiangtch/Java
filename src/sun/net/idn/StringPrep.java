...
/*     */   }
/*     */   
/* 188 */   private static VersionInfo getVersionInfo(byte[] paramArrayOfByte) { if (paramArrayOfByte.length != 4) {
/* 189 */       return null;
/*     */     }
...
/* 231 */     if ((localVersionInfo.compareTo(this.sprepUniVer) < 0) && 
/* 232 */       (localVersionInfo.compareTo(this.normCorrVer) < 0) && ((this.indexes[7] & 0x1) > 0))
/*     */     {
/*     */ 
...
/*     */     int type;
/*     */     
/* 245 */     public void reset() { this.isIndex = false;
/* 246 */       this.value = 0;
/* 247 */       this.type = -1;
/*     */     }
/*     */   }
...
/*     */       {
/* 304 */         throw new ParseException("An unassigned code point was found in the input " + paramUCharacterIterator.getText(), paramUCharacterIterator.getIndex()); }
/* 305 */       if (localValues.type == 1)
/*     */       {
/*     */ 
/* 308 */         if (localValues.isIndex) {
/* 309 */           int k = localValues.value;
/* 310 */           int m; if ((k >= this.indexes[3]) && (k < this.indexes[4]))
/*     */           {
/* 312 */             m = 1;
...
/*     */       {
/* 450 */         throw new ParseException("A prohibited code point was found in the input" + localUCharacterIterator.getText(), localValues.value);
/*     */       }
/*     */       
...
/* 468 */       if ((i2 == 1) && (i1 == 1))
/*     */       {
/* 470 */         throw new ParseException("The input does not conform to the rules for BiDi code points." + localUCharacterIterator.getText(), m > n ? m : n);
/*     */       }
/*     */       
/*     */ 
/*     */ 
...
/*     */ 
/*     */ 
/* 480 */         throw new ParseException("The input does not conform to the rules for BiDi code points." + localUCharacterIterator.getText(), m > n ? m : n);
/*     */       }
/*     */     }
/*     */     
