...
/* 200 */       this.returnsValue = paramBoolean;
/*     */     }
/*     */     
/* 203 */     public boolean hasNext() { return this.index < HeaderParser.this.nkeys; }
/*     */     
/*     */     public String next() {
/* 206 */       return HeaderParser.this.tab[(this.index++)][0];
/*     */     }
/*     */     
/* 209 */     public void remove() { throw new UnsupportedOperationException("remove not supported"); }
/*     */   }
/*     */   
