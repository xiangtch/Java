...
/* 203 */     return (paramString != null) && 
/* 204 */       (paramString.length() > 0) && 
/* 205 */       (paramString.endsWith("/*"));
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */ 
/*     */ 
/* 337 */       "MimeEntry[contentType=" + this.typeName + ", image=" + this.imageFileName + ", action=" + this.action + ", command=" + this.command + ", extensions=" + getExtensionsAsList() + "]";
/*     */   }
/*     */ }
