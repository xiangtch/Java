...
/*     */       {
/* 140 */         localObject1 = ((String)localObject1).substring(0, i) + this.uc.getContentType() + ((String)localObject1).substring(i + 2);
/*     */       }
/*     */       
/* 143 */       int j = 0;
