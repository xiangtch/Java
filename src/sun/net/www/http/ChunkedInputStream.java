...
/*  81 */   private byte[] chunkData = new byte['က'];
/*     */   
/*     */ 
/*     */ 
/*     */ 
...
/*     */     throws IOException
/*     */   {
/* 280 */     while (this.state != 5) { int i;
/*     */       int j;
/* 282 */       Object localObject; switch (this.state)
/*     */       {
/*     */ 
/*     */ 
/*     */ 
...
/* 311 */         for (j = 0; j < str1.length(); j++) {
/* 312 */           if (Character.digit(str1.charAt(j), 16) == -1)
/*     */             break;
/*     */         }
/*     */         try {
