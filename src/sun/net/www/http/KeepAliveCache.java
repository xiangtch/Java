...
/*     */   
/*  54 */   static int getMaxConnections() { if (result == -1)
/*     */     {
/*     */ 
/*     */ 
/*  58 */       result = ((Integer)AccessController.doPrivileged(new GetIntegerAction("http.maxConnections", 5))).intValue();
/*  59 */       if (result <= 0)
/*  60 */         result = 5;
/*     */     }
/*  62 */     return result;
...
/*     */           }
/*     */           
/* 106 */           KeepAliveCache.this.keepAliveTimer = new Thread((ThreadGroup)localObject, localObject, "Keep-Alive-Timer");
...
/*     */     }
/*     */     
/* 118 */     final Object localObject = new KeepAliveKey(paramURL, paramObject);
...
/*     */       try
/*     */       {
/* 172 */         Thread.sleep(5000L); } catch (InterruptedException localInterruptedException) {}
/*     */       Iterator localIterator;
/* 174 */       KeepAliveKey localKeepAliveKey; synchronized (this)
/*     */       {
/*     */ 
/*     */ 
/*     */ 
