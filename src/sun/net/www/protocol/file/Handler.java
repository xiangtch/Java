...
/*     */     
/*  86 */     if ((str3 == null) || (str3.equals("")) || 
/*  87 */       (str3.equalsIgnoreCase("localhost")) || 
/*  88 */       (str3.equals("~"))) {
...
/*     */     try
/*     */     {
/* 110 */       URL localURL = new URL("ftp", str3, str2 + (paramURL.getRef() == null ? "" : new StringBuilder().append("#").append(paramURL.getRef()).toString()));
...
/*     */     {
/* 121 */       throw new IOException("Unable to connect to: " + paramURL.toExternalForm());
/*     */     }
