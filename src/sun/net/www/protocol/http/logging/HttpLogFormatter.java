...
/*  60 */     Object localObject1; int j; Object localObject2; if (str2.startsWith("sun.net.www.MessageHeader@"))
/*     */     {
/*     */ 
/*     */ 
...
/*  81 */       while (((String)localObject1).length() >= 7) { String str3;
/*  82 */         int k; int m; String str4; if (((String)localObject1).startsWith("Cookie=[")) {
