...
/*     */     throws IOException
/*     */   {
/* 151 */     InetSocketAddress localInetSocketAddress = paramSocketAddress == null ? new InetSocketAddress(0) : Net.checkAddress(paramSocketAddress);
...
/*     */     try {
/* 214 */       begin();
/* 215 */       Object localObject1; if ((paramSocketOption == StandardSocketOptions.SO_REUSEADDR) && 
...
/* 228 */     static final Set<SocketOption<?>> defaultOptions = ;
/*     */     
