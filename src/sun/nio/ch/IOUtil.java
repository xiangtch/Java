...
/*  87 */       return 0;
/*  88 */     if (paramLong != -1L) {
/*  89 */       m = paramNativeDispatcher.pwrite(paramFileDescriptor, ((DirectBuffer)paramByteBuffer)
/*  90 */         .address() + i, k, paramLong);
/*     */     }
/*     */     else {
...
/* 118 */       int m = paramInt1;
/* 119 */       int i1; while ((m < k) && (j < IOV_MAX)) {
...
/* 143 */         m++;
/*     */       }
/* 145 */       if (j == 0) { ByteBuffer localByteBuffer1;
/* 146 */         return 0L;
/*     */       }
...
/*     */ 
/* 151 */       long l2 = l1;
/* 152 */       int i4; for (int i3 = 0; i3 < j; i3++) {
/* 153 */         if (l2 > 0L) {
...
/*     */       
/* 168 */       i = 1;
/* 169 */       ByteBuffer localByteBuffer4; return l1;
/*     */ 
/*     */     }
/*     */     finally
/*     */     {
...
/* 248 */       int m = paramInt1;
/* 249 */       int i1; while ((m < k) && (j < IOV_MAX)) {
...
/* 273 */         m++;
/*     */       }
/* 275 */       if (j == 0) { ByteBuffer localByteBuffer1;
/* 276 */         return 0L;
/*     */       }
...
/*     */       
/* 302 */       i = 1;
/* 303 */       int i4; ByteBuffer localByteBuffer5; return l1;
/*     */ 
/*     */     }
/*     */     finally
/*     */     {
