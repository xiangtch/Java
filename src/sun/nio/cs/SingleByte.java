...
/*  90 */           CoderResult localCoderResult2; if (j == 65533)
...
/*     */     
/* 116 */     protected void implReplaceWith(String paramString) { this.repl = paramString.charAt(0); }
/*     */     
...
/* 151 */       return ((paramArrayOfByte.length == 1) && (paramArrayOfByte[0] == 63)) || 
/* 152 */         (super.isLegalReplacement(paramArrayOfByte));
/*     */     }
/*     */     
...
/* 195 */           int j = encode(c);
/* 196 */           CoderResult localCoderResult2; if (j == 65533) {
...
/*     */     
/* 233 */     protected void implReplaceWith(byte[] paramArrayOfByte) { this.repl = paramArrayOfByte[0]; }
/*     */     
...
/*     */         }
/*     */         else {
/* 246 */           if ((Character.isHighSurrogate(c)) && (paramInt1 < j) && 
/* 247 */             (Character.isLowSurrogate(paramArrayOfChar[paramInt1]))) {
...
/* 267 */     i = 0;
/* 268 */     int k; int m; for (int j = 0; j < paramArrayOfChar1.length; j++) {
