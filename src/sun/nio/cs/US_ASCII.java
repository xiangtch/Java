...
/*  85 */           CoderResult localCoderResult2; if (n >= 0) {
/*  86 */             if (k >= m)
...
/* 108 */           CoderResult localCoderResult2; if (j >= 0) {
...
/*     */     
/* 134 */     protected void implReplaceWith(String paramString) { this.repl = paramString.charAt(0); }
/*     */     
...
/* 163 */       return ((paramArrayOfByte.length == 1) && (paramArrayOfByte[0] >= 0)) || 
/* 164 */         (super.isLegalReplacement(paramArrayOfByte));
/*     */     }
/*     */     
...
/* 185 */           CoderResult localCoderResult2; if (c < '') {
/* 186 */             if (k >= m)
...
/* 210 */           CoderResult localCoderResult2; if (c < '') {
...
/*     */     
/* 238 */     protected void implReplaceWith(byte[] paramArrayOfByte) { this.repl = paramArrayOfByte[0]; }
/*     */     
...
/*     */         }
/*     */         else {
/* 250 */           if ((Character.isHighSurrogate(c)) && (paramInt1 < j) && 
