...
/*  53 */       return this.currentBO == 1 ? 
/*  54 */         (paramByteBuffer.get() & 0xFF) << 24 | 
/*  55 */         (paramByteBuffer.get() & 0xFF) << 16 | 
/*  56 */         (paramByteBuffer.get() & 0xFF) << 8 | paramByteBuffer
/*  57 */         .get() & 0xFF : paramByteBuffer
/*  58 */         .get() & 0xFF | 
/*  59 */         (paramByteBuffer.get() & 0xFF) << 8 | 
/*  60 */         (paramByteBuffer.get() & 0xFF) << 16 | 
/*  61 */         (paramByteBuffer.get() & 0xFF) << 24;
/*     */     }
/*     */     
...
/*     */ 
/*     */ 
/*  74 */           j = (paramByteBuffer.get() & 0xFF) << 24 | (paramByteBuffer.get() & 0xFF) << 16 | (paramByteBuffer.get() & 0xFF) << 8 | paramByteBuffer.get() & 0xFF;
...
/* 156 */           CoderResult localCoderResult2; if (!Character.isSurrogate(c1)) {
...
/* 165 */             CoderResult localCoderResult4; if (Character.isLowSurrogate(c2)) {
