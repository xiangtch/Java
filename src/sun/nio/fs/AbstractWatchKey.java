...
/*     */ 
/*     */ 
/*     */   final void signalEvent(Kind<?> paramKind, Object paramObject)
/*     */   {
...
/* 113 */         if ((((WatchEvent)localObject1).kind() == StandardWatchEventKinds.OVERFLOW) || (
/* 114 */           (paramKind == ((WatchEvent)localObject1).kind()) && 
/* 115 */           (Objects.equals(paramObject, ((WatchEvent)localObject1).context()))))
/*     */         {
...
/*     */     private int count;
/*     */     
/*     */     Event(Kind<T> paramKind, T paramT)
/*     */     {
