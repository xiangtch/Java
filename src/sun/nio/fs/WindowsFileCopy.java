...
/*  56 */     int k = 0;
/*  57 */     for (Object localObject2 : paramVarArgs) {
...
/* 122 */           if (i == 0)
/*     */           {
/* 124 */             throw new FileAlreadyExistsException(paramWindowsPath2.getPathForExceptionMessage());
/*     */           }
/*     */           
/*     */ 
/*     */         }
...
/*     */         {
/*     */ 
/* 158 */           if ((localWindowsException4.lastError() == 145) || 
/* 159 */             (localWindowsException4.lastError() == 183))
/*     */           {
/*     */ 
/* 162 */             throw new DirectoryNotEmptyException(paramWindowsPath2.getPathForExceptionMessage());
/*     */           }
/*     */         }
...
/*     */     {
/* 172 */       final int i1 = (paramWindowsPath1.getFileSystem().supportsLinks()) && (!bool) ? 2048 : 0;
/*     */       
/*     */ 
/* 175 */       if (k != 0)
/*     */       {
...
/*     */             try {
/* 185 */               WindowsNativeDispatcher.CopyFileEx(this.val$sourcePath, str2, i1, 
...
/* 227 */           WindowsPath.addPrefixIfNeeded(str3), i2);
/*     */       }
/*     */     }
...
/*     */     {
/*     */ 
/* 236 */       WindowsFileAttributeViews.Dos localDos = WindowsFileAttributeViews.createDosView(paramWindowsPath2, false);
/*     */       try {
...
/* 262 */     int i = 0;
/* 263 */     int j = 0;
/* 264 */     for (Object localObject2 : paramVarArgs) {
...
/*     */ 
/*     */ 
/* 299 */           throw new AtomicMoveNotSupportedException(paramWindowsPath1.getPathForExceptionMessage(), paramWindowsPath2.getPathForExceptionMessage(), localWindowsException1.errorString());
/*     */         }
...
/* 341 */           if (j == 0)
/*     */           {
/* 343 */             throw new FileAlreadyExistsException(paramWindowsPath2.getPathForExceptionMessage());
/*     */           }
/*     */           
/*     */ 
/*     */         }
...
/*     */         {
/*     */ 
/* 369 */           if ((localWindowsException4.lastError() == 145) || 
/* 370 */             (localWindowsException4.lastError() == 183))
/*     */           {
/*     */ 
/* 373 */             throw new DirectoryNotEmptyException(paramWindowsPath2.getPathForExceptionMessage());
/*     */           }
/*     */         }
...
/* 417 */             WindowsPath.addPrefixIfNeeded(str3), 1);
/*     */         }
/*     */       }
/*     */       catch (WindowsException localWindowsException7) {
...
/*     */ 
/*     */ 
/* 426 */       WindowsFileAttributeViews.Dos localDos = WindowsFileAttributeViews.createDosView(paramWindowsPath2, false);
/*     */       try {
...
/*     */         
/* 453 */         if ((localWindowsException8.lastError() == 145) || 
/* 454 */           (localWindowsException8.lastError() == 183))
/*     */         {
/*     */ 
/* 457 */           throw new DirectoryNotEmptyException(paramWindowsPath2.getPathForExceptionMessage());
/*     */         }
...
/*     */ 
/*     */ 
/* 485 */     WindowsSecurity.Privilege localPrivilege = WindowsSecurity.enablePrivilege("SeRestorePrivilege");
/*     */     try {
/* 487 */       int i = 7;
/*     */       
/*     */ 
/* 490 */       NativeBuffer localNativeBuffer = WindowsAclFileAttributeView.getFileSecurity(str, i);
/*     */       try {
/*     */         try {
/* 493 */           WindowsNativeDispatcher.SetFileSecurity(paramWindowsPath2.getPathForWin32Calls(), i, localNativeBuffer
/* 494 */             .address());
/*     */         } catch (WindowsException localWindowsException) {
