...
/*     */     
/*  59 */     if ((localResult.type() != WindowsPathType.ABSOLUTE) && 
/*  60 */       (localResult.type() != WindowsPathType.UNC))
...
/*     */         try
/*     */         {
/* 171 */           localWindowsPath.checkRead();
/*     */         } catch (SecurityException localSecurityException) {}
/* 173 */         continue;
/*     */         try
/*     */         {
...
/* 224 */         return new FileStoreIterator(WindowsFileSystem.this);
/*     */       }
/*     */     };
/*     */   }
/*     */   
...
/*     */   
/* 235 */   public Set<String> supportedFileAttributeViews() { return supportedFileAttributeViews; }
/*     */   
/*     */ 
...
/* 246 */       for (String str2 : paramVarArgs) {
