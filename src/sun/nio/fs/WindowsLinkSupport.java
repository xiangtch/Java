...
/*     */     {
/*     */       try {
/* 122 */         WindowsFileAttributes localWindowsFileAttributes = WindowsFileAttributes.get(localWindowsPath1, false);
/*     */         
...
/*     */       }
/*     */       
/* 131 */       WindowsPath localWindowsPath2 = WindowsPath.createFromNormalizedPath(localWindowsFileSystem, readLink(localWindowsPath1));
...
/*     */         
/* 137 */         localWindowsPath1 = (WindowsPath)AccessController.doPrivileged(new PrivilegedAction()
/*     */         {
/*     */ 
...
/* 187 */     String str2; if (((c <= 'z') && (c >= 'a')) || ((c <= 'Z') && (c >= 'A') && (i == 58) && 
/* 188 */       (str1.charAt(2) == '\\')))
/*     */     {
...
/*     */ 
/* 239 */         if ((paramBoolean) && 
/* 240 */           (WindowsFileAttributes.isReparsePoint(localFirstFile.attributes())))
/*     */         {
/* 242 */           String str5 = getFinalPath(paramWindowsPath);
/* 243 */           WindowsPath localWindowsPath; if (str5 == null)
/*     */           {
/*     */ 
/* 246 */             localWindowsPath = resolveAllLinks(
/* 247 */               WindowsPath.createFromNormalizedPath(localWindowsFileSystem, str1)); }
...
/*     */         }
/* 378 */         WindowsPath localWindowsPath2 = WindowsPath.createFromNormalizedPath(localWindowsFileSystem, readLink(localWindowsPath1));
