...
/*     */     try
/*     */     {
/* 107 */       WindowsPathParser.Result localResult = WindowsPathParser.parseNormalizedPath(paramString);
/* 108 */       if (paramBasicFileAttributes == null) {
/* 109 */         return new WindowsPath(paramWindowsFileSystem, localResult
/* 110 */           .type(), localResult
/* 111 */           .root(), localResult
/* 112 */           .path());
/*     */       }
/* 114 */       return new WindowsPathWithAttributes(paramWindowsFileSystem, localResult
/* 115 */         .type(), localResult
/* 116 */         .root(), localResult
...
/*     */       }
/*     */       
/* 232 */       localObject = new StringBuilder(str1.length() + this.path.length() + 1);
...
/* 265 */       throw new WindowsException("Unable to get working directory of drive '" + Character.toUpperCase(this.root.charAt(0)) + "'");
/*     */     }
...
/*     */     String str1;
/* 531 */     switch (localWindowsPath.type)
/*     */     {
/*     */     case RELATIVE: 
...
/* 857 */       int i = 0;
/* 858 */       int j = paramVarArgs.length;
/* 859 */       if (j > 0) {
/* 860 */         paramVarArgs = (WatchEvent.Modifier[])Arrays.copyOf(paramVarArgs, j);
/* 861 */         int k = 0;
/* 862 */         while (k < j) {
/* 863 */           if (paramVarArgs[(k++)] == ExtendedWatchEventModifier.FILE_TREE) {
/* 864 */             i = 1;
/*     */           }
/*     */         }
/*     */       }
