...
/*     */ 
/*     */ 
/* 136 */           j = j + (WindowsNativeDispatcher.GetLengthSid(l2) + Math.max(12, 12));
/*     */         }
/*     */         catch (WindowsException localWindowsException2)
/*     */         {
/* 140 */           throw new IOException("Failed to get SID for " + localUserPrincipal.getName() + ": " + localWindowsException2.errorString());
/*     */         }
/*     */       }
/*     */       
...
/* 159 */           throw new IOException("Failed to encode ACE: " + localWindowsException3.errorString());
/*     */         }
/* 161 */         k++;
/*     */       }
/*     */       
...
/* 264 */       .setType(localAclEntryType)
/* 265 */       .setPrincipal(localUserPrincipal)
/* 266 */       .setFlags(localEnumSet1).setPermissions(localEnumSet2).build();
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/* 348 */     for (FileAttribute<?> localFileAttribute : paramVarArgs)
/*     */     {
...
/*     */     }
/* 390 */     return (List<AclEntry>)localObject;
/*     */   }
/*     */ }
