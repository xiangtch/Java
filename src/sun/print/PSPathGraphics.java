...
/*     */ 
/*     */ 
/* 402 */       localRectangle2D.setRect(localRectangle2D.getX(), localRectangle2D.getY(), localRectangle2D
/* 403 */         .getWidth() + 0.001D, localRectangle2D
...
/*     */         
/*     */ 
/* 452 */         if (((paramInt1 + paramInt3 > localBufferedImage.getWidth(null)) || 
/* 453 */           (paramInt2 + paramInt4 > localBufferedImage.getHeight(null))) && 
/* 454 */           (canDoRedraws())) {
/* 455 */           n = 0;
/*     */         }
/* 457 */         if (n == 0)
...
/*     */           
/* 477 */           ((Rectangle2D)localObject3).setRect(((Rectangle2D)localObject3).getX(), ((Rectangle2D)localObject3).getY(), ((Rectangle2D)localObject3)
/* 478 */             .getWidth() + 0.001D, ((Rectangle2D)localObject3)
...
/*     */           }
/*     */           
/* 509 */           ((Rectangle2D)localObject3).setRect(((Rectangle2D)localObject3).getX() / d8, ((Rectangle2D)localObject3)
/* 510 */             .getY() / d8, ((Rectangle2D)localObject3)
/* 511 */             .getWidth() / d8, ((Rectangle2D)localObject3)
/* 512 */             .getHeight() / d8);
/*     */           
/*     */ 
/*     */ 
...
/*     */ 
/*     */ 
/* 539 */         Object localObject1 = new BufferedImage((int)localRectangle2D.getWidth(), (int)localRectangle2D.getHeight(), 5);
/*     */         
/*     */ 
/*     */ 
/*     */ 
...
/* 546 */         ((Graphics2D)localObject2).clipRect(0, 0, ((BufferedImage)localObject1)
/* 547 */           .getWidth(), ((BufferedImage)localObject1)
/* 548 */           .getHeight());
/*     */         
/* 550 */         ((Graphics2D)localObject2).translate(-localRectangle2D.getX(), 
/* 551 */           -localRectangle2D.getY());
...
/*     */         
/* 579 */         Object localObject3 = getTransform().createTransformedShape(localShape2);
...
/*     */ 
/*     */ 
/* 600 */         Rectangle2D.Float localFloat5 = new Rectangle2D.Float((float)(localRectangle2D.getX() * d1), (float)(localRectangle2D.getY() * d2), (float)(localRectangle2D.getWidth() * d1), (float)(localRectangle2D.getHeight() * d2));
/*     */         
/*     */ 
/*     */ 
/*     */ 
/*     */ 
/*     */ 
/* 607 */         ByteComponentRaster localByteComponentRaster = (ByteComponentRaster)((BufferedImage)localObject1).getRaster();
/*     */         
/* 609 */         localPSPrinterJob.drawImageBGR(localByteComponentRaster.getDataStorage(), localFloat5.x, localFloat5.y, 
/*     */         
/* 611 */           (float)Math.rint(localFloat5.width + 0.5D), 
/* 612 */           (float)Math.rint(localFloat5.height + 0.5D), 0.0F, 0.0F, ((BufferedImage)localObject1)
/*     */           
/* 614 */           .getWidth(), ((BufferedImage)localObject1).getHeight(), ((BufferedImage)localObject1)
/* 615 */           .getWidth(), ((BufferedImage)localObject1).getHeight());
/*     */         
/*     */ 
/* 618 */         localPSPrinterJob.setClip(
/* 619 */           getTransform().createTransformedShape(localShape2));
/*     */         
/*     */ 
...
/*     */ 
/*     */ 
/* 652 */     BufferedImage localBufferedImage = new BufferedImage((int)paramRectangle2D.getWidth(), (int)paramRectangle2D.getHeight(), 5);
/*     */     
/*     */ 
/*     */ 
/*     */ 
...
/*     */     
/* 680 */     localProxyGraphics2D.translate(
/* 681 */       -localPSPrinterJob.getPhysicalPrintableX(localPageFormat.getPaper()) / localPSPrinterJob
/* 682 */       .getXRes() * 72.0D, 
/* 683 */       -localPSPrinterJob.getPhysicalPrintableY(localPageFormat.getPaper()) / localPSPrinterJob
/* 684 */       .getYRes() * 72.0D);
/*     */     
...
/*     */ 
/*     */ 
/* 712 */     Rectangle2D.Float localFloat = new Rectangle2D.Float((float)(paramRectangle2D.getX() * paramDouble1), (float)(paramRectangle2D.getY() * paramDouble2), (float)(paramRectangle2D.getWidth() * paramDouble1), (float)(paramRectangle2D.getHeight() * paramDouble2));
/*     */     
/*     */ 
/*     */ 
/*     */ 
...
/*     */     
/* 720 */     localPSPrinterJob.drawImageBGR(localByteComponentRaster.getDataStorage(), localFloat.x, localFloat.y, localFloat.width, localFloat.height, 0.0F, 0.0F, localBufferedImage
/*     */     
/*     */ 
/*     */ 
/*     */ 
/* 725 */       .getWidth(), localBufferedImage.getHeight(), localBufferedImage
/* 726 */       .getWidth(), localBufferedImage.getHeight());
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/* Location:              E:\java_source\rt.jar!\sun\print\PSPathGraphics.class
