...
/* 210 */     String str; if (paramClass == Media.class) {
/* 211 */       str = Locale.getDefault().getCountry();
/* 212 */       if ((str != null) && (
/* 213 */         (str.equals("")) || 
/* 214 */         (str.equals(Locale.US.getCountry())) || 
/* 215 */         (str.equals(Locale.CANADA.getCountry())))) {
...
/*     */       
/* 223 */       float f3 = 0.5F;
/* 224 */       float f1; float f2; if ((str != null) && (
/* 225 */         (str.equals("")) || 
/* 226 */         (str.equals(Locale.US.getCountry())) || 
/* 227 */         (str.equals(Locale.CANADA.getCountry())))) {
/* 228 */         f1 = NA.LETTER.getX(25400) - 2.0F * f3;
/* 229 */         f2 = NA.LETTER.getY(25400) - 2.0F * f3;
/*     */       } else {
/* 231 */         f1 = ISO.A4.getX(25400) - 2.0F * f3;
/* 232 */         f2 = ISO.A4.getY(25400) - 2.0F * f3;
/*     */       }
...
/* 239 */       return new PageRanges(1, Integer.MAX_VALUE);
...
/* 282 */       if ((paramDocFlavor == null) || 
/* 283 */         (paramDocFlavor.equals(SERVICE_FORMATTED.PAGEABLE)) ||
/* 284 */         (paramDocFlavor.equals(SERVICE_FORMATTED.PRINTABLE))) {
...
/* 341 */       if ((paramDocFlavor == null) || 
/* 342 */         (paramDocFlavor.equals(SERVICE_FORMATTED.PAGEABLE)) ||
/* 343 */         (paramDocFlavor.equals(SERVICE_FORMATTED.PRINTABLE))) {
/* 344 */         localObject1 = new PageRanges[1];
/* 345 */         localObject1[0] = new PageRanges(1, Integer.MAX_VALUE);
/* 346 */         return localObject1;
/*     */       }
/* 348 */       return null;
/*     */     }
/* 350 */     if (paramClass == SheetCollate.class) {
/* 351 */       if ((paramDocFlavor == null) || 
/* 352 */         (paramDocFlavor.equals(SERVICE_FORMATTED.PAGEABLE)) ||
/* 353 */         (paramDocFlavor.equals(SERVICE_FORMATTED.PRINTABLE))) {
...
/* 364 */       if ((paramDocFlavor == null) || 
/* 365 */         (paramDocFlavor.equals(SERVICE_FORMATTED.PAGEABLE)) ||
/* 366 */         (paramDocFlavor.equals(SERVICE_FORMATTED.PRINTABLE))) {
...
/* 417 */       if (paramAttribute != OrientationRequested.REVERSE_PORTRAIT) { if (paramDocFlavor != null)
/*     */         {
/* 419 */           if ((paramDocFlavor.equals(SERVICE_FORMATTED.PAGEABLE)) ||
/* 420 */             (paramDocFlavor.equals(SERVICE_FORMATTED.PRINTABLE))) {} }
/* 421 */       } else return false;
/*     */     }
/* 423 */     else if (paramAttribute.getCategory() == PageRanges.class) {
/* 424 */       if ((paramDocFlavor != null) && 
/* 425 */         (!paramDocFlavor.equals(SERVICE_FORMATTED.PAGEABLE)) &&
/* 426 */         (!paramDocFlavor.equals(SERVICE_FORMATTED.PRINTABLE))) {
/* 427 */         return false;
/*     */       }
/* 429 */     } else if (paramAttribute.getCategory() == SheetCollate.class) {
/* 430 */       if ((paramDocFlavor != null) && 
/* 431 */         (!paramDocFlavor.equals(SERVICE_FORMATTED.PAGEABLE)) &&
/* 432 */         (!paramDocFlavor.equals(SERVICE_FORMATTED.PRINTABLE))) {
/* 433 */         return false;
/*     */       }
/* 435 */     } else if ((paramAttribute.getCategory() == Sides.class) && 
/* 436 */       (paramDocFlavor != null) && 
/* 437 */       (!paramDocFlavor.equals(SERVICE_FORMATTED.PAGEABLE)) &&
/* 438 */       (!paramDocFlavor.equals(SERVICE_FORMATTED.PRINTABLE))) {
/* 439 */       return false;
/*     */     }
/*     */     
/* 442 */     return true;
...
/*     */   {
/* 491 */     if (paramObject != this) if (!(paramObject instanceof PSStreamPrintService)) break label33; label33: return ((PSStreamPrintService)paramObject)
/*     */     
...
/* Location:              E:\java_source\rt.jar!\sun\print\PSStreamPrintService.class
