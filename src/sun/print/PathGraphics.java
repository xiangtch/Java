...
/*      */     }
/*      */     
/*  578 */     TextLayout localTextLayout = new TextLayout(paramString, getFont(), getFontRenderContext());
...
/*      */     
/*      */ 
/*  587 */     Shape localShape = localTextLayout.getOutline(AffineTransform.getTranslateInstance(paramFloat1, paramFloat2));
/*  588 */     fill(localShape);
/*      */   }
/*      */   
/*      */ 
...
/*      */     
/*      */ 
/*  614 */     TextLayout localTextLayout = new TextLayout(paramAttributedCharacterIterator, getFontRenderContext());
...
/*  730 */         arrayOfChar = (char[][])localHashtable.get(localFont2D.handle);
/*  731 */         if (arrayOfChar == null) {
/*  732 */           arrayOfChar = new char[k][];
/*  733 */           localHashtable.put(localFont2D.handle, arrayOfChar);
/*      */         }
/*  735 */         for (m = 0; m < j; m++) {
...
/*  742 */             char[] arrayOfChar3 = (char[])localHashtable.get(localPhysicalFont.handle);
/*  743 */             if (arrayOfChar3 == null) {
/*  744 */               arrayOfChar3 = getGlyphToCharMapForFont(localPhysicalFont);
/*      */             }
...
/*  760 */       for (k = 0; k < j; k++) {
/*  761 */         m = arrayOfInt1[k];
/*  762 */         char[] arrayOfChar2 = arrayOfChar[(m >>> 24)];
/*  763 */         m &= 0xFFFFFF;
/*  764 */         if (arrayOfChar2 == null) {
/*  765 */           return false;
/*      */         }
/*      */         
/*      */ 
...
/*  783 */         if (m == 65535) {
/*  784 */           i2 = 10;
/*  785 */         } else { if ((m < 0) || (m >= arrayOfChar2.length)) {
/*  786 */             return false;
/*      */           }
/*  788 */           i2 = arrayOfChar2[m];
/*      */         }
/*  790 */         if (i2 != 65535) {
/*  791 */           ???[k] = i2;
/*      */         } else {
...
/*      */ 
/*  835 */     if ((!bool) && 
/*  836 */       (localFontRenderContext1.usesFractionalMetrics() == localFontRenderContext2.usesFractionalMetrics())) {
/*  837 */       localObject3 = localFontRenderContext1.getTransform();
/*  838 */       AffineTransform localAffineTransform = getTransform();
/*  839 */       localObject4 = new double[4];
/*  840 */       double[] arrayOfDouble = new double[4];
/*  841 */       ((AffineTransform)localObject3).getMatrix((double[])localObject4);
/*  842 */       localAffineTransform.getMatrix(arrayOfDouble);
/*  843 */       bool = true;
/*  844 */       for (int i5 = 0; i5 < 4; i5++) {
/*  845 */         if (localObject4[i5] != arrayOfDouble[i5]) {
/*  846 */           bool = false;
/*  847 */           break;
/*      */         }
/*      */       }
/*      */     }
/*      */     
/*  852 */     Object localObject3 = new String((char[])???, 0, j);
/*  853 */     int i3 = platformFontCount(localFont, (String)localObject3);
/*  854 */     if (i3 == 0) {
/*  855 */       return false;
/*      */     }
/*      */     
/*  858 */     Object localObject4 = paramGlyphVector.getGlyphPositions(0, j, null);
/*      */     
/*      */ 
/*  861 */     int i4 = ((i & 0x2) == 0) || (samePositions(localGlyphVector, arrayOfInt2, arrayOfInt1, (float[])localObject4)) ? 1 : 0;
/*      */     
/*      */ 
/*      */ 
/*      */ 
...
/*  881 */     int i6 = 0;
/*  882 */     Object localObject5; if ((localFont.hasLayoutAttributes()) && (this.printingGlyphVector) && (i4 != 0))
/*      */     {
/*      */ 
/*      */ 
/*      */ 
...
/*  899 */       localObject5 = localMap.get(TextAttribute.TRACKING);
/*      */       
/*  901 */       int i8 = (localObject5 != null) && ((localObject5 instanceof Number)) && (((Number)localObject5).floatValue() != 0.0F) ? 1 : 0;
/*      */       
/*  903 */       if (i8 != 0) {
/*  904 */         i4 = 0;
/*      */       } else {
/*  906 */         Rectangle2D localRectangle2D = localFont.getStringBounds((String)localObject3, localFontRenderContext1);
/*  907 */         float f2 = (float)localRectangle2D.getWidth();
/*  908 */         if (Math.abs(f2 - f1) > 1.0E-5D) {
/*  909 */           i6 = 1;
/*      */         }
/*      */       }
/*      */     }
...
/*  915 */       drawString((String)localObject3, paramFloat1, paramFloat2, localFont, localFontRenderContext1, 0.0F);
/*  916 */       return true;
/*      */     }
/*      */     
/*      */ 
...
/*  929 */       drawString((String)localObject3, paramFloat1, paramFloat2, localFont, localFontRenderContext1, f1);
/*  930 */       return true;
/*      */     }
/*      */     
/*      */ 
...
/*  958 */       localObject5 = new String((char[])???, i7, 1);
/*  959 */       drawString((String)localObject5, paramFloat1 + localObject4[(i7 * 2)], paramFloat2 + localObject4[(i7 * 2 + 1)], localFont, localFontRenderContext1, 0.0F);
/*      */     }
/*      */     
/*  962 */     return true;
/*      */   }
...
/*      */     
/*      */ 
/* 1164 */     boolean bool = localColorModel == null;
/*      */     
/*      */ 
/*      */ 
/*      */ 
...
/* 1175 */       (paramBufferedImage.getType() == 2) || 
/* 1176 */       (paramBufferedImage.getType() == 3))) {
...
/*      */ 
/*      */ 
/* 1185 */         int[] arrayOfInt = SunWritableRaster.stealData((DataBufferInt)localDataBuffer, 0);
...
/* 1216 */     return (localColorModel != null) && 
/* 1217 */       (localColorModel.getTransparency() == 2);
/*      */   }
/*      */   
/*      */ 
/*      */ 
...
/* 1290 */       i1 = paramInt3; }
/*      */     int n;
/* 1292 */     int i2; if (paramInt2 + paramInt4 > k) {
/* 1293 */       n = k;
/* 1294 */       i2 = n - paramInt2;
/*      */     } else {
...
/* Location:              E:\java_source\rt.jar!\sun\print\PathGraphics.class
