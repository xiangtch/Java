...
/*      */     }
/*      */     
/*  322 */     if ((paramFrame == null) && ((paramJobAttributes == null) || 
/*      */     
/*  324 */       (paramJobAttributes.getDialog() == DialogType.NATIVE))) {
...
/*      */ 
/*      */ 
/*  354 */     DestinationType localDestinationType = this.jobAttributes.getDestination();
/*  355 */     if (localDestinationType == DestinationType.FILE) {
/*  356 */       throwPrintToFile();
/*      */       
/*      */ 
/*  359 */       String str = paramJobAttributes.getFileName();
/*  360 */       if ((str != null) && 
/*  361 */         (paramJobAttributes.getDialog() == DialogType.NONE))
/*      */       {
...
/*  381 */         if ((!localFile1.exists()) || (
/*  382 */           (localFile1.isFile()) && (localFile1.canWrite()))) { if (localFile2 != null)
/*      */           {
/*  384 */             if ((localFile2.exists()) && ((!localFile2.exists()) || (localFile2.canWrite()))) {} }
/*  385 */         } else { throw new IllegalArgumentException("Cannot write to file:" + str);
/*      */         }
/*      */       }
/*      */     }
/*      */   }
...
/*  398 */       return false;
/*      */     }
/*  400 */     DialogType localDialogType = this.jobAttributes.getDialog();
/*  401 */     PrintService localPrintService = this.printerJob.getPrintService();
/*  402 */     if ((localPrintService == null) && (localDialogType == DialogType.NONE)) {
/*  403 */       return false;
/*      */     }
/*  405 */     copyAttributes(localPrintService);
/*      */     
/*      */ 
/*  408 */     DefaultSelectionType localDefaultSelectionType = this.jobAttributes.getDefaultSelection();
/*  409 */     if (localDefaultSelectionType == DefaultSelectionType.RANGE) {
/*  410 */       this.attributes.add(SunPageSelection.RANGE);
/*  411 */     } else if (localDefaultSelectionType == DefaultSelectionType.SELECTION) {
...
/*      */     }
/*      */     
/*  421 */     if (localDialogType == DialogType.NONE) {
/*  422 */       bool = true;
/*      */     } else {
/*  424 */       if (localDialogType == DialogType.NATIVE) {
...
/*  461 */         localPaper.setSize(localMediaSize.getX(25400) * 72.0D, localMediaSize
/*  462 */           .getY(25400) * 72.0D);
/*      */       }
/*      */       
/*  465 */       if (this.pageAttributes.getOrigin() == OriginType.PRINTABLE)
/*      */       {
/*  467 */         localPaper.setImageableArea(18.0D, 18.0D, localPaper
/*  468 */           .getWidth() - 36.0D, localPaper
/*  469 */           .getHeight() - 36.0D);
/*      */       } else {
...
/*      */       
/*      */ 
/*  477 */       OrientationRequested localOrientationRequested = (OrientationRequested)this.attributes.get(OrientationRequested.class);
...
/*      */     
/*      */ 
/*  499 */     SunPageSelection localSunPageSelection = (SunPageSelection)this.attributes.get(SunPageSelection.class);
/*  500 */     if (localSunPageSelection == SunPageSelection.RANGE) {
/*  501 */       this.jobAttributes.setDefaultSelection(DefaultSelectionType.RANGE);
/*  502 */     } else if (localSunPageSelection == SunPageSelection.SELECTION) {
/*  503 */       this.jobAttributes.setDefaultSelection(DefaultSelectionType.SELECTION);
/*      */     } else {
/*  505 */       this.jobAttributes.setDefaultSelection(DefaultSelectionType.ALL);
/*      */     }
/*      */     
/*  508 */     Destination localDestination = (Destination)this.attributes.get(Destination.class);
/*  509 */     if (localDestination != null) {
/*  510 */       this.jobAttributes.setDestination(DestinationType.FILE);
/*  511 */       this.jobAttributes.setFileName(localDestination.getURI().getPath());
/*      */     } else {
/*  513 */       this.jobAttributes.setDestination(DestinationType.PRINTER);
/*      */     }
/*      */     
...
/*      */     
/*      */ 
/*  526 */     SheetCollate localSheetCollate = (SheetCollate)this.attributes.get(SheetCollate.class);
/*  527 */     if (localSheetCollate == SheetCollate.COLLATED) {
/*  528 */       this.jobAttributes.setMultipleDocumentHandling(MultipleDocumentHandlingType.SEPARATE_DOCUMENTS_COLLATED_COPIES);
/*      */     }
/*      */     else {
/*  531 */       this.jobAttributes.setMultipleDocumentHandling(MultipleDocumentHandlingType.SEPARATE_DOCUMENTS_UNCOLLATED_COPIES);
/*      */     }
/*      */     
/*      */ 
/*  535 */     Sides localSides = (Sides)this.attributes.get(Sides.class);
/*  536 */     if (localSides == Sides.TWO_SIDED_LONG_EDGE) {
/*  537 */       this.jobAttributes.setSides(SidesType.TWO_SIDED_LONG_EDGE);
/*  538 */     } else if (localSides == Sides.TWO_SIDED_SHORT_EDGE) {
/*  539 */       this.jobAttributes.setSides(SidesType.TWO_SIDED_SHORT_EDGE);
/*      */     } else {
/*  541 */       this.jobAttributes.setSides(SidesType.ONE_SIDED);
/*      */     }
/*      */     
/*      */ 
/*      */ 
/*      */ 
/*  547 */     Chromaticity localChromaticity = (Chromaticity)this.attributes.get(Chromaticity.class);
/*  548 */     if (localChromaticity == Chromaticity.COLOR) {
/*  549 */       this.pageAttributes.setColor(ColorType.COLOR);
/*      */     } else {
/*  551 */       this.pageAttributes.setColor(ColorType.MONOCHROME);
/*      */     }
/*      */     
/*      */ 
/*  555 */     OrientationRequested localOrientationRequested = (OrientationRequested)this.attributes.get(OrientationRequested.class);
/*  556 */     if (localOrientationRequested == OrientationRequested.LANDSCAPE) {
/*  557 */       this.pageAttributes.setOrientationRequested(OrientationRequestedType.LANDSCAPE);
/*      */     }
/*      */     else {
/*  560 */       this.pageAttributes.setOrientationRequested(OrientationRequestedType.PORTRAIT);
/*      */     }
/*      */     
/*      */ 
...
/*  566 */       this.pageAttributes.setPrintQuality(PrintQualityType.DRAFT);
/*  567 */     } else if (localPrintQuality == PrintQuality.HIGH) {
/*  568 */       this.pageAttributes.setPrintQuality(PrintQualityType.HIGH);
/*      */     } else {
/*  570 */       this.pageAttributes.setPrintQuality(PrintQualityType.NORMAL);
/*      */     }
/*      */     
/*  573 */     Media localMedia = (Media)this.attributes.get(Media.class);
/*  574 */     if ((localMedia != null) && ((localMedia instanceof MediaSizeName))) {
/*  575 */       MediaType localMediaType = unMapMedia((MediaSizeName)localMedia);
/*      */       
...
/*  632 */     if ((str != null) && (str != "") && 
/*  633 */       (!str.equals(localPrintService.getName())))
/*      */     {
/*      */ 
...
/*  650 */     if ((localObject1 == DestinationType.FILE) &&
/*  651 */       (localPrintService.isAttributeCategorySupported(Destination.class)))
/*      */     {
/*  653 */       localObject2 = this.jobAttributes.getFileName();
/*      */       
/*      */ 
/*  656 */       if ((localObject2 == null) && 
/*  657 */         ((localObject3 = (Destination)localPrintService.getDefaultAttributeValue(Destination.class)) != null)) {
...
/*  692 */     if (localObject2 == SidesType.TWO_SIDED_LONG_EDGE) {
/*  693 */       this.attributes.add(Sides.TWO_SIDED_LONG_EDGE);
/*  694 */     } else if (localObject2 == SidesType.TWO_SIDED_SHORT_EDGE) {
/*  695 */       this.attributes.add(Sides.TWO_SIDED_SHORT_EDGE);
/*  696 */     } else if (localObject2 == SidesType.ONE_SIDED) {
/*  697 */       this.attributes.add(Sides.ONE_SIDED);
/*      */     }
/*      */     
/*      */ 
/*  701 */     Object localObject3 = this.jobAttributes.getMultipleDocumentHandling();
/*  702 */     if (localObject3 == MultipleDocumentHandlingType.SEPARATE_DOCUMENTS_COLLATED_COPIES)
/*      */     {
...
/*  712 */       .getToPage()));
/*      */     
/*  714 */     if (this.pageAttributes.getColor() == ColorType.COLOR) {
...
/*  721 */     if (this.pageAttributes.getOrientationRequested() == OrientationRequestedType.LANDSCAPE)
/*      */     {
...
/*  731 */     MediaSizeName localMediaSizeName = mapMedia((MediaType)localObject4);
/*  732 */     if (localMediaSizeName != null) {
/*  733 */       this.attributes.add(localMediaSizeName);
/*      */     }
/*      */     
/*      */ 
/*  737 */     PrintQualityType localPrintQualityType = this.pageAttributes.getPrintQuality();
/*  738 */     if (localPrintQualityType == PrintQualityType.DRAFT) {
/*  739 */       this.attributes.add(PrintQuality.DRAFT);
/*  740 */     } else if (localPrintQualityType == PrintQualityType.NORMAL) {
/*  741 */       this.attributes.add(PrintQuality.NORMAL);
/*  742 */     } else if (localPrintQualityType == PrintQualityType.HIGH) {
...
/*      */     double d2;
/*      */     
/*  844 */     if ((this.pageAttributes != null) && 
/*  845 */       (this.pageAttributes.getOrigin() == OriginType.PRINTABLE)) {
...
/*      */   
/*      */ 
/*      */   private static int[] getSize(MediaType paramMediaType)
/*      */   {
...
/*      */   }
/*      */   
/*      */   public static MediaSizeName mapMedia(MediaType paramMediaType) {
...
/* 1104 */         if ((JAVAXSIZES[j] != null) && 
/* 1105 */           (MediaSize.getMediaSizeForName(JAVAXSIZES[j]) != null)) {
...
/*      */ 
/*      */ 
/* 1124 */     return (MediaSizeName)localObject;
/*      */   }
/*      */   
/*      */   public static MediaType unMapMedia(MediaSizeName paramMediaSizeName)
/*      */   {
/* 1129 */     MediaType localMediaType = null;
/*      */     
/*      */ 
/*      */ 
...
/* 1156 */         this.jobAttributes.setDestination(DestinationType.PRINTER);
/* 1157 */       } else if (str.equals("file")) {
/* 1158 */         this.jobAttributes.setDestination(DestinationType.FILE);
/*      */       }
/*      */     }
...
/* 1179 */         this.pageAttributes.setOrientationRequested(OrientationRequestedType.PORTRAIT);
/*      */       }
/* 1181 */       else if (str.equals("landscape")) {
/* 1182 */         this.pageAttributes.setOrientationRequested(OrientationRequestedType.LANDSCAPE);
/*      */       }
/*      */     }
/*      */     
...
/* 1189 */         this.pageAttributes.setMedia(SIZES[MediaType.LETTER.hashCode()]);
/* 1190 */       } else if (str.equals("legal")) {
/* 1191 */         this.pageAttributes.setMedia(SIZES[MediaType.LEGAL.hashCode()]);
/* 1192 */       } else if (str.equals("executive")) {
/* 1193 */         this.pageAttributes.setMedia(SIZES[MediaType.EXECUTIVE.hashCode()]);
/* 1194 */       } else if (str.equals("a4")) {
/* 1195 */         this.pageAttributes.setMedia(SIZES[MediaType.A4.hashCode()]);
/*      */       }
/*      */     }
/*      */   }
/*      */   
...
/*      */ 
/*      */ 
/* 1207 */     this.props.setProperty("awt.print.destination", this.jobAttributes
/* 1208 */       .getDestination() == DestinationType.PRINTER ? "printer" : "file");
/*      */     
...
/*      */     }
/* 1226 */     this.props.setProperty("awt.print.orientation", this.pageAttributes
/* 1227 */       .getOrientationRequested() == OrientationRequestedType.PORTRAIT ? "portrait" : "landscape");
/*      */     
/*      */ 
/* 1230 */     MediaType localMediaType = SIZES[this.pageAttributes.getMedia().hashCode()];
/* 1231 */     if (localMediaType == MediaType.LETTER) {
/* 1232 */       str = "letter";
/* 1233 */     } else if (localMediaType == MediaType.LEGAL) {
/* 1234 */       str = "legal";
/* 1235 */     } else if (localMediaType == MediaType.EXECUTIVE) {
/* 1236 */       str = "executive";
/* 1237 */     } else if (localMediaType == MediaType.A4) {
/* 1238 */       str = "a4";
/*      */     } else {
...
/* Location:              E:\java_source\rt.jar!\sun\print\PrintJob2D.class
