...
/* 122 */           if (this.listeners != null) { PrintServiceAttributeSet localPrintServiceAttributeSet;
/* 123 */             if ((this.service instanceof AttributeUpdater))
/*     */             {
/* 125 */               localPrintServiceAttributeSet = ((AttributeUpdater)this.service).getUpdatedAttributes();
/*     */             } else {
...
/*     */               {
/* 132 */                 PrintServiceAttributeListener localPrintServiceAttributeListener = (PrintServiceAttributeListener)this.listeners.elementAt(i);
...
/* Location:              E:\java_source\rt.jar!\sun\print\ServiceNotifier.class
