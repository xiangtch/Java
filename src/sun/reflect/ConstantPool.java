...
/*    */   
/* 36 */   public int getSize() { return getSize0(this.constantPoolOop); }
...
/* 60 */   private native Field getFieldAtIfLoaded0(Object paramObject, int paramInt); private native String[] getMemberRefInfoAt0(Object paramObject, int paramInt); private native int getIntAt0(Object paramObject, int paramInt); private native long getLongAt0(Object paramObject, int paramInt); private native float getFloatAt0(Object paramObject, int paramInt); private native double getDoubleAt0(Object paramObject, int paramInt); private native String getStringAt0(Object paramObject, int paramInt); private native String getUTF8At0(Object paramObject, int paramInt); static { Reflection.registerFieldsToFilter(ConstantPool.class, new String[] { "constantPoolOop" }); }
/*    */ }


/* Location:              E:\java_source\rt.jar!\sun\reflect\ConstantPool.class
