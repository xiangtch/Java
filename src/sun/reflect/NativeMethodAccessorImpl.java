...
/*    */     {
/*    */ 
/* 53 */       MethodAccessorImpl localMethodAccessorImpl = (MethodAccessorImpl)new MethodAccessorGenerator().generateMethod(this.method.getDeclaringClass(), this.method
/* 54 */         .getName(), this.method
/* 55 */         .getParameterTypes(), this.method
/* 56 */         .getReturnType(), this.method
/* 57 */         .getExceptionTypes(), this.method
/* 58 */         .getModifiers());
/* 59 */       this.parent.setDelegate(localMethodAccessorImpl);
/*    */     }
/*    */     
...
/* Location:              E:\java_source\rt.jar!\sun\reflect\NativeMethodAccessorImpl.class
