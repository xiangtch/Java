...
/*     */ 
/*     */ 
/* 231 */       final Class localClass = RMIClassLoader.loadClass(paramActivationDesc.getLocation(), (String)localObject2).asSubclass(Remote.class);
...
/*     */           {
/*     */ 
/* 258 */             Constructor localConstructor = localClass.getDeclaredConstructor(new Class[] { ActivationID.class, MarshalledObject.class });
/*     */             
...
/* 269 */               return (Remote)localConstructor.newInstance(new Object[] { paramActivationID, paramActivationDesc
/* 270 */                 .getData() });
/*     */             } finally {
...
/*     */     {
/*     */ 
/* 310 */       throw new ActivationException("exception in object constructor", localInvocationTargetException.getTargetException());
/*     */     }
...
/* Location:              E:\java_source\rt.jar!\sun\rmi\server\ActivationGroupImpl.class
