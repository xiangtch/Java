...
/*     */ {
/*  68 */   private static final long dgcAckTimeout = ((Long)AccessController.doPrivileged(new GetLongAction("sun.rmi.dgc.ackTimeout", 300000L))).longValue();
/*     */   
/*     */ 
/*     */ 
/*     */ 
/*  73 */   private static final ScheduledExecutorService scheduler = ((RuntimeUtil)AccessController.doPrivileged(new GetInstanceAction()))
/*  74 */     .getScheduler();
/*     */   
/*     */ 
/*     */ 
...
/*     */           }
/* 124 */           DGCAckHandler.this.release(); } }, dgcAckTimeout, TimeUnit.MILLISECONDS);
/*     */     }
/*     */   }
/*     */   
/*     */ 
...
/*     */   {
/* 146 */     DGCAckHandler localDGCAckHandler = (DGCAckHandler)idTable.remove(paramUID);
/* 147 */     if (localDGCAckHandler != null) {
/* 148 */       localDGCAckHandler.release();
/*     */     }
/*     */   }
/*     */ }


/* Location:              E:\java_source\rt.jar!\sun\rmi\transport\DGCAckHandler.class
