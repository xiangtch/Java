...
/* 114 */       throw new InternalError(localCloneNotSupportedException.toString(), localCloneNotSupportedException);
/*     */     }
/*     */   }
/*     */   
/*     */ 
...
/*     */       
/*     */ 
/* 199 */       RMIClientSocketFactory localRMIClientSocketFactory1 = localTCPEndpoint1.getClientSocketFactory();
/*     */       
/* 201 */       RMIClientSocketFactory localRMIClientSocketFactory2 = localTCPEndpoint2.getClientSocketFactory();
/*     */       
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */ 
/* 211 */       if ((localTCPEndpoint1.getPort() != localTCPEndpoint2.getPort()) || 
/* 212 */         (!localTCPEndpoint1.getHost().equals(localTCPEndpoint2.getHost())))
/*     */       {
/* 214 */         return false;
/*     */       }
...
/* 217 */         return false;
/*     */       }
/* 219 */       if (localRMIClientSocketFactory1 != null)
/*     */       {
/* 221 */         if ((localRMIClientSocketFactory1.getClass() != localRMIClientSocketFactory2.getClass()) || 
/* 222 */           (!localRMIClientSocketFactory1.equals(localRMIClientSocketFactory2)))
/*     */         {
/* 224 */           return false; }
/*     */       }
...
/* 256 */       if (this.isLocal)
/*     */       {
/* 258 */         ObjectEndpoint localObjectEndpoint = new ObjectEndpoint(this.id, this.ep.getInboundTransport());
...
/* Location:              E:\java_source\rt.jar!\sun\rmi\transport\LiveRef.class
