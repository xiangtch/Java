...
/*     */ 
/* 116 */     });
/* 117 */     commands = new CGICommandHandler[] { new CGIForwardCommand(), new CGIGethostnameCommand(), new CGIPingCommand(), new CGITryHostnameCommand() };
/*     */     
/*     */ 
/*     */ 
/*     */ 
...
/* 145 */       String str1; String str2; if (i == -1) {
...
/*     */       }
/*     */       
/* 154 */       CGICommandHandler localCGICommandHandler = (CGICommandHandler)commandLookup.get(str1);
/* 155 */       if (localCGICommandHandler != null) {
/*     */         try {
/* 157 */           localCGICommandHandler.execute(str2);
/*     */         } catch (CGIClientException localCGIClientException) {
/* 159 */           localCGIClientException.printStackTrace();
/* 160 */           returnClientError(localCGIClientException.getMessage());
/*     */         } catch (CGIServerException localCGIServerException) {
/* 162 */           localCGIServerException.printStackTrace();
/* 163 */           returnServerError(localCGIServerException.getMessage());
/*     */         }
/*     */       } else
/* 166 */         returnClientError("invalid command.");
/*     */     } catch (Exception localException) {
/* 168 */       localException.printStackTrace();
/* 169 */       returnServerError("internal error: " + localException.getMessage());
/*     */     }
/* 171 */     System.exit(0);
/*     */   }
/*     */   
...
/* Location:              E:\java_source\rt.jar!\sun\rmi\transport\proxy\CGIHandler.class
