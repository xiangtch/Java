...
/*     */     
/*  82 */     BufferedInputStream localBufferedInputStream = new BufferedInputStream(localSocket.getInputStream());
/*     */     
...
/*     */ 
/*     */ 
/*  91 */     int i = (localBufferedInputStream.read() == 80) && (localBufferedInputStream.read() == 79) && (localBufferedInputStream.read() == 83) && (localBufferedInputStream.read() == 84) ? 1 : 0;
...
/* Location:              E:\java_source\rt.jar!\sun\rmi\transport\proxy\HttpAwareServerSocket.class
