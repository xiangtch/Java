...
/*     */     
/*     */ 
/*  57 */     DataInputStream localDataInputStream = new DataInputStream(paramInputStream);
/*  58 */     String str1 = "Content-length:".toLowerCase();
/*  59 */     int i = 0;
/*     */     String str2;
/*     */     do {
/*  62 */       str2 = localDataInputStream.readLine();
/*     */       
...
/*     */         
/*     */ 
/*  78 */         this.bytesLeft = Integer.parseInt(str2.substring(str1.length()).trim());
/*  79 */         i = 1;
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */     }
/*  88 */     while ((str2.length() != 0) && 
/*  89 */       (str2.charAt(0) != '\r') && (str2.charAt(0) != '\n'));
/*     */     
...
/* Location:              E:\java_source\rt.jar!\sun\rmi\transport\proxy\HttpInputStream.class
