...
/* 108 */   static { localHost = getHostnameProperty();
/*     */     
/*     */ 
...
/*     */   {
/* 402 */     for (TCPTransport localTCPTransport : ) {
...
/*     */ 
/*     */ 
/* 501 */       if ((this.csf != null) && (
/* 502 */         (this.csf.getClass() != localTCPEndpoint.csf.getClass()) || (!this.csf.equals(localTCPEndpoint.csf))))
/* 503 */         return false;
/* 504 */       if ((this.ssf != null) && (
/* 505 */         (this.ssf.getClass() != localTCPEndpoint.ssf.getClass()) || (!this.ssf.equals(localTCPEndpoint.ssf))))
/* 506 */         return false;
/* 507 */       return true;
/*     */     }
/* 509 */     return false;
...
/*     */         
/* 741 */         if ((localObject1 == null) || (((String)localObject1).equals("")) || 
/* 742 */           (((String)localObject1).indexOf('.') < 0))
/*     */         {
/* 744 */           localObject1 = str;
/*     */         }
/*     */       }
/* 747 */       return (String)localObject1;
/*     */     }
/*     */     
/*     */ 
/*     */ 
...
/* Location:              E:\java_source\rt.jar!\sun\rmi\transport\tcp\TCPEndpoint.class
