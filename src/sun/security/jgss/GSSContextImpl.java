...
/* 202 */             if ((GSSUtil.isSpNegoMech(this.mechOid)) && 
/* 203 */               (localGSSException.getMajor() == 13))
/*     */             {
/* 205 */               localGSSCredentialSpi = this.myCred.getElement(this.myCred.getMechs()[0], true);
/*     */             } else {
...
/*     */ 
/*     */ 
/* 242 */           throw new GSSExceptionImpl(10, "Mechanism not equal to " + this.mechOid.toString() + " in initSecContext token");
/*     */         }
...
/* 254 */         if ((!this.mechCtxt.getProvider().getName().equals("SunNativeGSS")) && ((j != 0) || 
...
/*     */     {
/* 273 */       throw new GSSExceptionImpl(10, localIOException.getMessage());
/*     */     }
/*     */   }
/*     */   
/*     */ 
...
/*     */ 
/*     */ 
/* 336 */           throw new GSSExceptionImpl(10, "Mechanism not equal to " + this.mechOid.toString() + " in acceptSecContext token");
/*     */         }
...
/*     */     }
/*     */     catch (IOException localIOException) {
/* 362 */       throw new GSSExceptionImpl(10, localIOException.getMessage());
/*     */     }
/*     */   }
/*     */   
...
/*     */     
/*     */ 
/* 461 */     if ((this.mechCtxt.isTransferable()) && 
/* 462 */       (this.mechCtxt.getProvider().getName().equals("SunNativeGSS"))) {
...
/*     */     {
/* 589 */       this.srcName = GSSNameImpl.wrapElement(this.gssManager, this.mechCtxt.getSrcName());
/*     */     }
...
/*     */     {
/* 597 */       this.targName = GSSNameImpl.wrapElement(this.gssManager, this.mechCtxt.getTargName());
/*     */     }
...
/* Location:              E:\java_source\rt.jar!\sun\security\jgss\GSSContextImpl.class
