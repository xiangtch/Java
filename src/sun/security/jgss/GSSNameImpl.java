...
/*     */     
/* 104 */     oldHostbasedServiceName = localOid;
/*     */   }
/*     */   
...
/*     */     
/* 181 */     this.elements = new HashMap(paramGSSManagerImpl.getMechs().length);
/*     */     
...
/*     */ 
/*     */ 
/* 331 */         arrayOfByte2 = localGSSNameImpl.appNameStr != null ? localGSSNameImpl.appNameStr.getBytes("UTF-8") : localGSSNameImpl.appNameBytes;
/*     */       }
/*     */       catch (UnsupportedEncodingException localUnsupportedEncodingException) {}
/*     */       
/*     */ 
...
/*     */     try
/*     */     {
/* 415 */       localObjectIdentifier = new ObjectIdentifier(this.mechElement.getMechanism().toString());
...
/*     */     {
/* 426 */       throw new GSSExceptionImpl(11, "Could not ASN.1 Encode " + localObjectIdentifier.toString());
/*     */     }
...
/*     */       {
/* 477 */         localGSSNameSpi = this.gssManager.getNameElement(this.appNameStr, this.appNameType, paramOid);
/*     */       }
/*     */       else {
/* 480 */         localGSSNameSpi = this.gssManager.getNameElement(this.appNameBytes, this.appNameType, paramOid);
/*     */       }
...
/* Location:              E:\java_source\rt.jar!\sun\security\jgss\GSSNameImpl.class
