...
/*     */     
/* 110 */     String str = (String)AccessController.doPrivileged(new GetPropertyAction("sun.security.jgss.mechanism"));
/* 111 */     if (str != null) {
/* 112 */       localOid = GSSUtil.createOid(str);
/*     */     }
/* 114 */     DEFAULT_MECH_OID = localOid == null ? GSSUtil.GSS_KRB5_MECH_OID : localOid;
/*     */   }
/*     */   
/*     */ 
...
/* 142 */         GSSUtil.debug(
/* 143 */           "Error in adding provider " + localProvider.getName() + ": " + localGSSException);
/*     */       }
/*     */     }
/*     */   }
/*     */   
...
/*     */   {
/* 154 */     return (paramString.startsWith("GssApiMechanism.")) || 
/* 155 */       (paramString.regionMatches(true, 0, "GssApiMechanism.", 0, PROV_PROP_PREFIX_LEN));
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */       {
/* 253 */         throw new GSSExceptionImpl(2, "Provider " + localProvider.getName() + " does not support mechanism " + paramOid);
/*     */       }
/*     */     }
/*     */     
/*     */ 
...
/*     */       {
/*     */ 
/* 301 */         Constructor localConstructor = localClass2.getConstructor(new Class[] { GSSCaller.class });
...
/*     */       {
/* 363 */         throw new GSSExceptionImpl(2, "Provider " + paramProvider.getName() + " does not support " + str);
/*     */       }
/*     */       
...
/*     */       {
/* 397 */         throw new GSSExceptionImpl(2, "Provider " + paramProvider.getName() + " does not support " + str);
/*     */       }
/*     */       
...
/*     */         catch (GSSException localGSSException) {
/* 437 */           GSSUtil.debug(
/* 438 */             "Ignore the invalid property " + str + " from provider " + paramProvider.getName());
/*     */         }
/*     */       }
/*     */     }
/*     */     
...
/* 508 */         return (equals(localPreferencesEntry)) || (
/* 509 */           (this.p.getName().equals(localPreferencesEntry.p.getName())) && (this.oid == null));
/*     */       }
/*     */       
/* 512 */       return false;
/*     */     }
...
/* Location:              E:\java_source\rt.jar!\sun\security\jgss\ProviderList.class
