...
/*     */     {
/*  87 */       throw new GSSException(4, -1, paramOid.toString() + " is an unsupported nametype");
/*     */     }
/*     */     
/*     */     PrincipalName localPrincipalName;
/*     */     try
/*     */     {
/*  93 */       if ((paramOid.equals(GSSName.NT_EXPORT_NAME)) || 
/*  94 */         (paramOid.equals(Krb5MechFactory.NT_GSS_KRB5_PRINCIPAL))) {
/*  95 */         localPrincipalName = new PrincipalName(paramString, 1);
/*     */       }
/*     */       else
/*     */       {
...
/* 114 */           localPrincipalName = new PrincipalName(paramString, 1);
/*     */         }
/*     */         else {
...
/* 123 */           localPrincipalName = new PrincipalName(str3, 3);
/*     */         }
/*     */       }
/*     */     }
/*     */     catch (KrbException localKrbException)
/*     */     {
/* 129 */       throw new GSSException(3, -1, localKrbException.getMessage());
/*     */     }
/*     */     
/* 132 */     if ((localPrincipalName.isRealmDeduced()) && (!Realm.AUTODEDUCEREALM)) {
/* 133 */       SecurityManager localSecurityManager = System.getSecurityManager();
/* 134 */       if (localSecurityManager != null) {
/*     */         try {
/* 136 */           localSecurityManager.checkPermission(new ServicePermission("@" + localPrincipalName
...
/*     */       }
/*     */     }
/* 144 */     return new Krb5NameElement(localPrincipalName, paramString, paramOid);
/*     */   }
/*     */   
...
/*     */ 
/* 166 */     if ((i > 0) && 
/* 167 */       (paramString.charAt(i - 1) == '\\'))
/*     */     {
/* 169 */       if ((i - 2 < 0) || 
/* 170 */         (paramString.charAt(i - 2) != '\\'))
/* 171 */         i = -1;
/*     */     }
...
/*     */     throws GSSException
/*     */   {
/* 189 */     StringBuffer localStringBuffer = new StringBuffer(paramString1);
/*     */     
/*     */ 
/*     */ 
/*     */     try
...
/*     */     
/* 203 */     localStringBuffer = localStringBuffer.append('/').append(paramString2);
...
/* 227 */       Krb5NameElement localKrb5NameElement = (Krb5NameElement)paramGSSNameSpi;
/* 228 */       return this.krb5PrincipalName.getName().equals(localKrb5NameElement.krb5PrincipalName
/* 229 */         .getName());
/*     */     }
/* 231 */     return false;
/*     */   }
...
/* Location:              E:\java_source\rt.jar!\sun\security\jgss\krb5\Krb5NameElement.class
