...
/* 250 */           (j != this.ec))
/*     */         {
/* 252 */           throw new GSSException(10, -1, getTokenName(paramInt) + ":EC incorrect!");
/*     */         }
/*     */       }
/*     */     }
/*     */     catch (IOException localIOException)
/*     */     {
/* 258 */       throw new GSSException(10, -1, getTokenName(paramInt) + ":" + localIOException.getMessage());
/*     */     }
/*     */   }
/*     */   
/*     */ 
...
/*     */       throws GSSException
/*     */     {
/* 508 */       this.tokenId = paramInt;
/*     */       
/* 510 */       this.bytes[0] = ((byte)(paramInt >>> 8));
/* 511 */       this.bytes[1] = ((byte)paramInt);
/*     */       
/*     */ 
/* 514 */       int i = 0;
/*     */       
/*     */ 
/*     */ 
/* 518 */       i = (MessageToken_v2.this.initiator ? 0 : 1) | ((paramBoolean) && (paramInt != 1028) ? 2 : 0) | (MessageToken_v2.this.have_acceptor_subkey ? 4 : 0);
/* 519 */       this.bytes[2] = ((byte)i);
/*     */       
/*     */ 
/* 522 */       this.bytes[3] = -1;
/*     */       
/* 524 */       if (paramInt == 1284)
/*     */       {
/* 526 */         this.bytes[4] = 0;
/* 527 */         this.bytes[5] = 0;
/*     */         
/* 529 */         this.bytes[6] = 0;
/* 530 */         this.bytes[7] = 0;
/* 531 */       } else if (paramInt == 1028)
/*     */       {
/* 533 */         for (int j = 4; j < 8; j++) {
/* 534 */           this.bytes[j] = -1;
/*     */         }
/*     */       }
/*     */       
...
/*     */     {
/* 555 */       GSSToken.readFully(paramInputStream, this.bytes, 0, 16);
/* 556 */       this.tokenId = GSSToken.readInt(this.bytes, 0);
/*     */       
/*     */ 
/* 559 */       if (this.tokenId != paramInt)
/*     */       {
/* 561 */         throw new GSSException(10, -1, Krb5Token.getTokenName(this.tokenId) + ":Defective Token ID!");
/*     */       }
/*     */       
/*     */ 
/*     */ 
...
/*     */ 
/*     */ 
/* 570 */       int i = MessageToken_v2.this.initiator ? 1 : 0;
/* 571 */       int j = this.bytes[2] & 0x1;
/* 572 */       if (j != i)
/*     */       {
/* 574 */         throw new GSSException(10, -1, Krb5Token.getTokenName(this.tokenId) + ":Acceptor Flag Error!");
/*     */       }
/*     */       
/*     */ 
/* 578 */       int k = this.bytes[2] & 0x2;
/* 579 */       if ((k == 2) && (this.tokenId == 1284))
/*     */       {
/* 581 */         paramMessageProp.setPrivacy(true);
/*     */       } else {
/* 583 */         paramMessageProp.setPrivacy(false);
/*     */       }
/*     */       
...
/*     */         {
/* 590 */           throw new GSSException(10, -1, Krb5Token.getTokenName(this.tokenId) + ":Defective Token Filler!");
/*     */         }
/*     */         
/*     */ 
...
/* 599 */         for (int m = 3; m < 8; m++) {
/* 600 */           if ((this.bytes[m] & 0xFF) != 255)
/*     */           {
...
/* Location:              E:\java_source\rt.jar!\sun\security\jgss\krb5\MessageToken_v2.class
