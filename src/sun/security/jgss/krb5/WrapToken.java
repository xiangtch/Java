...
/*     */     
/* 135 */     this.dataSize = (getGSSHeader().getMechTokenLength() - getKrb5TokenSize());
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */ 
/*     */ 
/* 167 */     this.dataSize = (getGSSHeader().getMechTokenLength() - getTokenSize());
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */     
/* 229 */     int i = this.tokenOffset + localGSSHeader.getLength() + getTokenSize();
/*     */     
/* 231 */     if (i + this.dataSize > this.tokenOffset + this.tokenLen)
/*     */     {
/*     */ 
/* 234 */       throw new GSSException(10, -1, "Insufficient data in " + getTokenName(getTokenId()));
/*     */     }
/*     */     
/*     */ 
/*     */ 
...
/*     */     {
/* 363 */       throw new GSSException(10, -1, getTokenName(getTokenId()) + ": " + localIOException.getMessage());
/*     */     }
/*     */     
/*     */ 
/*     */ 
...
/*     */   {
/* 528 */     return 
/* 529 */       GSSHeader.getMaxMechTokenSize(OID, paramInt2) - (getTokenSize(paramCipherHelper) + 8) - 8;
/*     */   }
/*     */ }


/* Location:              E:\java_source\rt.jar!\sun\security\jgss\krb5\WrapToken.class
