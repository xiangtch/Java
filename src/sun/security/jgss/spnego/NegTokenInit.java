...
/*  97 */         localDerOutputStream1.write(DerValue.createTag((byte)Byte.MIN_VALUE, true, (byte)0), this.mechTypes);
/*     */       }
/*     */       
/*     */ 
/*     */ 
...
/* 105 */         localDerOutputStream1.write(DerValue.createTag((byte)Byte.MIN_VALUE, true, (byte)1), localDerOutputStream2);
/*     */       }
/*     */       
/*     */ 
/*     */ 
...
/* 113 */         localDerOutputStream1.write(DerValue.createTag((byte)Byte.MIN_VALUE, true, (byte)2), localDerOutputStream2);
/*     */       }
/*     */       
/*     */ 
/*     */ 
...
/* 125 */         localDerOutputStream1.write(DerValue.createTag((byte)Byte.MIN_VALUE, true, (byte)3), localDerOutputStream2);
/*     */       }
/*     */       
/*     */ 
/*     */ 
...
/*     */     {
/* 137 */       throw new GSSException(10, -1, "Invalid SPNEGO NegTokenInit token : " + localIOException.getMessage());
/*     */     }
/*     */   }
/*     */   
...
/*     */     }
/*     */     catch (IOException localIOException) {
/* 201 */       throw new GSSException(10, -1, "Invalid SPNEGO NegTokenInit token : " + localIOException.getMessage());
/*     */     }
/*     */   }
/*     */   
/*     */   byte[] getMechTypes() {
...
/* Location:              E:\java_source\rt.jar!\sun\security\jgss\spnego\NegTokenInit.class
