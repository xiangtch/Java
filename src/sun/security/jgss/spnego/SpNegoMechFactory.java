...
/*     */     throws GSSException
/*     */   {
/*  75 */     Vector localVector = GSSUtil.searchSubject(paramGSSNameSpi, GSS_SPNEGO_MECH_OID, paramBoolean, SpNegoCredElement.class);
/*     */     
/*     */ 
/*     */ 
/*  79 */     SpNegoCredElement localSpNegoCredElement = (localVector == null) || (localVector.isEmpty()) ? null : (SpNegoCredElement)localVector.firstElement();
/*     */     
/*     */ 
/*  82 */     if (localSpNegoCredElement != null) {
/*  83 */       GSSCredentialSpi localGSSCredentialSpi = localSpNegoCredElement.getInternalCred();
/*  84 */       if (GSSUtil.isKerberosMech(localGSSCredentialSpi.getMechanism())) { Object localObject;
/*  85 */         if (paramBoolean) {
/*  86 */           localObject = (Krb5InitCredential)localGSSCredentialSpi;
/*     */           
/*  88 */           Krb5MechFactory.checkInitCredPermission((Krb5NameElement)((Krb5InitCredential)localObject).getName());
/*     */         } else {
/*  90 */           localObject = (Krb5AcceptCredential)localGSSCredentialSpi;
/*     */           
/*  92 */           Krb5MechFactory.checkAcceptCredPermission((Krb5NameElement)((Krb5AcceptCredential)localObject).getName(), paramGSSNameSpi);
/*     */         }
/*     */       }
/*     */     }
...
/*     */     throws GSSException
/*     */   {
/* 137 */     SpNegoCredElement localSpNegoCredElement = getCredFromSubject(paramGSSNameSpi, paramInt3 != 2);
/*     */     
/* 139 */     if (localSpNegoCredElement == null)
/*     */     {
/*     */ 
/* 142 */       localSpNegoCredElement = new SpNegoCredElement(this.manager.getCredentialElement(paramGSSNameSpi, paramInt1, paramInt2, null, paramInt3));
/*     */     }
/*     */     
...
/* Location:              E:\java_source\rt.jar!\sun\security\jgss\spnego\SpNegoMechFactory.class
