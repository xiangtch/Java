...
/*  86 */     Object localObject; if (paramBoolean) {
/*  87 */       localObject = null;
/*     */       try {
...
/*     */ 
/*     */ 
/* 123 */           localObject = new GSSCredElement(null, this.lifetime, 1, GSSLibStub.getInstance(GSSUtil.GSS_KRB5_MECH_OID));
...
/* 159 */       Object localObject; if (paramInt != -1)
/*     */       {
/* 161 */         SunNativeProvider.debug("Precomputed mechToken length: " + paramInt);
/*     */         
/*     */ 
/* 164 */         localObject = new GSSHeader(new ObjectIdentifier(this.cStub.getMech().toString()), paramInt);
/*     */         
...
/*     */         {
/* 298 */           this.srcName = new GSSNameElement(this.cStub.getContextName(this.pContext, true), this.cStub);
/*     */         }
...
/*     */       {
/* 324 */         this.targetName = new GSSNameElement(this.cStub.getContextName(this.pContext, false), this.cStub);
/*     */         
/*     */ 
...
/* 337 */           getMechFromSpNegoToken(arrayOfByte1, false))) {
...
/*     */   }
/*     */   
/* 535 */   public void requestReplayDet(boolean paramBoolean) throws GSSException { changeFlags(4, paramBoolean); }
/*     */   
/*     */   public void requestSequenceDet(boolean paramBoolean) throws GSSException {
/* 538 */     changeFlags(8, paramBoolean);
/*     */   }
/*     */   
/* 541 */   public void requestCredDeleg(boolean paramBoolean) throws GSSException { changeFlags(1, paramBoolean); }
/*     */   
/*     */   public void requestAnonymity(boolean paramBoolean) throws GSSException {
/* 544 */     changeFlags(64, paramBoolean);
/*     */   }
/*     */   
/* 547 */   public void requestConf(boolean paramBoolean) throws GSSException { changeFlags(16, paramBoolean); }
/*     */   
/*     */ 
/* 550 */   public void requestInteg(boolean paramBoolean) throws GSSException { changeFlags(32, paramBoolean); }
/*     */   
...
/*     */   }
/*     */   
/* 570 */   public boolean getCredDelegState() { return checkFlags(1); }
/*     */   
/*     */   public boolean getMutualAuthState() {
/* 573 */     return checkFlags(2);
/*     */   }
/*     */   
/* 576 */   public boolean getReplayDetState() { return checkFlags(4); }
/*     */   
/*     */   public boolean getSequenceDetState() {
/* 579 */     return checkFlags(8);
/*     */   }
/*     */   
/* 582 */   public boolean getAnonymityState() { return checkFlags(64); }
/*     */   
/*     */   public boolean isTransferable() throws GSSException {
/* 585 */     return checkFlags(256);
/*     */   }
/*     */   
/* 588 */   public boolean isProtReady() { return checkFlags(128); }
/*     */   
/*     */   public boolean getConfState() {
/* 591 */     return checkFlags(16);
/*     */   }
/*     */   
/* 594 */   public boolean getIntegState() { return checkFlags(32); }
/*     */   
/*     */   public boolean getDelegPolicyState() {
/* 597 */     return false;
/*     */   }
/*     */   
/* 600 */   public int getLifetime() { return this.cStub.getContextTime(this.pContext); }
/*     */   
/*     */   public GSSNameSpi getSrcName() throws GSSException {
/* 603 */     return this.srcName;
/*     */   }
/*     */   
/* 606 */   public GSSNameSpi getTargName() throws GSSException { return this.targetName; }
/*     */   
...
/*     */   }
/*     */   
/* 619 */   public boolean isInitiator() { return this.isInitiator; }
/*     */   
...
/* Location:              E:\java_source\rt.jar!\sun\security\jgss\wrapper\NativeGSSContext.class
