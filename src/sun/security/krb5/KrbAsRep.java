...
/*     */     {
/*     */ 
/* 119 */       throw new KrbException(400, "Cannot find key for type/kvno to decrypt AS REP - " + EType.toString(i) + "/" + localInteger);
/*     */     }
...
/* 134 */     EncryptionKey localEncryptionKey = EncryptionKey.acquireSecretKey(paramPrincipalName, paramArrayOfChar, i, 
/*     */     
/*     */ 
/*     */ 
...
/* 155 */     this.rep.encKDCRepPart = localEncASRepPart;
/*     */     
/* 157 */     ASReq localASReq = paramKrbAsReq.getMessage();
/* 158 */     check(true, localASReq, this.rep);
/*     */     
/* 160 */     this.creds = new Credentials(this.rep.ticket, localASReq.reqBody.cname, localEncASRepPart.sname, localEncASRepPart.key, localEncASRepPart.flags, localEncASRepPart.authtime, localEncASRepPart.starttime, localEncASRepPart.endtime, localEncASRepPart.renewTill, localEncASRepPart.caddr);
/*     */     
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/* 171 */     if (this.DEBUG) {
/* 172 */       System.out.println(">>> KrbAsRep cons in KrbAsReq.getReply " + localASReq.reqBody.cname
/* 173 */         .getNameString());
/*     */     }
/*     */   }
/*     */   
/*     */   Credentials getCreds() {
/* 178 */     return (Credentials)Objects.requireNonNull(this.creds, "Creds not available yet.");
/*     */   }
/*     */   
/*     */   sun.security.krb5.internal.ccache.Credentials getCCreds() {
/* 182 */     return new sun.security.krb5.internal.ccache.Credentials(this.rep);
/*     */   }
/*     */ }


/* Location:              E:\java_source\rt.jar!\sun\security\krb5\KrbAsRep.class
