...
/*     */   {
/*  95 */     if (((paramDerValue.getTag() & 0x1F) != 14) || 
/*  96 */       (paramDerValue.isApplication() != true) || 
/*  97 */       (paramDerValue.isConstructed() != true)) {
...
/* 138 */     localDerOutputStream1.write(DerValue.createTag((byte)Byte.MIN_VALUE, true, (byte)0), localDerOutputStream2);
/* 139 */     localDerOutputStream2 = new DerOutputStream();
/* 140 */     localDerOutputStream2.putInteger(BigInteger.valueOf(this.msgType));
/* 141 */     localDerOutputStream1.write(DerValue.createTag((byte)Byte.MIN_VALUE, true, (byte)1), localDerOutputStream2);
/* 142 */     localDerOutputStream1.write(DerValue.createTag((byte)Byte.MIN_VALUE, true, (byte)2), this.apOptions.asn1Encode());
/* 143 */     localDerOutputStream1.write(DerValue.createTag((byte)Byte.MIN_VALUE, true, (byte)3), this.ticket.asn1Encode());
/* 144 */     localDerOutputStream1.write(DerValue.createTag((byte)Byte.MIN_VALUE, true, (byte)4), this.authenticator.asn1Encode());
...
/* Location:              E:\java_source\rt.jar!\sun\security\krb5\internal\APReq.class
