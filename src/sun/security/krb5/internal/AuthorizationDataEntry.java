...
/* 100 */     localDerOutputStream1.write(DerValue.createTag((byte)Byte.MIN_VALUE, true, (byte)0), localDerOutputStream2);
/* 101 */     localDerOutputStream2 = new DerOutputStream();
/* 102 */     localDerOutputStream2.putOctetString(this.adData);
/* 103 */     localDerOutputStream1.write(DerValue.createTag((byte)Byte.MIN_VALUE, true, (byte)1), localDerOutputStream2);
...
/* Location:              E:\java_source\rt.jar!\sun\security\krb5\internal\AuthorizationDataEntry.class
