...
/*     */   {
/*  93 */     if (((paramDerValue.getTag() & 0x1F) != 27) || 
/*  94 */       (paramDerValue.isApplication() != true) || 
/*  95 */       (paramDerValue.isConstructed() != true)) {
...
/* 138 */     localVector.addElement(new DerValue(DerValue.createTag((byte)Byte.MIN_VALUE, true, (byte)0), this.ctime
/* 139 */       .asn1Encode()));
/* 140 */     localDerOutputStream1.putInteger(BigInteger.valueOf(this.cusec));
/* 141 */     localVector.addElement(new DerValue(DerValue.createTag((byte)Byte.MIN_VALUE, true, (byte)1), localDerOutputStream1
/* 142 */       .toByteArray()));
/* 143 */     if (this.subKey != null) {
/* 144 */       localVector.addElement(new DerValue(DerValue.createTag((byte)Byte.MIN_VALUE, true, (byte)2), this.subKey
/* 145 */         .asn1Encode()));
/*     */     }
...
/* 151 */       localVector.addElement(new DerValue(DerValue.createTag((byte)Byte.MIN_VALUE, true, (byte)3), localDerOutputStream1
/* 152 */         .toByteArray()));
/*     */     }
...
/* Location:              E:\java_source\rt.jar!\sun\security\krb5\internal\EncAPRepPart.class
