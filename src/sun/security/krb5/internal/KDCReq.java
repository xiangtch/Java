...
/* 128 */     BigInteger localBigInteger; if ((localDerValue2.getTag() & 0x1F) == 1) {
...
/* 186 */     localDerOutputStream3.write(DerValue.createTag((byte)Byte.MIN_VALUE, true, (byte)1), localDerOutputStream1);
/*     */     
/* 188 */     localDerOutputStream1 = new DerOutputStream();
/* 189 */     localDerOutputStream1.putInteger(BigInteger.valueOf(this.msgType));
/* 190 */     localDerOutputStream3.write(DerValue.createTag((byte)Byte.MIN_VALUE, true, (byte)2), localDerOutputStream1);
/*     */     
...
/* 199 */       localDerOutputStream3.write(DerValue.createTag((byte)Byte.MIN_VALUE, true, (byte)3), localDerOutputStream2);
/*     */     }
/*     */     
/* 202 */     localDerOutputStream3.write(DerValue.createTag((byte)Byte.MIN_VALUE, true, (byte)4), this.reqBody
...
/* Location:              E:\java_source\rt.jar!\sun\security\krb5\internal\KDCReq.class
