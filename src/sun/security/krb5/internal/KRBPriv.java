...
/*     */   {
/*  91 */     if (((paramDerValue.getTag() & 0x1F) != 21) || 
/*  92 */       (paramDerValue.isApplication() != true) || 
/*  93 */       (paramDerValue.isConstructed() != true))
...
/* 131 */     localDerOutputStream2.write(DerValue.createTag((byte)Byte.MIN_VALUE, true, (byte)0), localDerOutputStream1);
/* 132 */     localDerOutputStream1 = new DerOutputStream();
/* 133 */     localDerOutputStream1.putInteger(BigInteger.valueOf(this.msgType));
/* 134 */     localDerOutputStream2.write(DerValue.createTag((byte)Byte.MIN_VALUE, true, (byte)1), localDerOutputStream1);
/* 135 */     localDerOutputStream2.write(DerValue.createTag((byte)Byte.MIN_VALUE, true, (byte)3), this.encPart.asn1Encode());
...
/* Location:              E:\java_source\rt.jar!\sun\security\krb5\internal\KRBPriv.class
