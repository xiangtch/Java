...
/*     */   {
/*  94 */     if (((paramDerValue.getTag() & 0x1F) != 20) || 
/*  95 */       (paramDerValue.isApplication() != true) || 
/*  96 */       (paramDerValue.isConstructed() != true))
...
/* 134 */     localDerOutputStream2.write(DerValue.createTag((byte)Byte.MIN_VALUE, true, (byte)0), localDerOutputStream1);
/* 135 */     localDerOutputStream1 = new DerOutputStream();
/* 136 */     localDerOutputStream1.putInteger(BigInteger.valueOf(this.msgType));
/* 137 */     localDerOutputStream2.write(DerValue.createTag((byte)Byte.MIN_VALUE, true, (byte)1), localDerOutputStream1);
/* 138 */     localDerOutputStream2.write(DerValue.createTag((byte)Byte.MIN_VALUE, true, (byte)2), this.safeBody.asn1Encode());
/* 139 */     localDerOutputStream2.write(DerValue.createTag((byte)Byte.MIN_VALUE, true, (byte)3), this.cksum.asn1Encode());
...
/* Location:              E:\java_source\rt.jar!\sun\security\krb5\internal\KRBSafe.class
