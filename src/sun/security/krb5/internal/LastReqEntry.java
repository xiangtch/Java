...
/* 83 */     localDerOutputStream1.write(DerValue.createTag((byte)Byte.MIN_VALUE, true, (byte)0), localDerOutputStream2);
/* 84 */     localDerOutputStream1.write(DerValue.createTag((byte)Byte.MIN_VALUE, true, (byte)1), this.lrValue.asn1Encode());
...
/* 93 */     localLastReqEntry.lrValue = this.lrValue;
/* 94 */     return localLastReqEntry;
/*    */   }
/*    */ }


/* Location:              E:\java_source\rt.jar!\sun\security\krb5\internal\LastReqEntry.class
