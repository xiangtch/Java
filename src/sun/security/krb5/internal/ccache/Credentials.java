...
/*     */     
/* 113 */     this.authorizationData = ((AuthorizationData)paramAuthorizationData.clone());
...
/*     */   {
/* 183 */     return new sun.security.krb5.Credentials(this.ticket, this.cname, this.sname, this.key, this.flags, this.authtime, this.starttime, this.endtime, this.renewTill, this.caddr);
/*     */   }
/*     */   
...
/*     */   
/*     */   public int getEType() {
/* 208 */     return this.key.getEType();
/*     */   }
/*     */   
/*     */   public int getTktEType() {
/* 212 */     return this.ticket.encPart.getEType();
/*     */   }
/*     */ }


/* Location:              E:\java_source\rt.jar!\sun\security\krb5\internal\ccache\Credentials.class
