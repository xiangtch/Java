...
/*  73 */       (paramString.length() >= 5) && 
/*  74 */       (paramString.regionMatches(true, 0, "FILE:", 0, 5))) {
...
/*     */     }
/*  99 */     if ((paramString.length() >= 5) && 
/* 100 */       (paramString.regionMatches(true, 0, "FILE:", 0, 5))) {
...
/* Location:              E:\java_source\rt.jar!\sun\security\krb5\internal\ccache\CredentialsCache.class
