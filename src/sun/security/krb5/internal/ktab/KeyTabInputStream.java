...
/*  84 */     j = read(4);
/*  85 */     this.index -= 4;
/*  86 */     PrincipalName localPrincipalName = new PrincipalName(j, arrayOfString, localRealm);
/*  87 */     KerberosTime localKerberosTime = readTimeStamp();
/*     */     
/*  89 */     int k = read() & 0xFF;
/*  90 */     this.index -= 1;
/*  91 */     int m = read(2);
...
/* 114 */     skip(this.index);
/*     */     
/* 116 */     return new KeyTabEntry(localPrincipalName, localRealm, localKerberosTime, k, m, arrayOfByte);
/*     */   }
/*     */   
...
/* Location:              E:\java_source\rt.jar!\sun\security\krb5\internal\ktab\KeyTabInputStream.class
