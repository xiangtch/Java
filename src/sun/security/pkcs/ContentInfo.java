...
/*     */       
/* 150 */       DerInputStream localDerInputStream2 = new DerInputStream(localDerValue2.toByteArray());
...
/* 166 */     if ((this.contentType.equals(DATA_OID)) || 
/* 167 */       (this.contentType.equals(OLD_DATA_OID)) || 
/* 168 */       (this.contentType.equals(TIMESTAMP_TOKEN_INFO_OID))) {
...
/*     */ 
/*     */ 
/* 192 */       localDerValue = new DerValue((byte)-96, localDerOutputStream1.toByteArray());
...
/* Location:              E:\java_source\rt.jar!\sun\security\pkcs\ContentInfo.class
