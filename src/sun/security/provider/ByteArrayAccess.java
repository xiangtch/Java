...
/*     */ {
/*  62 */   private static final Unsafe unsafe = ;
/*     */   
/*     */ 
/*     */ 
...
/*     */   static
/*     */   {
/*  79 */     int i = (unsafe.arrayIndexScale(byte[].class) == 1) && (unsafe.arrayIndexScale(int[].class) == 4) && (unsafe.arrayIndexScale(long[].class) == 8) && ((byteArrayOfs & 0x3) == 0) ? 1 : 0;
/*     */     
/*     */ 
/*  82 */     ByteOrder localByteOrder = ByteOrder.nativeOrder();
/*     */     
/*  84 */     littleEndianUnaligned = (i != 0) && (unaligned()) && (localByteOrder == ByteOrder.LITTLE_ENDIAN);
/*  85 */     bigEndian = (i != 0) && (localByteOrder == ByteOrder.BIG_ENDIAN);
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */   {
/*  95 */     String str = (String)AccessController.doPrivileged(new GetPropertyAction("os.arch", ""));
/*  96 */     return (str.equals("i386")) || (str.equals("x86")) || (str.equals("amd64")) || 
/*  97 */       (str.equals("x86_64")) || (str.equals("ppc64")) || (str.equals("ppc64le"));
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */     {
/*     */ 
/* 390 */       paramArrayOfLong[(paramInt2++)] = (unsafe.getInt(paramArrayOfByte, paramInt1) << 32 | unsafe.getInt(paramArrayOfByte, paramInt1 + 4) & 0xFFFFFFFF);
...
/* Location:              E:\java_source\rt.jar!\sun\security\provider\ByteArrayAccess.class
