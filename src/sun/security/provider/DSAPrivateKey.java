...
/*     */     try
/*     */     {
/*  82 */       this.key = new DerValue((byte)2, paramBigInteger1.toByteArray()).toByteArray();
/*  83 */       encode();
/*     */     }
/*     */     catch (IOException localIOException) {
/*  86 */       InvalidKeyException localInvalidKeyException = new InvalidKeyException("could not DER encode x: " + localIOException.getMessage());
...
/* Location:              E:\java_source\rt.jar!\sun\security\provider\DSAPrivateKey.class
