...
/*  87 */     .equalsIgnoreCase((String)AccessController.doPrivileged(new GetPropertyAction("sun.security.rsa.restrictRSAExponent", "true")));
/*     */   
/*     */ 
/*     */ 
/*     */ 
...
/*     */     throws InvalidKeyException
/*     */   {
/* 125 */     checkKeyLengths(paramInt + 7 & 0xFFFFFFF8, paramBigInteger, 512, Integer.MAX_VALUE);
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */ 
/*     */ 
/* 164 */     if ((restrictExpLen) && (paramBigInteger != null) && (paramInt1 > 3072))
/*     */     {
/* 166 */       if (paramBigInteger.bitLength() > 64) {
...
/*     */       try {
/* 230 */         return new RSAPublicKeyImpl(((RSAPublicKey)localObject)
/* 231 */           .getModulus(), ((RSAPublicKey)localObject)
...
/*     */       try {
/* 256 */         return new RSAPrivateCrtKeyImpl(((RSAPrivateCrtKey)localObject)
/* 257 */           .getModulus(), ((RSAPrivateCrtKey)localObject)
/* 258 */           .getPublicExponent(), ((RSAPrivateCrtKey)localObject)
/* 259 */           .getPrivateExponent(), ((RSAPrivateCrtKey)localObject)
/* 260 */           .getPrimeP(), ((RSAPrivateCrtKey)localObject)
/* 261 */           .getPrimeQ(), ((RSAPrivateCrtKey)localObject)
/* 262 */           .getPrimeExponentP(), ((RSAPrivateCrtKey)localObject)
/* 263 */           .getPrimeExponentQ(), ((RSAPrivateCrtKey)localObject)
...
/*     */       try {
/* 276 */         return new RSAPrivateKeyImpl(((RSAPrivateKey)localObject)
/* 277 */           .getModulus(), ((RSAPrivateKey)localObject)
...
/* 301 */       return new RSAPublicKeyImpl(((RSAPublicKeySpec)localObject)
/* 302 */         .getModulus(), ((RSAPublicKeySpec)localObject)
...
/* 319 */       return new RSAPrivateCrtKeyImpl(((RSAPrivateCrtKeySpec)localObject)
/* 320 */         .getModulus(), ((RSAPrivateCrtKeySpec)localObject)
/* 321 */         .getPublicExponent(), ((RSAPrivateCrtKeySpec)localObject)
/* 322 */         .getPrivateExponent(), ((RSAPrivateCrtKeySpec)localObject)
/* 323 */         .getPrimeP(), ((RSAPrivateCrtKeySpec)localObject)
/* 324 */         .getPrimeQ(), ((RSAPrivateCrtKeySpec)localObject)
/* 325 */         .getPrimeExponentP(), ((RSAPrivateCrtKeySpec)localObject)
/* 326 */         .getPrimeExponentQ(), ((RSAPrivateCrtKeySpec)localObject)
/* 327 */         .getCrtCoefficient());
/*     */     }
/* 329 */     if ((paramKeySpec instanceof RSAPrivateKeySpec)) {
/* 330 */       localObject = (RSAPrivateKeySpec)paramKeySpec;
/* 331 */       return new RSAPrivateKeyImpl(((RSAPrivateKeySpec)localObject)
/* 332 */         .getModulus(), ((RSAPrivateKeySpec)localObject)
...
/* 354 */         return (KeySpec)paramClass.cast(new RSAPublicKeySpec(((RSAPublicKey)localObject)
/* 355 */           .getModulus(), ((RSAPublicKey)localObject)
/* 356 */           .getPublicExponent()));
/*     */       }
/* 358 */       if (x509KeySpecClass.isAssignableFrom(paramClass)) {
/* 359 */         return (KeySpec)paramClass.cast(new X509EncodedKeySpec(paramKey.getEncoded()));
/*     */       }
...
/* 367 */         return (KeySpec)paramClass.cast(new PKCS8EncodedKeySpec(paramKey.getEncoded()));
...
/* 371 */           return (KeySpec)paramClass.cast(new RSAPrivateCrtKeySpec(((RSAPrivateCrtKey)localObject)
/* 372 */             .getModulus(), ((RSAPrivateCrtKey)localObject)
/* 373 */             .getPublicExponent(), ((RSAPrivateCrtKey)localObject)
/* 374 */             .getPrivateExponent(), ((RSAPrivateCrtKey)localObject)
/* 375 */             .getPrimeP(), ((RSAPrivateCrtKey)localObject)
/* 376 */             .getPrimeQ(), ((RSAPrivateCrtKey)localObject)
/* 377 */             .getPrimeExponentP(), ((RSAPrivateCrtKey)localObject)
/* 378 */             .getPrimeExponentQ(), ((RSAPrivateCrtKey)localObject)
...
/* 387 */         return (KeySpec)paramClass.cast(new RSAPrivateKeySpec(((RSAPrivateKey)localObject)
/* 388 */           .getModulus(), ((RSAPrivateKey)localObject)
...
/* Location:              E:\java_source\rt.jar!\sun\security\rsa\RSAKeyFactory.class
