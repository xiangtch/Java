...
/*     */         }
/*     */       }
/* 181 */       int m = ((j != 0) && (t0GetResponse)) || ((k != 0) && (t1GetResponse)) ? 1 : 0;
/* 182 */       int n = 0;
/* 183 */       byte[] arrayOfByte1 = B0;
/*     */       byte[] arrayOfByte2;
/* 185 */       int i1; for (;;) { n++; if (n >= 32) {
...
/*     */     {
/*     */ 
/* 251 */       int tmp30_29 = 0; byte[] tmp30_28 = paramArrayOfByte;tmp30_28[tmp30_29] = ((byte)(tmp30_28[tmp30_29] & 0xBC)); int 
/* 252 */         tmp40_39 = 0; byte[] tmp40_38 = paramArrayOfByte;tmp40_38[tmp40_39] = ((byte)(tmp40_38[tmp40_39] | this.channel));
/* 253 */     } else if (this.channel <= 19)
/*     */     {
/*     */ 
/* 256 */       int tmp63_62 = 0; byte[] tmp63_61 = paramArrayOfByte;tmp63_61[tmp63_62] = ((byte)(tmp63_61[tmp63_62] & 0xB0)); int 
/* 257 */         tmp73_72 = 0; byte[] tmp73_71 = paramArrayOfByte;tmp73_71[tmp73_72] = ((byte)(tmp73_71[tmp73_72] | 0x40)); int 
/* 258 */         tmp82_81 = 0; byte[] tmp82_80 = paramArrayOfByte;tmp82_80[tmp82_81] = ((byte)(tmp82_80[tmp82_81] | this.channel - 4));
/*     */     } else {
...
/* Location:              E:\java_source\rt.jar!\sun\security\smartcardio\ChannelImpl.class
