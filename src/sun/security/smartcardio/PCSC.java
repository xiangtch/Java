...
/* 175 */     StringBuffer localStringBuffer = new StringBuffer(paramArrayOfByte.length * 3);
/* 176 */     for (int i = 0; i < paramArrayOfByte.length; i++) {
/* 177 */       int j = paramArrayOfByte[i] & 0xFF;
/* 178 */       if (i != 0) {
/* 179 */         localStringBuffer.append(':');
/*     */       }
/* 181 */       localStringBuffer.append(hexDigits[(j >>> 4)]);
/* 182 */       localStringBuffer.append(hexDigits[(j & 0xF)]);
/*     */     }
/* 184 */     return localStringBuffer.toString();
/*     */   }
/*     */ }


/* Location:              E:\java_source\rt.jar!\sun\security\smartcardio\PCSC.class
