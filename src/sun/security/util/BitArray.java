...
/*  97 */     if (i > 0) {
/*  98 */       int tmp98_97 = (i - 1); byte[] tmp98_92 = this.repn;tmp98_92[tmp98_97] = ((byte)(tmp98_92[tmp98_97] & k));
/*     */     }
/*     */   }
/*     */   
/*     */ 
...
/*     */     
/* 146 */     if (paramBoolean) {
/* 147 */       int tmp44_43 = i; byte[] tmp44_40 = this.repn;tmp44_40[tmp44_43] = ((byte)(tmp44_40[tmp44_43] | j));
/*     */     } else {
/* 149 */       int tmp59_58 = i; byte[] tmp59_55 = this.repn;tmp59_55[tmp59_58] = ((byte)(tmp59_55[tmp59_58] & (j ^ 0xFFFFFFFF)));
/*     */     }
/*     */   }
/*     */   
/*     */ 
...
/* Location:              E:\java_source\rt.jar!\sun\security\util\BitArray.class
