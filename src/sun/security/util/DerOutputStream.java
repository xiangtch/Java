...
/*     */ 
/* 206 */       for (j = 0; j < 3; j++) {
/* 207 */         if ((arrayOfByte[j] != -1) || ((arrayOfByte[(j + 1)] & 0x80) != 128))
/*     */           break;
/* 209 */         i++;
/*     */       }
/*     */       
...
/*     */ 
/* 217 */       for (j = 0; j < 3; j++) {
/* 218 */         if ((arrayOfByte[j] != 0) || ((arrayOfByte[(j + 1)] & 0x80) != 0))
/*     */           break;
/* 220 */         i++;
/*     */       }
/*     */     }
...
/* Location:              E:\java_source\rt.jar!\sun\security\util\DerOutputStream.class
