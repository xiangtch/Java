...
/*      */ 
/*      */ 
/* 1231 */     String str = (String)paramMap.get(paramString);
/* 1232 */     if (str == null) {
/* 1233 */       AVAKeyword localAVAKeyword = (AVAKeyword)keywordMap.get(paramString);
/* 1234 */       if ((localAVAKeyword != null) && (localAVAKeyword.isCompliant(paramInt))) {
/* 1235 */         return localAVAKeyword.oid;
/*      */       }
/*      */     } else {
...
/* 1248 */       int j = paramString.charAt(0);
/* 1249 */       if ((j >= 48) && (j <= 57)) {
/* 1250 */         i = 1;
/*      */       }
/*      */     }
...
/* 1280 */     String str2 = (String)paramMap.get(str1);
/* 1281 */     if (str2 == null) {
/* 1282 */       AVAKeyword localAVAKeyword = (AVAKeyword)oidMap.get(paramObjectIdentifier);
/* 1283 */       if ((localAVAKeyword != null) && (localAVAKeyword.isCompliant(paramInt))) {
/* 1284 */         return localAVAKeyword.keyword;
/*      */       }
/*      */     } else {
...
/*      */       }
/* 1290 */       str2 = str2.trim();
/* 1291 */       int i = str2.charAt(0);
/* 1292 */       if ((i < 65) || (i > 122) || ((i > 90) && (i < 97))) {
/* 1293 */         throw new IllegalArgumentException("keyword does not start with letter");
/*      */       }
/*      */       
/* 1296 */       for (int j = 1; j < str2.length(); j++) {
/* 1297 */         i = str2.charAt(j);
/* 1298 */         if (((i < 65) || (i > 122) || ((i > 90) && (i < 97))) && ((i < 48) || (i > 57)) && (i != 95))
/*      */         {
...
/*      */   {
/* 1318 */     AVAKeyword localAVAKeyword = (AVAKeyword)oidMap.get(paramObjectIdentifier);
/* 1319 */     if (localAVAKeyword == null) {
/* 1320 */       return false;
/*      */     }
/* 1322 */     return localAVAKeyword.isCompliant(paramInt);
/*      */   }
/*      */   
/*      */ 
...
/*      */   
/* 1331 */   static { new AVAKeyword("CN", X500Name.commonName_oid, true, true);
...
/* Location:              E:\java_source\rt.jar!\sun\security\x509\AVAKeyword.class
