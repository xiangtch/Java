...
/*     */       }
/* 172 */       this.accessDescriptions = ((List)paramObject);
/*     */     } else {
...
/*     */   {
/* 213 */     AttributeNameEnumeration localAttributeNameEnumeration = new AttributeNameEnumeration();
/* 214 */     localAttributeNameEnumeration.addElement("descriptions");
...
/*     */     } else {
/* 223 */       DerOutputStream localDerOutputStream = new DerOutputStream();
/* 224 */       for (Object localObject = this.accessDescriptions.iterator(); ((Iterator)localObject).hasNext();) { AccessDescription localAccessDescription = (AccessDescription)((Iterator)localObject).next();
/* 225 */         localAccessDescription.encode(localDerOutputStream);
/*     */       }
/* 227 */       localObject = new DerOutputStream();
/* 228 */       ((DerOutputStream)localObject).write((byte)48, localDerOutputStream);
/* 229 */       this.extensionValue = ((DerOutputStream)localObject).toByteArray();
/*     */     }
/*     */   }
/*     */   
/*     */ 
...
/* Location:              E:\java_source\rt.jar!\sun\security\x509\AuthorityInfoAccessExtension.class
