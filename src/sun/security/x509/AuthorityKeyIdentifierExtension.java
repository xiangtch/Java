...
/*  90 */     DerOutputStream localDerOutputStream3; if (this.id != null) {
/*  91 */       localDerOutputStream3 = new DerOutputStream();
/*  92 */       this.id.encode(localDerOutputStream3);
/*  93 */       localDerOutputStream2.writeImplicit(DerValue.createTag((byte)Byte.MIN_VALUE, false, (byte)0), localDerOutputStream3);
/*     */     }
/*     */     try
/*     */     {
...
/* 100 */         localDerOutputStream2.writeImplicit(DerValue.createTag((byte)Byte.MIN_VALUE, true, (byte)1), localDerOutputStream3);
/*     */       }
/*     */     }
...
/* 109 */       localDerOutputStream2.writeImplicit(DerValue.createTag((byte)Byte.MIN_VALUE, false, (byte)2), localDerOutputStream4);
/*     */     }
/*     */     
...
/*     */       }
/* 174 */       else if ((localDerValue2.isContextSpecific((byte)1)) && 
/* 175 */         (localDerValue2.isConstructed())) {
...
/*     */       }
/* 182 */       else if ((localDerValue2.isContextSpecific((byte)2)) && 
/* 183 */         (!localDerValue2.isConstructed())) {
...
/*     */   {
/* 315 */     if (this.id != null) {
/* 316 */       DerOutputStream localDerOutputStream = new DerOutputStream();
/* 317 */       this.id.encode(localDerOutputStream);
/* 318 */       return localDerOutputStream.toByteArray();
/*     */     }
/* 320 */     return null;
/*     */   }
/*     */ }
...
/* Location:              E:\java_source\rt.jar!\sun\security\x509\AuthorityKeyIdentifierExtension.class
