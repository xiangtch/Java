...
/*  52 */   private static CRLReason[] values = ;
/*     */   
...
/*  59 */       return;
/*     */     }
/*  61 */     DerOutputStream localDerOutputStream = new DerOutputStream();
/*  62 */     localDerOutputStream.putEnumerated(this.reasonCode);
/*  63 */     this.extensionValue = localDerOutputStream.toByteArray();
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/* 103 */     DerValue localDerValue = new DerValue(this.extensionValue);
/* 104 */     this.reasonCode = localDerValue.getEnumerated();
/*     */   }
/*     */   
/*     */ 
...
/*     */     throws IOException
/*     */   {
/* 162 */     DerOutputStream localDerOutputStream = new DerOutputStream();
/*     */     
...
/*     */   {
/* 178 */     AttributeNameEnumeration localAttributeNameEnumeration = new AttributeNameEnumeration();
/* 179 */     localAttributeNameEnumeration.addElement("reason");
/*     */     
/* 181 */     return localAttributeNameEnumeration.elements();
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/* Location:              E:\java_source\rt.jar!\sun\security\x509\CRLReasonCodeExtension.class
