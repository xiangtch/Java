...
/* 136 */       return "";
/* 137 */     return 
/* 138 */       "Validity: [From: " + this.notBefore.toString() + ",\n               To: " + this.notAfter.toString() + "]";
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */     {
/* 270 */       throw new CertificateNotYetValidException("NotBefore: " + this.notBefore.toString());
/*     */     }
/* 272 */     if (this.notAfter.before(paramDate))
/*     */     {
/* 274 */       throw new CertificateExpiredException("NotAfter: " + this.notAfter.toString());
/*     */     }
/*     */   }
/*     */ }


/* Location:              E:\java_source\rt.jar!\sun\security\x509\CertificateValidity.class
