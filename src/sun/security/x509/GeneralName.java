...
/*     */     try {
/* 206 */       return this.name.constrains(localGeneralNameInterface) == 0;
...
/*     */ 
/*     */ 
/* 236 */       paramDerOutputStream.writeImplicit(DerValue.createTag((byte)Byte.MIN_VALUE, true, (byte)i), localDerOutputStream);
/*     */     }
/* 238 */     else if (i == 4)
/*     */     {
/*     */ 
/* 241 */       paramDerOutputStream.write(DerValue.createTag((byte)Byte.MIN_VALUE, true, (byte)i), localDerOutputStream);
/*     */     }
/*     */     else
/*     */     {
/* 245 */       paramDerOutputStream.writeImplicit(DerValue.createTag((byte)Byte.MIN_VALUE, false, (byte)i), localDerOutputStream);
/*     */     }
/*     */   }
/*     */ }


/* Location:              E:\java_source\rt.jar!\sun\security\x509\GeneralName.class
