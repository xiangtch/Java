...
/* 200 */       localDerOutputStream1.writeImplicit(DerValue.createTag((byte)Byte.MIN_VALUE, false, (byte)0), localDerOutputStream2);
/*     */     }
/*     */     
/* 203 */     if (this.maximum != -1) {
/* 204 */       localDerOutputStream2 = new DerOutputStream();
/* 205 */       localDerOutputStream2.putInteger(this.maximum);
/* 206 */       localDerOutputStream1.writeImplicit(DerValue.createTag((byte)Byte.MIN_VALUE, false, (byte)1), localDerOutputStream2);
/*     */     }
/*     */     
...
/* Location:              E:\java_source\rt.jar!\sun\security\x509\GeneralSubtree.class
