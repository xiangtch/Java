...
/*     */       
/*     */       default: 
/* 280 */         throw new IOException("Unsupported GeneralNameInterface type: " + paramGeneralNameInterface.getType()); }
/*     */       
...
/*     */ 
/* 359 */       k = 0;
/* 360 */       GeneralNameInterface localGeneralNameInterface2; for (m = 0; m < paramGeneralSubtrees.size(); m++) {
/* 361 */         GeneralSubtree localGeneralSubtree = paramGeneralSubtrees.get(m);
/*     */         
/* 363 */         localGeneralNameInterface2 = getGeneralNameInterface(localGeneralSubtree);
...
/*     */             {
/* 402 */               GeneralNameInterface localGeneralNameInterface3 = paramGeneralSubtrees.getGeneralNameInterface(i1);
/*     */               
/*     */ 
/* 405 */               int i2 = localGeneralNameInterface2.constrains(localGeneralNameInterface3);
...
/*     */           }
/*     */           
/* 420 */           localObject2 = createWidestSubtree((GeneralNameInterface)localObject1);
...
/* Location:              E:\java_source\rt.jar!\sun\security\x509\GeneralSubtrees.class
