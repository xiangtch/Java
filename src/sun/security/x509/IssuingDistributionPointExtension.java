...
/*     */       
/* 193 */       if ((localDerValue2.isContextSpecific((byte)0)) && 
/* 194 */         (localDerValue2.isConstructed()))
/*     */       {
/* 196 */         this.distributionPoint = new DistributionPointName(localDerValue2.data.getDerValue());
/* 197 */       } else if ((localDerValue2.isContextSpecific((byte)1)) && 
/* 198 */         (!localDerValue2.isConstructed())) {
/* 199 */         localDerValue2.resetTag((byte)1);
/* 200 */         this.hasOnlyUserCerts = localDerValue2.getBoolean();
/* 201 */       } else if ((localDerValue2.isContextSpecific((byte)2)) && 
/* 202 */         (!localDerValue2.isConstructed())) {
/* 203 */         localDerValue2.resetTag((byte)1);
/* 204 */         this.hasOnlyCACerts = localDerValue2.getBoolean();
/* 205 */       } else if ((localDerValue2.isContextSpecific((byte)3)) && 
/* 206 */         (!localDerValue2.isConstructed())) {
/* 207 */         this.revocationReasons = new ReasonFlags(localDerValue2);
/* 208 */       } else if ((localDerValue2.isContextSpecific((byte)4)) && 
/* 209 */         (!localDerValue2.isConstructed())) {
/* 210 */         localDerValue2.resetTag((byte)1);
/* 211 */         this.isIndirectCRL = localDerValue2.getBoolean();
/* 212 */       } else if ((localDerValue2.isContextSpecific((byte)5)) && 
/* 213 */         (!localDerValue2.isConstructed())) {
...
/* 396 */       localDerOutputStream1.writeImplicit(DerValue.createTag((byte)Byte.MIN_VALUE, true, (byte)0), localDerOutputStream2);
/*     */     }
/*     */     
/*     */ 
...
/* 403 */       localDerOutputStream1.writeImplicit(DerValue.createTag((byte)Byte.MIN_VALUE, false, (byte)1), localDerOutputStream2);
/*     */     }
/*     */     
/*     */ 
...
/* 410 */       localDerOutputStream1.writeImplicit(DerValue.createTag((byte)Byte.MIN_VALUE, false, (byte)2), localDerOutputStream2);
/*     */     }
/*     */     
/*     */ 
...
/* 417 */       localDerOutputStream1.writeImplicit(DerValue.createTag((byte)Byte.MIN_VALUE, false, (byte)3), localDerOutputStream2);
/*     */     }
/*     */     
/*     */ 
...
/* 424 */       localDerOutputStream1.writeImplicit(DerValue.createTag((byte)Byte.MIN_VALUE, false, (byte)4), localDerOutputStream2);
/*     */     }
/*     */     
/*     */ 
...
/* 431 */       localDerOutputStream1.writeImplicit(DerValue.createTag((byte)Byte.MIN_VALUE, false, (byte)5), localDerOutputStream2);
/*     */     }
/*     */     
/*     */ 
...
/*     */ 
/*     */ 
/* 458 */     localStringBuilder.append(this.hasOnlyUserCerts ? "  Only contains user certs: true" : "  Only contains user certs: false").append("\n");
/*     */     
/* 460 */     localStringBuilder.append(this.hasOnlyCACerts ? "  Only contains CA certs: true" : "  Only contains CA certs: false")
/*     */     
/* 462 */       .append("\n");
/*     */     
/* 464 */     localStringBuilder.append(this.hasOnlyAttributeCerts ? "  Only contains attribute certs: true" : "  Only contains attribute certs: false")
/*     */     
/* 466 */       .append("\n");
/*     */     
/* 468 */     localStringBuilder.append(this.isIndirectCRL ? "  Indirect CRL: true" : "  Indirect CRL: false")
/*     */     
/* 470 */       .append("\n");
/*     */     
...
/* Location:              E:\java_source\rt.jar!\sun\security\x509\IssuingDistributionPointExtension.class
