...
/* 105 */   private static final int[] NetscapeCertType_data = { 2, 16, 840, 1, 113730, 1, 1 };
/*     */   
/*     */ 
/*     */ 
/*     */ 
...
/* 116 */   private static final Map<String, OIDInfo> nameMap = new HashMap();
/* 117 */   static { addInternal("x509.info.extensions.SubjectKeyIdentifier", PKIXExtensions.SubjectKey_Id, "sun.security.x509.SubjectKeyIdentifierExtension");
/*     */     
...
/*     */   {
/* 175 */     OIDInfo localOIDInfo = new OIDInfo(paramString1, paramObjectIdentifier, paramString2);
/* 176 */     oidMap.put(paramObjectIdentifier, localOIDInfo);
/* 177 */     nameMap.put(paramString1, localOIDInfo);
/*     */   }
/*     */   
/*     */ 
...
/*     */     {
/* 191 */       this.name = paramString1;
/* 192 */       this.oid = paramObjectIdentifier;
/* 193 */       this.className = paramString2;
/*     */     }
/*     */     
/*     */     OIDInfo(String paramString, ObjectIdentifier paramObjectIdentifier, Class<?> paramClass) {
/* 197 */       this.name = paramString;
/* 198 */       this.oid = paramObjectIdentifier;
/* 199 */       this.className = paramClass.getName();
/* 200 */       this.clazz = paramClass;
/*     */     }
/*     */     
/*     */     Class<?> getClazz()
...
/*     */       try
/*     */       {
/* 208 */         Class localClass = this.clazz;
/* 209 */         if (localClass == null) {
/* 210 */           localClass = Class.forName(this.className);
/* 211 */           this.clazz = localClass;
/*     */         }
/* 213 */         return localClass;
/*     */       } catch (ClassNotFoundException localClassNotFoundException) {
/* 215 */         throw new CertificateException("Could not load class: " + localClassNotFoundException, localClassNotFoundException);
/*     */       }
/*     */     }
/*     */   }
/*     */   
...
/*     */     try
/*     */     {
/* 233 */       localObjectIdentifier = new ObjectIdentifier(paramString2);
/*     */     } catch (IOException localIOException) {
/* 235 */       throw new CertificateException("Invalid Object identifier: " + paramString2);
/*     */     }
/*     */     
/* 238 */     OIDInfo localOIDInfo = new OIDInfo(paramString1, localObjectIdentifier, paramClass);
/* 239 */     if (oidMap.put(localObjectIdentifier, localOIDInfo) != null) {
/* 240 */       throw new CertificateException("Object identifier already exists: " + paramString2);
/*     */     }
/*     */     
/* 243 */     if (nameMap.put(paramString1, localOIDInfo) != null) {
...
/*     */   {
/* 256 */     OIDInfo localOIDInfo = (OIDInfo)oidMap.get(paramObjectIdentifier);
/* 257 */     return localOIDInfo == null ? null : localOIDInfo.name;
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */   {
/* 268 */     OIDInfo localOIDInfo = (OIDInfo)nameMap.get(paramString);
/* 269 */     return localOIDInfo == null ? null : localOIDInfo.oid;
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */     throws CertificateException
/*     */   {
/* 279 */     OIDInfo localOIDInfo = (OIDInfo)nameMap.get(paramString);
/* 280 */     return localOIDInfo == null ? null : localOIDInfo.getClazz();
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */     throws CertificateException
/*     */   {
/* 291 */     OIDInfo localOIDInfo = (OIDInfo)oidMap.get(paramObjectIdentifier);
/* 292 */     return localOIDInfo == null ? null : localOIDInfo.getClazz();
/*     */   }
/*     */ }


/* Location:              E:\java_source\rt.jar!\sun\security\x509\OIDMap.class
