...
/*  91 */       localDerOutputStream1.writeImplicit(DerValue.createTag((byte)Byte.MIN_VALUE, false, (byte)0), localDerOutputStream3);
/*     */     }
/*     */     
/*  94 */     if (this.inhibit != -1) {
/*  95 */       localDerOutputStream3 = new DerOutputStream();
/*  96 */       localDerOutputStream3.putInteger(this.inhibit);
/*  97 */       localDerOutputStream1.writeImplicit(DerValue.createTag((byte)Byte.MIN_VALUE, false, (byte)1), localDerOutputStream3);
/*     */     }
/*     */     
...
/*     */       }
/* 164 */       else if ((localDerValue2.isContextSpecific((byte)1)) && 
/* 165 */         (!localDerValue2.isConstructed())) {
...
/* Location:              E:\java_source\rt.jar!\sun\security\x509\PolicyConstraintsExtension.class
