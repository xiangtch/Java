...
/*     */     {
/* 142 */       if ((this.w == paramInt1) && (this.h == paramInt2) && (((this.config != null) && 
/* 143 */         (this.config.equals(paramGraphicsConfiguration))) || ((this.config == null) && (paramGraphicsConfiguration == null))))
/*     */       {
...
/* 154 */             if (((localObject1 == null) && (localObject2 != null)) || ((localObject1 != null) && 
/* 155 */               (!localObject1.equals(localObject2)))) {
/* 156 */               return false;
/*     */             }
/*     */           }
/* 159 */           return true;
...
/* Location:              E:\java_source\rt.jar!\sun\swing\ImageCache.class
