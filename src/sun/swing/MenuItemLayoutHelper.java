...
/*      */     
/*  203 */     MenuItemCheckIconFactory localMenuItemCheckIconFactory = (MenuItemCheckIconFactory)UIManager.get(paramString + ".checkIconFactory");
/*      */     
/*  205 */     if ((!this.isColumnLayout) || (!this.useCheckAndArrow) || (localMenuItemCheckIconFactory == null) || 
/*  206 */       (!localMenuItemCheckIconFactory.isCompatible(this.checkIcon, paramString))) {
...
/*  213 */     int i = 0;
/*      */     
/*  215 */     Object localObject = UIManager.get(paramString + ".minimumTextOffset");
...
/*  223 */     int i = this.gap;
/*      */     
/*  225 */     Object localObject = UIManager.get(paramString + ".afterCheckIconGap");
...
/*  241 */     int i = this.gap;
/*      */     
/*  243 */     Object localObject = UIManager.get(paramString + ".checkIconOffset");
...
/*  296 */       this.labelSize.height = max(new int[] { this.checkSize.height, this.iconSize.height, 
/*  297 */         this.textSize.height, this.accSize.height, this.arrowSize.height });
/*      */     } else {
...
/*  320 */       i = this.gap;
/*  321 */       if ((this.iconSize.getMaxWidth() == 0) || 
/*  322 */         (this.textSize.getMaxWidth() == 0)) {
/*  323 */         i = 0;
/*      */       }
/*  325 */       this.labelSize.maxWidth = 
/*  326 */         calcMaxValue(MAX_LABEL_WIDTH, this.iconSize.maxWidth + 
/*  327 */         this.textSize.maxWidth + i);
/*      */     }
/*      */     else
/*      */     {
...
/*  498 */     return new LayoutResult(new Rectangle(
/*  499 */       this.iconSize.width, this.iconSize.height), new Rectangle(
/*  500 */       this.textSize.width, this.textSize.height), new Rectangle(
/*  501 */       this.accSize.width, this.accSize.height), new Rectangle(
/*  502 */       this.checkSize.width, this.checkSize.height), new Rectangle(
/*  503 */       this.arrowSize.width, this.arrowSize.height), new Rectangle(
/*  504 */       this.labelSize.width, this.labelSize.height));
/*      */   }
/*      */   
...
/*      */   {
/*  529 */     paramLayoutResult.accRect.y = ((int)(paramLayoutResult.labelRect.y + paramLayoutResult.labelRect.height / 2.0F - paramLayoutResult.accRect.height / 2.0F));
/*  530 */     fixVerticalAlignment(paramLayoutResult, paramLayoutResult.accRect);
/*  531 */     if (this.useCheckAndArrow)
/*      */     {
/*      */ 
/*  534 */       paramLayoutResult.arrowRect.y = ((int)(paramLayoutResult.labelRect.y + paramLayoutResult.labelRect.height / 2.0F - paramLayoutResult.arrowRect.height / 2.0F));
/*      */       
/*      */ 
/*  537 */       paramLayoutResult.checkRect.y = ((int)(paramLayoutResult.labelRect.y + paramLayoutResult.labelRect.height / 2.0F - paramLayoutResult.checkRect.height / 2.0F));
...
/*      */ 
/*      */ 
/*  572 */     calcXPositionsLTR(this.viewRect.x, this.leadingGap, this.gap, new Rectangle[] { paramLayoutResult.checkRect, 
/*  573 */       paramLayoutResult.iconRect, paramLayoutResult.textRect });
/*      */     
/*      */ 
...
/*  582 */       paramLayoutResult.arrowRect, paramLayoutResult.accRect });
/*      */     
/*      */ 
...
/*      */     
/*      */ 
/*  605 */     calcXPositionsLTR(this.viewRect.x, this.leadingGap, this.gap, new Rectangle[] { paramLayoutResult.checkRect, 
/*  606 */       paramLayoutResult.labelRect });
/*      */     
/*      */ 
...
/*  614 */       paramLayoutResult.arrowRect, paramLayoutResult.accRect });
/*      */     
/*      */ 
...
/*  638 */       paramLayoutResult.checkRect, paramLayoutResult.iconRect, paramLayoutResult.textRect });
/*      */     
/*      */ 
...
/*      */     }
/*      */     
/*  646 */     calcXPositionsLTR(this.viewRect.x, this.leadingGap, this.gap, new Rectangle[] { paramLayoutResult.arrowRect, 
/*  647 */       paramLayoutResult.accRect });
/*      */     
/*      */ 
/*      */ 
...
/*  672 */       paramLayoutResult.checkRect, paramLayoutResult.labelRect });
/*      */     
/*      */ 
...
/*  719 */     SwingUtilities.layoutCompoundLabel(this.mi, this.fm, this.text, this.icon, this.verticalAlignment, this.horizontalAlignment, this.verticalTextPosition, this.horizontalTextPosition, 
/*      */     
/*  721 */       paramLayoutResult.labelRect, 
/*  722 */       paramLayoutResult.iconRect, paramLayoutResult.textRect, this.gap);
/*      */   }
/*      */   
...
/*  728 */     for (Rectangle localRectangle : paramVarArgs) {
...
/*  739 */     for (Rectangle localRectangle : paramVarArgs) {
...
/*      */     {
/*      */ 
/*  755 */       paramLayoutResult.textRect.y = ((int)(this.viewRect.y + paramLayoutResult.labelRect.height / 2.0F - paramLayoutResult.textRect.height / 2.0F));
/*      */       
/*      */ 
/*  758 */       paramLayoutResult.iconRect.y = ((int)(this.viewRect.y + paramLayoutResult.labelRect.height / 2.0F - paramLayoutResult.iconRect.height / 2.0F));
/*  759 */     } else if (this.verticalAlignment == 0)
/*      */     {
/*      */ 
/*  762 */       paramLayoutResult.textRect.y = ((int)(this.viewRect.y + this.viewRect.height / 2.0F - paramLayoutResult.textRect.height / 2.0F));
/*      */       
/*      */ 
/*  765 */       paramLayoutResult.iconRect.y = ((int)(this.viewRect.y + this.viewRect.height / 2.0F - paramLayoutResult.iconRect.height / 2.0F));
/*      */     }
/*  767 */     else if (this.verticalAlignment == 3)
/*      */     {
/*      */ 
/*      */ 
/*  771 */       paramLayoutResult.textRect.y = ((int)(this.viewRect.y + this.viewRect.height - paramLayoutResult.labelRect.height / 2.0F - paramLayoutResult.textRect.height / 2.0F));
/*      */       
/*      */ 
/*      */ 
/*  775 */       paramLayoutResult.iconRect.y = ((int)(this.viewRect.y + this.viewRect.height - paramLayoutResult.labelRect.height / 2.0F - paramLayoutResult.iconRect.height / 2.0F));
/*      */     }
/*      */   }
/*      */   
/*      */ 
...
/*      */     {
/*      */ 
/*  789 */       paramLayoutResult.labelRect.y = ((int)(this.viewRect.y + this.viewRect.height / 2.0F - paramLayoutResult.labelRect.height / 2.0F));
/*  790 */     } else if (this.verticalAlignment == 3)
/*      */     {
/*  792 */       paramLayoutResult.labelRect.y = (this.viewRect.y + this.viewRect.height - paramLayoutResult.labelRect.height);
/*      */     }
/*      */   }
/*      */   
/*      */ 
...
/*  805 */     if (((localContainer instanceof JComponent)) && ((!(paramJMenuItem instanceof JMenu)) || 
/*      */     
...
/* 1119 */     if (((paramJMenuItem instanceof JMenu)) && 
/* 1120 */       (((JMenu)paramJMenuItem).isTopLevelMenu())) {
/* 1121 */       bool = false;
/*      */     }
/* 1123 */     return bool;
/*      */   }
...
/* Location:              E:\java_source\rt.jar!\sun\swing\MenuItemLayoutHelper.class
