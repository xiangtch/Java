...
/*     */ 
/*     */ 
/* 119 */     this.statusFormat = new MessageFormat(UIManager.getString("PrintingDialog.contentProgressText"));
/*     */     
/*     */ 
...
/*     */     {
/* 151 */       this.abortDialog = localJOptionPane.createDialog(this.parent.getParent(), str1);
/*     */     } else {
...
/* 263 */       if (paramPrintable == null) {
/* 264 */         throw new NullPointerException("Printable is null");
/*     */       }
/* 266 */       this.printDelegatee = paramPrintable;
/*     */     }
/*     */     
/*     */ 
/*     */ 
...
/*     */     {
/* 274 */       int i = this.printDelegatee.print(paramGraphics, paramPageFormat, paramInt);
...
/*     */             public void run() {
/* 281 */               NotificationPrintable.this.updateStatusOnEDT(paramInt);
/*     */             }
/*     */           });
/*     */         }
/*     */       }
...
/* Location:              E:\java_source\rt.jar!\sun\swing\PrintingStatus.class
