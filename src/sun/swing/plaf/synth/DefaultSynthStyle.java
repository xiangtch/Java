...
/*     */           {
/* 502 */             paramDefaultSynthStyle.states[i] = ((StateInfo)this.states[i].clone());
/*     */           }
/*     */           
/*     */         }
/*     */         
...
/* 514 */         int n; int i1; int i2; for (int m = this.states.length - 1; m >= 0; 
/* 515 */             m--) {
...
/* 520 */               i2 >= 0; i2--)
/*     */           {
/* 522 */             if (n == paramDefaultSynthStyle.states[i2].getComponentState())
/*     */             {
/* 524 */               paramDefaultSynthStyle.states[i2] = this.states[m].addTo(paramDefaultSynthStyle.states[i2]);
/*     */               
...
/* 555 */                 i4--)
/*     */             {
/* 557 */               if (i2 == paramDefaultSynthStyle.states[i4].getComponentState()) {
/* 558 */                 i3 = 1;
/* 559 */                 break;
/*     */               }
/*     */             }
/* 562 */             if (i3 == 0)
/*     */             {
/* 564 */               arrayOfStateInfo[(n++)] = ((StateInfo)this.states[i1].clone());
/*     */             }
/*     */           }
...
/*     */       {
/* 922 */         localStringBuffer.append("colors=").append(Arrays.asList(this.colors)).append(',');
/*     */       }
...
/* Location:              E:\java_source\rt.jar!\sun\swing\plaf\synth\DefaultSynthStyle.class
