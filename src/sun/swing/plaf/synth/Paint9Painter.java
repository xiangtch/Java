...
/*     */   {
/*  93 */     return (paramImage != null) && (paramImage.getWidth(null) > 0) && 
/*  94 */       (paramImage.getHeight(null) > 0);
/*     */   }
/*     */   
...
/*     */     {
/* 167 */       paramGraphics.drawImage(paramImage, paramInt1 + (paramInt3 - i) / 2, paramInt2 + (paramInt4 - j) / 2, null); } else { int k;
/*     */       int m;
/*     */       int n;
/* 170 */       int i1; int i2; int i3; int i4; int i5; if (paramPaintType == PaintType.TILE)
/*     */       {
/* 172 */         k = 0;
...
/* 180 */             paramGraphics.drawImage(paramImage, i2, m, i4, i5, i1, k, i1 + i4 - i2, k + i5 - m, null);i2 += i - i1;
/*     */           }
/* 174 */           m += j - k;
/*     */ 
/*     */ 
...
/* Location:              E:\java_source\rt.jar!\sun\swing\plaf\synth\Paint9Painter.class
