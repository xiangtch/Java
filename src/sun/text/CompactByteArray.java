...
/*  78 */     this.indices = new short['Ȁ'];
/*  79 */     this.hashes = new int['Ȁ'];
...
/* 175 */           for (i1 = 0; i1 < i; 
/* 176 */               n += 128) {
/* 177 */             if ((this.hashes[m] == this.hashes[i1]) && 
/* 178 */               (arrayRegionMatches(this.values, j, this.values, n, 128)))
/*     */             {
...
/* 270 */       return localCompactByteArray;
/*     */     } catch (CloneNotSupportedException localCloneNotSupportedException) {
/* 272 */       throw new InternalError(localCloneNotSupportedException);
/*     */     }
/*     */   }
/*     */   
/*     */ 
...
/* Location:              E:\java_source\rt.jar!\sun\text\CompactByteArray.class
