...
/*     */         {
/*     */ 
/* 143 */           this.blockTouched[j] = new boolean['Ȁ'];
...
/* 161 */     this.indices[paramInt] = new short['Ȁ'];
/* 162 */     this.blockTouched[paramInt] = new boolean['Ȁ'];
...
/* Location:              E:\java_source\rt.jar!\sun\text\UCompactIntArray.class
