...
/*     */       
/*     */       case 1: 
/* 252 */         BidiBase tmp471_469 = localBidiBase;tmp471_469.paraLevel = ((byte)(tmp471_469.paraLevel | 0x1));
/*     */         
/*     */ 
/*     */ 
...
/*     */     }
/*     */     
/* 403 */     paramByte2 = (byte)(paramByte2 - 1); int i; BidiRun localBidiRun; if (paramByte2 >= paramByte1) {
/* 404 */       i = 0;
/*     */       
/*     */ 
/*     */ 
...
/*     */           
/*     */ 
/* 418 */           int k = i; do { k++; } while ((k < m) && (arrayOfByte[arrayOfBidiRun[k].start] >= paramByte2));
/*     */           
/*     */ 
/*     */ 
/* 422 */           int j = k - 1;
...
/*     */           
/*     */ 
/* 716 */           int k = i; do { k++; } while ((k < paramArrayOfByte.length) && (paramArrayOfByte[k] >= i1));
/*     */           
/*     */ 
/*     */ 
/*     */ 
...
/* 754 */     int j = 0;
/* 755 */     int n = 0;
/* 756 */     int i; int k; for (int i1 = 0; i1 < paramBidiBase.runCount; i1++) {
...
/*     */     int i3;
/*     */     int i6;
/* 772 */     int i5; if (paramBidiBase.insertPoints.size > 0) {
...
/* Location:              E:\java_source\rt.jar!\sun\text\bidi\BidiLine.class
