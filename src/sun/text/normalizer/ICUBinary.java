...
/*     */     
/* 157 */     if ((n == 1) && (i1 == 0) && (i2 == 2))
/*     */     {
/* 159 */       if (Arrays.equals(paramArrayOfByte, arrayOfByte1)) { if (paramAuthenticate == null)
/*     */           break label231;
/* 161 */         if (paramAuthenticate.isDataVersionAcceptable(arrayOfByte2)) break label231; } }
