...
/*      */ 
/*      */ 
/*  159 */     public int getFoldingOffset(int paramInt) { return 2048 + (paramInt >> 11 & 0x7FE0); } }
/*      */   
/*      */   private static final class NextCombiningArgs { char[] source;
/*      */     int start;
/*      */     char c;
/*      */     char c2; int combiningIndex; char cc; }
/*      */   private static final class NextCCArgs { char[] source; int next; int limit; char c; char c2; }
/*  166 */   static final class FCDTrieImpl implements Trie.DataManipulate { static CharTrie fcdTrie = null;
/*      */     
/*      */ 
/*      */ 
/*      */ 
...
/*      */ 
/*      */ 
/*  176 */     public int getFoldingOffset(int paramInt) { return paramInt; } }
/*      */   
/*      */   private static final class DecomposeArgs { int cc;
/*      */     int trailCC; int length; }
/*      */   private static final class ComposePartArgs { int prevCC; int length; }
/*  181 */   static final class AuxTrieImpl implements Trie.DataManipulate { static CharTrie auxTrie = null;
/*      */     
/*      */ 
/*      */ 
/*      */ 
...
/*      */   }
/*      */   
/*  404 */   public static int getFCD16(int paramInt) { return FCDTrieImpl.fcdTrie.getCodePointValue(paramInt); }
/*      */   
...
/*      */ 
/*      */ 
/* 2284 */   private static final UnicodeSet[] nxCache = new UnicodeSet['Ā'];
/*      */   
/*      */ 
/*      */ 
/*      */ 
...
/* 2456 */     if (paramUnicodeSet != null) {} return paramUnicodeSet.contains(paramChar2 == 0 ? paramChar1 : UCharacterProperty.getRawSupplementary(paramChar1, paramChar2));
/*      */   }
/*      */   
/*      */ 
/*      */ 
