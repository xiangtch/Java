...
/*     */   {
/* 105 */     return ((paramObject instanceof BuddhistCalendar)) && 
/* 106 */       (super.equals(paramObject));
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */     }
/* 244 */     i += "YEAR=".length();
/* 245 */     StringBuilder localStringBuilder = new StringBuilder(str.substring(0, i));
/*     */     
/* 247 */     while (Character.isDigit(str.charAt(i++))) {}
/*     */     
/* 249 */     int j = internalGet(1) + 543;
/* 250 */     localStringBuilder.append(j).append(str.substring(i - 1));
...
/* Location:              E:\java_source\rt.jar!\sun\util\BuddhistCalendar.class
