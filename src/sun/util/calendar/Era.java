...
/* 129 */     return (this.name.equals(localEra.name)) && 
/* 130 */       (this.abbr.equals(localEra.abbr)) && (this.since == localEra.since) && (this.localTime == localEra.localTime);
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/* Location:              E:\java_source\rt.jar!\sun\util\calendar\Era.class
