...
/*     */           {
/*     */ 
/* 154 */             throw new LocaleSyntaxException("Ill-formed Unicode locale keyword type: " + paramString2, localStringTokenIterator.currentStart());
/*     */           }
...
/* 203 */         if (!bool3)
/*     */         {
/* 205 */           throw new LocaleSyntaxException("Ill-formed extension value: " + str2, localStringTokenIterator.currentStart());
/*     */         }
...
/* 289 */         if (i <= j)
/*     */         {
/* 291 */           throw new LocaleSyntaxException("Incomplete privateuse:" + paramString.substring(j), j);
/*     */         }
/*     */         
...
/*     */     {
/*     */ 
/* 302 */       throw new LocaleSyntaxException("Ill-formed extension subtags:" + paramString.substring(localStringTokenIterator.currentStart()), localStringTokenIterator.currentStart());
/*     */     }
/*     */     
...
/* 441 */         UnicodeLocaleExtension localUnicodeLocaleExtension; Iterator localIterator2; String str5; if ((localExtension instanceof UnicodeLocaleExtension)) {
...
/* 616 */     int i = -1;
/* 617 */     int j = -1;
/* 618 */     while (!localStringTokenIterator.isDone()) { String str;
...
/*     */     
/* 670 */     CaseInsensitiveString(String paramString) { this.str = paramString;
...
/* Location:              E:\java_source\rt.jar!\sun\util\locale\InternalLocaleBuilder.class
