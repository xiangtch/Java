...
/*  85 */     Object localObject1; if (i != 0)
/*  86 */       for (localObject1 = paramMap.entrySet().iterator(); ((Iterator)localObject1).hasNext();) { localObject2 = (Entry)((Iterator)localObject1).next();
/*  87 */         char c = LocaleUtils.toLower(((InternalLocaleBuilder.CaseInsensitiveChar)((Entry)localObject2).getKey()).value());
/*  88 */         localObject4 = (String)((Entry)localObject2).getValue();
/*     */         
...
/* 115 */         for (localObject3 = paramMap1.entrySet().iterator(); ((Iterator)localObject3).hasNext();) { localObject4 = (Entry)((Iterator)localObject3).next();
/* 116 */           String str1 = LocaleUtils.toLowerString(((InternalLocaleBuilder.CaseInsensitiveString)((Entry)localObject4).getKey()).value());
/* 117 */           String str2 = LocaleUtils.toLowerString((String)((Entry)localObject4).getValue());
...
/* 197 */     for (Entry localEntry : paramSortedMap.entrySet()) {
...
/* Location:              E:\java_source\rt.jar!\sun\util\locale\LocaleExtensions.class
