...
/*  90 */     for (int j = 0; 
/*  91 */         j < i; j++) {
/*  92 */       if (isUpper(paramString.charAt(j))) {
/*     */         break;
/*     */       }
/*     */     }
/*  96 */     if (j == i) {
...
/* 110 */     for (int j = 0; 
/* 111 */         j < i; j++) {
/* 112 */       if (isLower(paramString.charAt(j))) {
/*     */         break;
/*     */       }
/*     */     }
/* 116 */     if (j == i) {
...
/* 135 */       for (j = 1; j < i; j++) {
/* 136 */         if (isUpper(paramString.charAt(j))) {
/*     */           break;
/*     */         }
/*     */       }
/*     */     }
...
/* Location:              E:\java_source\rt.jar!\sun\util\locale\LocaleUtils.class
