...
/*     */     }
/*     */     
/* 150 */     SimpleDateFormat localSimpleDateFormat = new SimpleDateFormat("", paramLocale);
/* 151 */     Calendar localCalendar = localSimpleDateFormat.getCalendar();
/*     */     try
/*     */     {
/* 154 */       String str = LocaleProviderAdapter.forType(this.type).getLocaleResources(paramLocale).getDateTimePattern(paramInt2, paramInt1, localCalendar);
/*     */       
/* 156 */       localSimpleDateFormat.applyPattern(str);
/*     */     }
/*     */     catch (MissingResourceException localMissingResourceException) {
/* 159 */       localSimpleDateFormat.applyPattern("M/d/yy h:mm a");
/*     */     }
/*     */     
/* 162 */     return localSimpleDateFormat;
/*     */   }
/*     */   
...
/* Location:              E:\java_source\rt.jar!\sun\util\locale\provider\DateFormatProviderImpl.class
