...
/*     */ {
/*  49 */   private static final LoggingProxy proxy = (LoggingProxy)AccessController.doPrivileged(new PrivilegedAction()
/*     */   {
...
/*     */   }
/*     */   
/*  84 */   public static String getLoggerLevel(String paramString) { ensureAvailable();
...
/*     */   {
/* 160 */     String str = (String)AccessController.doPrivileged(new PrivilegedAction()
/*     */     {
/*     */       public String run() {
...
/* Location:              E:\java_source\rt.jar!\sun\util\logging\LoggingSupport.class
